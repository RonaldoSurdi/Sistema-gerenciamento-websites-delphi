...
uses
  ...
  uadm_xml in 'uadm_xml.pas' {adm_xml};
...
begin
    ...
    HprevHist := FindWindow(Nil, PChar('HWS xml'));
    if HprevHist = 0 then begin
    Application.Title := 'HWS xml';
    ...
    Try
       ...
       if (ParamStr(1) <> '') and (ParamStr(2) = 'Å?Ö¤¶•') and (ParamStr(3) <> '') then begin
          if dm.conecta_bd(true,false,ParamStr(1),ParamStr(3)) then begin
             Application.CreateForm(Tadm_xml, adm_xml);
          end else begin
