...
type
  TLstTables = record
     ...
     Count: Integer;
  End;
  Tmdl_photogalerycfg = class(TForm)
    Panel1: TPanel;
    pn_tit: TPanel;
    Image3: TImage;
...
var
  mdl_photogalerycfg: Tmdl_photogalerycfg;
...
procedure Tmdl_photogalerycfg.FormClose(Sender: TObject; var Action: TCloseAction);
begin
     dm.ds_sql3.Filter:='';
...
procedure Tmdl_photogalerycfg.bt_fecharClick(Sender: TObject);
begin
    close;
end;

procedure Tmdl_photogalerycfg.FormCreate(Sender: TObject);
...
procedure Tmdl_photogalerycfg.DBGrid1CellClick(Column: TColumn);
begin
      atualiza_grade;
end;

procedure Tmdl_photogalerycfg.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_photogalerycfg.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_photogalerycfg.atualiza_grade;
begin
...
procedure Tmdl_photogalerycfg.addreg;
begin
     lbcp1.Text:='novo';
     lbcp2.Text:= '';
end;

procedure Tmdl_photogalerycfg.bt_sobreClick(Sender: TObject);
begin
      hwsf.BtSobre;
end;

procedure Tmdl_photogalerycfg.YuSoftLabel2Click(Sender: TObject);
begin
      JumpTo('www.hws.com.br');
end;

procedure Tmdl_photogalerycfg.FormMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
      SetCapture(mdl_photogalerycfg.Handle);
      cp_mouse := true;
      mv_mouse.X := x;
      mv_mouse.Y := Y;
end;

procedure Tmdl_photogalerycfg.FormMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
  if cp_mouse then begin
      mdl_photogalerycfg.Left:= mdl_photogalerycfg.Left-(mv_mouse.x-x);
      mdl_photogalerycfg.Top:= mdl_photogalerycfg.Top - (mv_mouse.y-y);
  end;
end;

procedure Tmdl_photogalerycfg.FormMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if cp_mouse then begin
      ReleaseCapture;
...
procedure Tmdl_photogalerycfg.bt_minimizeClick(Sender: TObject);
begin
     Application.Minimize;
end;

procedure Tmdl_photogalerycfg.tabtoenterpress(var Msg: TMsg; var Handled: Boolean);
begin
...
procedure Tmdl_photogalerycfg.bt_maximizaClick(Sender: TObject);
begin
    if mdl_photogalerycfg.WindowState=wsMaximized then mdl_photogalerycfg.WindowState:=wsNormal
    else mdl_photogalerycfg.WindowState:=wsMaximized;
end;

procedure Tmdl_photogalerycfg.FormResize(Sender: TObject);
begin
...
procedure Tmdl_photogalerycfg.bt_newClick(Sender: TObject);
begin
    addreg;
    lbcp2.SetFocus;
end;

procedure Tmdl_photogalerycfg.bt_delClick(Sender: TObject);
begin
...
procedure Tmdl_photogalerycfg.bt_saveClick(Sender: TObject);
var axcod : integer;
begin
...
procedure Tmdl_photogalerycfg.bt_nextClick(Sender: TObject);
begin
    dm.ds_sql3.Next;
    atualiza_grade;
end;

procedure Tmdl_photogalerycfg.bt_priorClick(Sender: TObject);
begin
    dm.ds_sql3.Prior;
    atualiza_grade;
end;

procedure Tmdl_photogalerycfg.Edit_searchChange(Sender: TObject);
begin
     filtrar_reg;
end;

procedure Tmdl_photogalerycfg.filtrar_reg;
begin
...
procedure Tmdl_photogalerycfg.bt_searchClick(Sender: TObject);
begin
     filtrar_reg;
end;

procedure Tmdl_photogalerycfg.ComboBox_searchChange(Sender: TObject);
begin
...
procedure Tmdl_photogalerycfg.Edit_searchKeyPress(Sender: TObject;
  var Key: Char);
begin
