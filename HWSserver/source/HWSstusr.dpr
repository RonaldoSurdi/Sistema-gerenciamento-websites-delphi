...
uses
  ...
  uadm_hdusr in 'uadm_hdusr.pas' {adm_hdusr};
...
begin
    ...
    HprevHist := FindWindow(Nil, PChar('HWS ST - Usuários'));
    if HprevHist = 0 then begin
    Application.Title := 'HWS ST - Usuários';
    ...
    Try
       ...
       if (ParamStr(1) <> '') and (ParamStr(2) = 'Å?Ö¤¶•') and (ParamStr(3) <> '') then begin
          if dm.conecta_bd(true,true,ParamStr(1),ParamStr(3)) then begin
             Application.CreateForm(Tadm_hdusr, adm_hdusr);
          end else begin
