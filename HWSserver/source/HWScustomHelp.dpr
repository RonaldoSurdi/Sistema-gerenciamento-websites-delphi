...
uses
  ...
  uadm_customhelp in 'uadm_customhelp.pas' {adm_customhelp},
...
begin
    ...
    Application.Title := 'HWS  Editor de Ajudas';
    ...
    Try
       ...
       if (ParamStr(1) <> '') and (ParamStr(2) = 'Å?Ö¤¶•') and (ParamStr(3) <> '') then begin
          if dm.conecta_bd(true,true,ParamStr(1),ParamStr(3)) then begin
             Application.CreateForm(Tadm_customhelp, adm_customhelp);
          end else begin
