...
uses
  ...
  uadm_moedas in 'uadm_moedas.pas' {adm_moedas};
...
begin
    ...
    HprevHist := FindWindow(Nil, PChar('HWS Moedas'));
    if HprevHist = 0 then begin
    Application.Title := 'HWS Moedas';
    ...
    Try
       ...
       if (ParamStr(1) <> '') and (ParamStr(2) = 'Å?Ö¤¶•') and (ParamStr(3) <> '') then begin
          if dm.conecta_bd(true,true,ParamStr(1),ParamStr(3)) then begin
             Application.CreateForm(Tadm_moedas, adm_moedas);
          end else begin
