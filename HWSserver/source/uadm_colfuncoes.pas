...
begin
     try
        ...
        hwsf.BtMensagem('Selecione um setor válido.');
        exit;
     end;
...
var xpathupdt,xpdtUF,xpdtCidade: String;
    ...
    axshowing: Boolean;
begin
     if not hwsf.BtConfirma('Tem certeza que desejas atualizar todos os registros?'+#13+'Formato: §função">'+#13+'(Nome dos arquivos 00_area.txt)') then exit;
                      ...
                      with dm.executa do begin
                           ...
                           try
                              Execute;
                               ...
                               xerrorlst.Add(xpdtUF+' --> erro ao importar função ['+xpdtCidade+'].');
                               xcodcid:=xcodcid-1;
                           end;
                      end;
                   end;
