...
procedure Tmdl_events2.FormClose(Sender: TObject; var Action: TCloseAction);
...
procedure Tmdl_events2.FormCreate(Sender: TObject);
var axshowing: Boolean;
...
begin
     ...
     mdl_events2.Caption:= AxDadosUsr.axtitle;
     xinit:=true;
     axcod_ent:=0;
...
procedure Tmdl_events2.monta_lng;
...
procedure Tmdl_events2.monta_table1;
var axshowing: Boolean;
...
procedure Tmdl_events2.monta_table2(xnewgal,xuplng:Boolean);
begin
...
procedure Tmdl_events2.FormResize(Sender: TObject);
begin
...
procedure Tmdl_events2.FormActivate(Sender: TObject);
begin
      mdl_events2.Refresh;
      if xinit then begin
         xinit:=false;
...
procedure Tmdl_events2.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      Case key of
...
procedure Tmdl_events2.travaformImages(xtrava: Boolean);
begin
...
procedure Tmdl_events2.addreg2;
begin
     ms_cod.Caption:='novo';
     ax_ms_cod:=0;
     ms_titulo.Text:='';
...
procedure Tmdl_events2.atualiza_grade;
var axshowing: Boolean;
    axlocid: Integer;
     ...
     axshowing:= loadx.Showing;
      ...
      if dm.ds_sql.RecordCount <= 0 then begin
         ...
         with dm.ds_sql do begin
            ...
            if (dm.ds_sql6.Locate('cod_gal',fieldbyname('cod_class').AsInteger,[])) then
               ComboBox_class2.Text:= dm.ds_sql6.fieldbyname('descricao').AsString
...
procedure Tmdl_events2.limpaphoto1(xupdateset:Boolean);
begin
...
procedure Tmdl_events2.atualiza_grade2;
var axshowing: Boolean;
    st_stream : TMemoryStream;
begin
     //banco de imagens
...
procedure Tmdl_events2.limpaphoto2(xupdateset:Boolean);
begin
...
procedure Tmdl_events2.bt_new1Click(Sender: TObject);
begin
      addreg;
      ab_titulo.SetFocus;
end;

procedure Tmdl_events2.bt_new2Click(Sender: TObject);
begin
      addreg2;
      ms_titulo.SetFocus;
end;

procedure Tmdl_events2.bt_save1Click(Sender: TObject);
...
begin
     ...
     if (axgrpname <> '') then begin
        if (dm.ds_sql6.Locate('descricao',axgrpname,[])) then
           axcodgrp:= dm.ds_sql6.fieldbyname('cod_gal').AsInteger
        else ComboBox_class2.ItemIndex:=0;
     end;
...
procedure Tmdl_events2.ComboBox_webChange(Sender: TObject);
begin
...
procedure Tmdl_events2.bt_save2Click(Sender: TObject);
...
procedure Tmdl_events2.getLogo1;
...
procedure Tmdl_events2.abretmplogo1;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp1.Seek(0,soFromBeginning);
...
procedure Tmdl_events2.getLogo2;
var axcodBlb: Integer;
begin
     try
...
procedure Tmdl_events2.abretmplogo2;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp2.Seek(0,soFromBeginning);
...
procedure Tmdl_events2.getBanner;
begin
     xbannertmp.Clear;
...
procedure Tmdl_events2.abretmpbanner;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xbannertmp.Seek(0,soFromBeginning);
...
procedure Tmdl_events2.bt_limpar1Click(Sender: TObject);
begin
      limpaphoto1(True);
...
procedure Tmdl_events2.bt_limpar2Click(Sender: TObject);
begin
      limpaphoto2(True);
...
procedure Tmdl_events2.bt_view1Click(Sender: TObject);
begin
      if dm.ds_sql.RecordCount>0 then begin
         ...
         mdl_richgalery_view.Left:=mdl_events2.Width-mdl_richgalery_view.Width;
         mdl_richgalery_view.Top:=mdl_events2.Height-mdl_richgalery_view.Height;
         mdl_richgalery_view.Show;
      end;
end;

procedure Tmdl_events2.bt_open1Click(Sender: TObject);
...
procedure Tmdl_events2.bt_open2Click(Sender: TObject);
var xfilext,xnamefile: String;
    xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
    xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp: Integer;
...
procedure Tmdl_events2.chk_view1Click(Sender: TObject);
begin
      if chk_view1.Checked then getLogo1;
end;

procedure Tmdl_events2.chk_view2Click(Sender: TObject);
begin
      if chk_view2.Checked then getLogo2;
end;

procedure Tmdl_events2.Splitter1Moved(Sender: TObject);
begin
      ComboBox_web.Width:=ToolBar_web.Width-53;
end;

procedure Tmdl_events2.DBGrid1CellClick(Column: TColumn);
begin
      atualiza_grade;
end;

procedure Tmdl_events2.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_events2.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_events2.DBGrid1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade;
end;

procedure Tmdl_events2.DBGrid2CellClick(Column: TColumn);
begin
      atualiza_grade2;
end;

procedure Tmdl_events2.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_events2.DBGrid2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_events2.DBGrid2MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade2;
end;

procedure Tmdl_events2.ComboSpeedButton1Click(Sender: TObject);
begin
      getLogo2;
end;

procedure Tmdl_events2.bt_recursiveClick(Sender: TObject);
...
function Tmdl_events2.inserimg(xnamefile,xfilext:String;
                      xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
                      xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp:Integer;
                      xic_ajt,xic_pr,xil_ajt,xil_pr: Boolean):Boolean;
...
function Tmdl_events2.retorna_TTabSheet(xidxcod:Integer):TTabSheet;
begin
      Case xidxcod of
          0: Result:=lngtb1;
          1: Result:=lngtb2;
...
procedure Tmdl_events2.PageControl_languagensChange(Sender: TObject);
begin
...
procedure Tmdl_events2.Timer_traduzTimer(Sender: TObject);
begin
      Inc(xtimerresponse);
end;

procedure Tmdl_events2.Tradutor1AoTraduzir(Sender: TObject;
  Traducao: String);
begin
    xreceivetrad:=Traducao;
end;

function Tmdl_events2.recebetraducao(xtrad_text,xtrad_de,xtrad_para: String):String;
var xrecebido: Bool;
begin
      xrecebido:=false;
      xreceivetrad:='';
...
procedure Tmdl_events2.save_cfg(xcodlng: Integer);
var axcod : integer;
    axshowing: Boolean;
begin
     axshowing:= loadx.Showing;
...
procedure Tmdl_events2.monta_table3;
var listaLng_id,axcoddefault,xid_default: Integer;
    axshowing: Boolean;
    //inclui linguagens
...
procedure Tmdl_events2.atualiza_grade3;
var axshowing: Boolean;
    axlocid: Integer;
begin
     //banner
...
procedure Tmdl_events2.limpaphoto3(xupdateset:Boolean);
begin
...
procedure Tmdl_events2.bt_open3Click(Sender: TObject);
var xfilext,xnamefile: String;
    xerror: Boolean;
    codBitmap: TBitmap;
    codJpeg: TJPEGImage;
...
procedure Tmdl_events2.bt_limpar3Click(Sender: TObject);
begin
      limpaphoto3(true);
end;

procedure Tmdl_events2.bt_save3Click(Sender: TObject);
begin
      save_cfg(listaLng.cod_lng[PageControl_languagens.TabIndex]);
end;

procedure Tmdl_events2.PageControl1Change(Sender: TObject);
begin
...
procedure Tmdl_events2.MenuItem1Click(Sender: TObject);
var axshowing: Boolean;
begin
...
procedure Tmdl_events2.bt_del2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_events2.ComboBox_entChange(Sender: TObject);
begin
      if StrtoInt(AxDadosUsr.axparm) > 5000 then begin
...
procedure Tmdl_events2.bt_helpClick(Sender: TObject);
begin
      //Tópicos de ajuda
...
procedure Tmdl_events2.StatusBar1Click(Sender: TObject);
begin
      hwsf.BtSobre;
end;

procedure Tmdl_events2.ToolBar_grpResize(Sender: TObject);
begin
     cb_group.Width := ToolBar_grp.Width - 50;
end;

procedure Tmdl_events2.Desfazer1Click(Sender: TObject);
begin
     //desfazer
...
procedure Tmdl_events2.Recortar1Click(Sender: TObject);
begin
     //recortar
     retorna_TRxRichEdit(PageControlab.TabIndex).CutToClipboard;
end;

procedure Tmdl_events2.Copiar1Click(Sender: TObject);
begin
     //copiar
     retorna_TRxRichEdit(PageControlab.TabIndex).CopyToClipboard;
end;

procedure Tmdl_events2.Colar1Click(Sender: TObject);
begin
      //colar
     retorna_TRxRichEdit(PageControlab.TabIndex).PasteFromClipboard;
end;

procedure Tmdl_events2.Cor1Click(Sender: TObject);
begin
     //cor da fonte
...
procedure Tmdl_events2.Negrito1Click(Sender: TObject);
begin
     //negrito
     if FUpdating then Exit;
...
procedure Tmdl_events2.Italico1Click(Sender: TObject);
begin
     //italico
     if FUpdating then Exit;
...
procedure Tmdl_events2.Sublinhado1Click(Sender: TObject);
begin
     //sublinhado
     if FUpdating then Exit;
...
procedure Tmdl_events2.Marcador1Click(Sender: TObject);
begin
     //marcador
     if FUpdating then Exit;
...
procedure Tmdl_events2.AlignButtonClick(Sender: TObject);
begin
...
procedure Tmdl_events2.esquerdo1Click(Sender: TObject);
begin
     retorna_LeftAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_events2.centro1Click(Sender: TObject);
begin
     retorna_CenterAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_events2.direita1Click(Sender: TObject);
begin
     retorna_RightAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_events2.justificado1Click(Sender: TObject);
begin
     retorna_JustifyAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_events2.re_editorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tmdl_events2.SelectionChange(Sender: TObject);
begin
  //if processoand then exit;
...
function Tmdl_events2.CurrText: TRxTextAttributes;
begin
...
procedure Tmdl_events2.SetEditRect;
var
  R: TRect;
begin
  with retorna_TRxRichEdit(PageControlab.TabIndex) do
...
procedure Tmdl_events2.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
function Tmdl_events2.retorna_TRxRichEdit(xidxcod:Integer):TRxRichEdit;
begin
      Case xidxcod of
          0: Result:=re_editor1;
          1: Result:=re_editor2;
...
function Tmdl_events2.retorna_fontName(xidxcod:Integer):TComboBox;
begin
      Case xidxcod of
          0: Result:=FontName1;
          1: Result:=FontName2;
...
function Tmdl_events2.retorna_fontSize(xidxcod:Integer):TEdit;
begin
      Case xidxcod of
          0: Result:=FontSize1;
          1: Result:=FontSize2;
...
function Tmdl_events2.retorna_BoldButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_events2.retorna_ItalicButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_events2.retorna_UnderlineButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_events2.retorna_LeftAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
          0: Result:=LeftAlign1;
          1: Result:=LeftAlign2;
...
function Tmdl_events2.retorna_CenterAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_events2.retorna_RightAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_events2.retorna_JustifyAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_events2.retorna_BulletsButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
procedure Tmdl_events2.cb_groupChange(Sender: TObject);
begin
...
procedure Tmdl_events2.monta_tableclass;
...
begin
      ...
      if not axshowing then begin
         loadx := Tloadx.Create(Application);
         loadx.lbloading.Caption:='Montando lista de artistas';
         loadx.Show;
         loadx.Update;
      end else begin
         loadx.lbloading.Caption:='Montando lista de artistas';
      ...
      With dm.ds_sql6 do begin
          if Active then close;
          CommandText:= 'SELECT codigo,cod_gal,cod_lng,descricao,xtp FROM '+LstTables.Table[9]+
                        ' WHERE cod_web='+#39+InttoStr(AxDadosUsr.cod_web)+#39+' AND xtp='+#39+'201'+#39+
                        ' ORDER BY descricao';
          Open;
          Filtered:=true;
          try
          ...
          ComboBox_class.Items.Add('Exibir todos os Artistas');
          First;
          While not Eof do begin
              if (axclass2 = fieldbyname('descricao').AsString) then axcodclass2:=true;
              ComboBox_class.Items.Add(fieldbyname('descricao').AsString);
              Next;
          end;
...
procedure Tmdl_events2.PanelclassResize(Sender: TObject);
begin
    ComboBox_class.Width := Panelclass.Width-64;
    CheckBox_class.Left:= ComboBox_class.Width+10;
end;

procedure Tmdl_events2.EVsaveKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_events2.EVsave2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_events2.Cordefundo1Click(Sender: TObject);
begin
      //cor de fundo
      if ColorDialog1.Execute then begin
...
procedure Tmdl_events2.validaCbClass();
begin
      if CheckBox_class.Checked then begin
         if (ComboBox_class.ItemIndex > 0) then begin
            if (dm.ds_sql6.Locate('descricao',ComboBox_class.Text,[])) then
               dm.ds_sql.Filter:='(('+xdsqlfilter+') AND (cod_class='+#39+dm.ds_sql6.fieldbyname('cod_gal').AsString+#39+'))';
         end else dm.ds_sql.Filter:=xdsqlfilter;
      end;
end;

procedure Tmdl_events2.CheckBox_classClick(Sender: TObject);
begin
      validaCbClass();
end;

procedure Tmdl_events2.ComboBox_classKeyPress(Sender: TObject;
  var Key: Char);
begin
      if key=#13 then validaCbClass();
end;

procedure Tmdl_events2.ComboBox_classClick(Sender: TObject);
begin
      validaCbClass();
end;

function Tmdl_events2.Btsearch_auto_ax(pathdefault,filtrofind:string):Tbt_search_ax;
...
procedure Tmdl_events2.monta_uf(xselect:Boolean; xufdefault:string);
...
procedure Tmdl_events2.monta_cid(xuf,xciddefault:String);
...
procedure Tmdl_events2.xcp18_axufChange(Sender: TObject);
begin
     monta_cid(xcp18_axuf.text,'');
end;

procedure Tmdl_events2.bt_exp1Click(Sender: TObject);
var xfiljpg : String;
...
procedure Tmdl_events2.bt_view2Click(Sender: TObject);
begin
      if dm.ds_sql3.RecordCount>0 then begin
         Application.CreateForm(Tmdl_richgalery_view,mdl_richgalery_view);
         mdl_richgalery_view.TableImage.xcp_cod:='codigo';
...
procedure Tmdl_events2.bt_exp2Click(Sender: TObject);
var xfiljpg : String;
    xImagem_tmp : TMemoryStream;
begin
      if ExportarImgDialog.Execute then begin
...
procedure Tmdl_events2.SpeedButton2Click(Sender: TObject);
...
procedure Tmdl_events2.SpeedButton4Click(Sender: TObject);
begin
      DBGrid1.SetFocus;
...
procedure Tmdl_events2.xfil_ate_chkClick(Sender: TObject);
begin
      xfil_ate.Enabled:=xfil_ate_chk.Checked;
end;

procedure Tmdl_events2.xfil_de_chkClick(Sender: TObject);
begin
      xfil_de.Enabled:=xfil_de_chk.Checked;
end;

procedure Tmdl_events2.calend1Click(Sender: TObject);
//var axtm: String;
begin
...
procedure Tmdl_events2.PanelbtviewResize(Sender: TObject);
begin
    bt_view1.Height:=Panelbtview.Height-49;
end;

procedure Tmdl_events2.Panelbtview2Resize(Sender: TObject);
begin
    bt_view2.Height:=Panelbtview2.Height-49;
end;

procedure Tmdl_events2.bt_imgRotateh1Click(Sender: TObject);
begin
...
procedure Tmdl_events2.bt_imgRotatea1Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp1,xlogosz1,xupdatelogo1,ComboBox_model.Text,LstTables.Table[1],'cod_gal','icon',ab_cod.Caption) then
        abretmplogo1;
end;

procedure Tmdl_events2.bt_imgRotateh2Click(Sender: TObject);
begin
...
procedure Tmdl_events2.bt_imgRotatea2Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp2,xlogosz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_ico',ms_cod.Caption) then begin
        if dm.rotateFoto(-90,xampltmp2,xamplsz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_larg',ms_cod.Caption) then
           abretmplogo2
...
procedure Tmdl_events2.MenuItem2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_events2.bt_cancel1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_events2.bt_activate1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_events2.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
