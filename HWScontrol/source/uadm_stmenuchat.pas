...
begin
      ...
      adm_stmenuchat.Caption := AxDadosUsr.axtitle;
...
function Tadm_stmenuchat.atualizaultimoacesso:Boolean;
begin
      if processoand then exit;
...
procedure Tadm_stmenuchat.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
