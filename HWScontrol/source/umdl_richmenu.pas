...
procedure Tmdl_richmenu.FormClose(Sender: TObject; var Action: TCloseAction);
...
procedure Tmdl_richmenu.FormCreate(Sender: TObject);
var axshowing: Boolean;
...
begin
     ...
     mdl_richmenu.Caption:= AxDadosUsr.axtitle;
     xinit:=true;
     axcod_ent:=0;
     PageControltxLast:=-1;
...
procedure Tmdl_richmenu.monta_lng;
...
procedure Tmdl_richmenu.monta_table1;
var axshowing: Boolean;
...
procedure Tmdl_richmenu.monta_table2(xnewgal,xuplng:Boolean);
begin
...
procedure Tmdl_richmenu.FormResize(Sender: TObject);
begin
...
procedure Tmdl_richmenu.FormActivate(Sender: TObject);
begin
      try
        mdl_richmenu.Refresh;
      except
      end;
      if xinit then begin
         xinit:=false;
...
procedure Tmdl_richmenu.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      Case key of
...
procedure Tmdl_richmenu.addreg;
begin
...
procedure Tmdl_richmenu.travaformImages(xtrava: Boolean);
begin
...
procedure Tmdl_richmenu.addreg2;
begin
     ms_cod.Caption:='novo';
     ax_ms_cod:=0;
     ms_titulo.Text:='';
...
procedure Tmdl_richmenu.atualiza_grade;
var axshowing: Boolean;
    axlocid: Integer;
...
procedure Tmdl_richmenu.limpaphoto1(xupdateset:Boolean);
begin
...
procedure Tmdl_richmenu.atualiza_grade2;
var axshowing: Boolean;
...
procedure Tmdl_richmenu.limpaphoto2(xupdateset:Boolean);
begin
...
procedure Tmdl_richmenu.bt_new1Click(Sender: TObject);
begin
      addreg;
      ab_titulo.SetFocus;
end;

procedure Tmdl_richmenu.bt_new2Click(Sender: TObject);
begin
      addreg2;
      ms_titulo.SetFocus;
end;

procedure Tmdl_richmenu.bt_save1Click(Sender: TObject);
...
begin
     ...
     if (ComboBox_class2.ItemIndex<0) then begin
        hwsf.BtMensagem('É necessário selecionar o Menu.');
...
procedure Tmdl_richmenu.ComboBox_webChange(Sender: TObject);
begin
...
procedure Tmdl_richmenu.bt_save2Click(Sender: TObject);
...
procedure Tmdl_richmenu.getLogo1;
...
procedure Tmdl_richmenu.abretmplogo1;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp1.Seek(0,soFromBeginning);
...
procedure Tmdl_richmenu.getLogo2;
var axcodBlb: Integer;
begin
     try
...
procedure Tmdl_richmenu.abretmplogo2;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp2.Seek(0,soFromBeginning);
...
procedure Tmdl_richmenu.getBanner;
begin
     xbannertmp.Clear;
...
procedure Tmdl_richmenu.abretmpbanner;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xbannertmp.Seek(0,soFromBeginning);
...
procedure Tmdl_richmenu.bt_limpar1Click(Sender: TObject);
begin
      limpaphoto1(True);
...
procedure Tmdl_richmenu.bt_limpar2Click(Sender: TObject);
begin
      limpaphoto2(True);
...
procedure Tmdl_richmenu.bt_view1Click(Sender: TObject);
begin
      if dm.ds_sql.RecordCount>0 then begin
         ...
         mdl_richgalery_view.Left:=mdl_richmenu.Width-mdl_richgalery_view.Width;
         mdl_richgalery_view.Top:=mdl_richmenu.Height-mdl_richgalery_view.Height;
         mdl_richgalery_view.Show;
      end;
end;

procedure Tmdl_richmenu.bt_open1Click(Sender: TObject);
...
procedure Tmdl_richmenu.bt_open2Click(Sender: TObject);
var xfilext,xnamefile: String;
    xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
    xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp: Integer;
...
procedure Tmdl_richmenu.chk_view1Click(Sender: TObject);
begin
      if chk_view1.Checked then getLogo1;
end;

procedure Tmdl_richmenu.chk_view2Click(Sender: TObject);
begin
      if chk_view2.Checked then getLogo2;
end;

procedure Tmdl_richmenu.Splitter1Moved(Sender: TObject);
begin
      ComboBox_web.Width:=ToolBar_web.Width-53;
end;

procedure Tmdl_richmenu.DBGrid1CellClick(Column: TColumn);
begin
      atualiza_grade;
end;

procedure Tmdl_richmenu.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_richmenu.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_richmenu.DBGrid1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade;
end;

procedure Tmdl_richmenu.DBGrid2CellClick(Column: TColumn);
begin
      atualiza_grade2;
end;

procedure Tmdl_richmenu.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_richmenu.DBGrid2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_richmenu.DBGrid2MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade2;
end;

procedure Tmdl_richmenu.bt_recursiveClick(Sender: TObject);
...
function Tmdl_richmenu.inserimg(xnamefile,xfilext:String;
                      xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
                      xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp:Integer;
                      xic_ajt,xic_pr,xil_ajt,xil_pr: Boolean):Boolean;
...
function Tmdl_richmenu.retorna_TTabSheet(xidxcod:Integer):TTabSheet;
begin
      Case xidxcod of
          0: Result:=lngtb1;
          1: Result:=lngtb2;
...
procedure Tmdl_richmenu.PageControl_languagensChange(Sender: TObject);
begin
...
procedure Tmdl_richmenu.Timer_traduzTimer(Sender: TObject);
begin
      Inc(xtimerresponse);
end;

procedure Tmdl_richmenu.Tradutor1AoTraduzir(Sender: TObject;
  Traducao: String);
begin
    xreceivetrad:=Traducao;
end;

function Tmdl_richmenu.recebetraducao(xtrad_text,xtrad_de,xtrad_para: String):String;
var xrecebido: Bool;
begin
      xrecebido:=false;
      xreceivetrad:='';
...
procedure Tmdl_richmenu.save_cfg(xcodlng: Integer);
var axcod : integer;
    axshowing: Boolean;
begin
     axshowing:= loadx.Showing;
...
procedure Tmdl_richmenu.monta_table3;
var listaLng_id,axcoddefault,xid_default: Integer;
    axshowing: Boolean;
    //inclui linguagens
...
procedure Tmdl_richmenu.atualiza_grade3;
var axshowing: Boolean;
    axlocid: Integer;
begin
     //banner
...
procedure Tmdl_richmenu.limpaphoto3(xupdateset:Boolean);
begin
...
procedure Tmdl_richmenu.bt_open3Click(Sender: TObject);
var xfilext,xnamefile: String;
    xerror: Boolean;
    codBitmap: TBitmap;
    codJpeg: TJPEGImage;
...
procedure Tmdl_richmenu.bt_limpar3Click(Sender: TObject);
begin
      limpaphoto3(true);
end;

procedure Tmdl_richmenu.bt_save3Click(Sender: TObject);
begin
      save_cfg(listaLng.cod_lng[PageControl_languagens.TabIndex]);
end;

procedure Tmdl_richmenu.PageControl1Change(Sender: TObject);
begin
...
procedure Tmdl_richmenu.MenuItem1Click(Sender: TObject);
var axshowing: Boolean;
begin
...
procedure Tmdl_richmenu.bt_del2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_richmenu.ComboBox_entChange(Sender: TObject);
begin
      if StrtoInt(AxDadosUsr.axparm) > 5000 then begin
...
procedure Tmdl_richmenu.bt_helpClick(Sender: TObject);
begin
      //Tópicos de ajuda
...
procedure Tmdl_richmenu.StatusBar1Click(Sender: TObject);
begin
      hwsf.BtSobre;
end;

procedure Tmdl_richmenu.ToolBar_grpResize(Sender: TObject);
begin
     cb_group.Width := ToolBar_grp.Width;
end;

procedure Tmdl_richmenu.Desfazer1Click(Sender: TObject);
begin
     //desfazer
...
procedure Tmdl_richmenu.Recortar1Click(Sender: TObject);
begin
     //recortar
     retorna_TRxRichEdit(PageControlab.TabIndex).CutToClipboard;
end;

procedure Tmdl_richmenu.Copiar1Click(Sender: TObject);
begin
     //copiar
     retorna_TRxRichEdit(PageControlab.TabIndex).CopyToClipboard;
end;

procedure Tmdl_richmenu.Colar1Click(Sender: TObject);
begin
      //colar
     retorna_TRxRichEdit(PageControlab.TabIndex).PasteFromClipboard;
end;

procedure Tmdl_richmenu.Cor1Click(Sender: TObject);
begin
     //cor da fonte
...
procedure Tmdl_richmenu.Negrito1Click(Sender: TObject);
begin
     //negrito
     if FUpdating then Exit;
...
procedure Tmdl_richmenu.Italico1Click(Sender: TObject);
begin
     //italico
     if FUpdating then Exit;
...
procedure Tmdl_richmenu.Sublinhado1Click(Sender: TObject);
begin
     //sublinhado
     if FUpdating then Exit;
...
procedure Tmdl_richmenu.Marcador1Click(Sender: TObject);
begin
     //marcador
     if FUpdating then Exit;
...
procedure Tmdl_richmenu.AlignButtonClick(Sender: TObject);
begin
...
procedure Tmdl_richmenu.esquerdo1Click(Sender: TObject);
begin
     retorna_LeftAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richmenu.centro1Click(Sender: TObject);
begin
     retorna_CenterAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richmenu.direita1Click(Sender: TObject);
begin
     retorna_RightAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richmenu.justificado1Click(Sender: TObject);
begin
     retorna_JustifyAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richmenu.re_editorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tmdl_richmenu.SelectionChange(Sender: TObject);
begin
  //if processoand then exit;
  try
...
function Tmdl_richmenu.CurrText: TRxTextAttributes;
begin
...
procedure Tmdl_richmenu.SetEditRect;
var
  R: TRect;
begin
  with retorna_TRxRichEdit(PageControlab.TabIndex) do
...
procedure Tmdl_richmenu.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
function Tmdl_richmenu.retorna_TRxRichEdit(xidxcod:Integer):TRxRichEdit;
begin
      Case xidxcod of
          //0: Result:=re_editor1;
          1: Result:=re_editor2;
...
function Tmdl_richmenu.retorna_fontName(xidxcod:Integer):TComboBox;
begin
      Case xidxcod of
          //0: Result:=FontName1;
          1: Result:=FontName2;
...
function Tmdl_richmenu.retorna_fontSize(xidxcod:Integer):TEdit;
begin
      Case xidxcod of
          //0: Result:=FontSize1;
          1: Result:=FontSize2;
...
function Tmdl_richmenu.retorna_BoldButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richmenu.retorna_ItalicButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richmenu.retorna_UnderlineButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richmenu.retorna_LeftAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
          //0: Result:=LeftAlign1;
          1: Result:=LeftAlign2;
...
function Tmdl_richmenu.retorna_CenterAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richmenu.retorna_RightAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richmenu.retorna_JustifyAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richmenu.retorna_BulletsButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richmenu.atualizafeed:Boolean;
begin
    WebBrowser_feed.Navigate('http://'+AxDadosUsr.website+'/feedemp_upd.php');
end;

procedure Tmdl_richmenu.cb_groupChange(Sender: TObject);
begin
...
procedure Tmdl_richmenu.monta_tableclass;
var axshowing: Boolean;
    axclass: Integer;
begin
      axshowing:= loadx.Showing;
      if not axshowing then begin
         loadx := Tloadx.Create(Application);
         loadx.lbloading.Caption:='Montando Menus';
         loadx.Show;
         loadx.Update;
      end else begin
         loadx.lbloading.Caption:='Montando Menus';
...
procedure Tmdl_richmenu.EVsaveKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_richmenu.EVsave2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_richmenu.Cordefundo1Click(Sender: TObject);
begin
      //cor de fundo
      if ColorDialog1.Execute then begin
...
procedure Tmdl_richmenu.validaCbClass;
...
function Tmdl_richmenu.Btsearch_auto_ax(pathdefault,filtrofind:string):Tbt_search_ax;
...
procedure Tmdl_richmenu.bt_exp1Click(Sender: TObject);
var xfiljpg : String;
...
procedure Tmdl_richmenu.bt_view2Click(Sender: TObject);
begin
      if dm.ds_sql3.RecordCount>0 then begin
         Application.CreateForm(Tmdl_richgalery_view,mdl_richgalery_view);
         mdl_richgalery_view.TableImage.xcp_cod:='codigo';
...
procedure Tmdl_richmenu.bt_exp2Click(Sender: TObject);
var xfiljpg : String;
    xImagem_tmp : TMemoryStream;
begin
      if ExportarImgDialog.Execute then begin
...
procedure Tmdl_richmenu.SpeedButton2Click(Sender: TObject);
...
procedure Tmdl_richmenu.PanelbtviewResize(Sender: TObject);
begin
    bt_view1.Height:=Panelbtview.Height-49;
end;

procedure Tmdl_richmenu.Panelbtview2Resize(Sender: TObject);
begin
    bt_view2.Height:=Panelbtview2.Height-49;
end;

procedure Tmdl_richmenu.bt_imgRotateh1Click(Sender: TObject);
begin
...
procedure Tmdl_richmenu.bt_imgRotatea1Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp1,xlogosz1,xupdatelogo1,ComboBox_model.Text,LstTables.Table[1],'cod_gal','icon',ab_cod.Caption) then
        abretmplogo1;
end;

procedure Tmdl_richmenu.bt_imgRotateh2Click(Sender: TObject);
begin
...
procedure Tmdl_richmenu.bt_imgRotatea2Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp2,xlogosz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_ico',ms_cod.Caption) then begin
        if dm.rotateFoto(-90,xampltmp2,xamplsz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_larg',ms_cod.Caption) then
           abretmplogo2
...
procedure Tmdl_richmenu.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
...
procedure Tmdl_richmenu.resetWebBrowse;
...
procedure Tmdl_richmenu.SetRepetirImagem(xreptid:Integer);
var axreptx: String;
begin
    Case xreptid of
        0: axreptx:='no-repeat';
...
procedure Tmdl_richmenu.setxHtml(xabaED:Integer);
...
procedure Tmdl_richmenu.InternalSaveDocumentToStream(
...
procedure Tmdl_richmenu.InternalSaveBodyHTMLToStream(const Stream: TStream);
var
  HTMLStr: string;
  Doc: IHTMLDocument2;
...
procedure Tmdl_richmenu.InternalSaveBodyHTMLToStringList(const StringList: TStringList);
var
  HTMLStr: string;
  Doc: IHTMLDocument2;
  BodyElement: IHTMLElement;
...
procedure Tmdl_richmenu.InternalSaveBodyTextToStream(const Stream: TStream);
var
  TextStr: string;
  Doc: IHTMLDocument2;
  BodyElement: IHTMLElement;
...
procedure Tmdl_richmenu.InternalLoadDocumentFromStream(const Stream: TStream);
var
  PersistStreamInit: IPersistStreamInit;
  StreamAdapter: IStream;
begin
...
procedure Tmdl_richmenu.SpeedButton10Click(Sender: TObject);
begin
    resetWebBrowse;
end;

procedure Tmdl_richmenu.SpeedButton9Click(Sender: TObject);
begin
      bt_save1.Click;
end;

procedure Tmdl_richmenu.SpeedButton11Click(Sender: TObject);
begin
    InvokeCMD(WebBrowser1, HTMLID_FIND);
end;

procedure Tmdl_richmenu.SpeedButton8Click(Sender: TObject);
var
...
procedure Tmdl_richmenu.NoRepetir1Click(Sender: TObject);
begin
    if (not NoRepetir1.Checked) then
        SetRepetirImagem(0);
end;

procedure Tmdl_richmenu.repetirimagem1Click(Sender: TObject);
begin
    if (not repetirimagem1.Checked) then
        SetRepetirImagem(1);
end;

procedure Tmdl_richmenu.RepetirX1Click(Sender: TObject);
begin
    if (not RepetirX1.Checked) then
        SetRepetirImagem(2);
end;

procedure Tmdl_richmenu.RepetirY1Click(Sender: TObject);
begin
    if (not RepetirY1.Checked) then
        SetRepetirImagem(3);
end;

procedure Tmdl_richmenu.Fixarfundo1Click(Sender: TObject);
begin
...
procedure Tmdl_richmenu.Limpar1Click(Sender: TObject);
begin
       HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
...
procedure Tmdl_richmenu.combofontChange(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('FontName', False,ComboFont.Text);
end;

procedure Tmdl_richmenu.ComboSizeChange(Sender: TObject);
begin
...
procedure Tmdl_richmenu.SpeedButton1Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('Bold', False,0);
end;

procedure Tmdl_richmenu.SpeedButton3Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('Italic', False,0);
end;

procedure Tmdl_richmenu.SpeedButton5Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('Underline', False,0);
end;

procedure Tmdl_richmenu.SpeedButton6Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    if cdColor.Execute then
...
procedure Tmdl_richmenu.ComboSpeedButton1Click(Sender: TObject);
...
procedure Tmdl_richmenu.ComboBox_classClick(Sender: TObject);
begin
      validaCbClass;
end;

procedure Tmdl_richmenu.ComboBox_classKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      validaCbClass;
end;

procedure Tmdl_richmenu.ComboBox_classKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      validaCbClass;
end;

procedure Tmdl_richmenu.ComboBox_classMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      validaCbClass;
end;

procedure Tmdl_richmenu.WebBrowser_feedDownloadComplete(Sender: TObject);
begin
      feedokupd:=true;
end;

procedure Tmdl_richmenu.alt_ordem(xtypOrd:Integer);
...
begin
    ...
    if (not updord) then begin
        hwsf.BtMensagem('Menu selecionado Inválido.');
        Exit;
    end;
    //Cadastrando novo
    axshowing:= loadx.Showing;
...
procedure Tmdl_richmenu.bt_ordemupClick(Sender: TObject);
begin
      alt_ordem(0);
end;

procedure Tmdl_richmenu.bt_ordemdownClick(Sender: TObject);
begin
      alt_ordem(1);
end;

procedure Tmdl_richmenu.bt_newSrvClick(Sender: TObject);
var axgrpname: String;
    axshowing,xexecutaimg: Boolean;
    axcod,axcl_id: Integer; 
    xtxt3: TMemoryStream;
begin
      axgrpname:=hwsf.BtDesc('Digite o título do Menu:');
...
procedure Tmdl_richmenu.bt_delSrvClick(Sender: TObject);
...
begin
      ...
      With dm.ds_sql8 do begin
         ...
         if (recordcount>0) then begin
            axvincul:=true;
            Close;
            hwsf.BtMensagem('Exclusão não permitida, pois itens vinculados a este Menu.');
            Exit;
         end;
      end;
      axshowing:= loadx.Showing;
...
procedure Tmdl_richmenu.bt_del1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
