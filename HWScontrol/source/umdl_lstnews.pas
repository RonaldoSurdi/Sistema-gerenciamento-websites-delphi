...
procedure Tmdl_lstnews.FormClose(Sender: TObject; var Action: TCloseAction);
...
procedure Tmdl_lstnews.FormCreate(Sender: TObject);
var axshowing: Boolean;
...
begin
     ...
     mdl_lstnews.Caption:= AxDadosUsr.axtitle;
     xinit:=true;
     axcod_ent:=0;
     ...
     With DBGrid1.Columns do begin
          ...
          Items[1].Width:=200;
          Add;
          Items[2].Title.Caption:='Local';
          Items[2].FieldName:='loc';
     end;
...
procedure Tmdl_lstnews.monta_lng;
...
procedure Tmdl_lstnews.monta_table1;
var axshowing: Boolean;
...
procedure Tmdl_lstnews.monta_table2(xnewgal,xuplng:Boolean);
begin
...
procedure Tmdl_lstnews.FormResize(Sender: TObject);
begin
...
procedure Tmdl_lstnews.FormActivate(Sender: TObject);
begin
      mdl_lstnews.Refresh;
      if xinit then begin
         xinit:=false;
...
procedure Tmdl_lstnews.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      Case key of
...
procedure Tmdl_lstnews.travaformImages(xtrava: Boolean);
begin
...
procedure Tmdl_lstnews.addreg2;
begin
     ms_cod.Caption:='novo';
     ax_ms_cod:=0;
     ms_titulo.Text:='';
...
procedure Tmdl_lstnews.atualiza_grade;
var axshowing: Boolean;
    axlocid: Integer;
...
procedure Tmdl_lstnews.limpaphoto1(xupdateset:Boolean);
begin
...
procedure Tmdl_lstnews.atualiza_grade2;
var axshowing: Boolean;
    st_stream : TMemoryStream;
begin
     //banco de imagens
...
procedure Tmdl_lstnews.limpaphoto2(xupdateset:Boolean);
begin
...
procedure Tmdl_lstnews.bt_new1Click(Sender: TObject);
begin
      addreg;
      ab_titulo.SetFocus;
end;

procedure Tmdl_lstnews.bt_new2Click(Sender: TObject);
begin
      addreg2;
      ms_titulo.SetFocus;
end;

procedure Tmdl_lstnews.bt_save1Click(Sender: TObject);
...
procedure Tmdl_lstnews.ComboBox_webChange(Sender: TObject);
begin
...
procedure Tmdl_lstnews.bt_save2Click(Sender: TObject);
...
procedure Tmdl_lstnews.getLogo1;
...
procedure Tmdl_lstnews.abretmplogo1;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp1.Seek(0,soFromBeginning);
...
procedure Tmdl_lstnews.getLogo2;
var axcodBlb: Integer;
begin
     try
...
procedure Tmdl_lstnews.abretmplogo2;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp2.Seek(0,soFromBeginning);
...
procedure Tmdl_lstnews.getBanner;
begin
     xbannertmp.Clear;
...
procedure Tmdl_lstnews.abretmpbanner;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xbannertmp.Seek(0,soFromBeginning);
...
procedure Tmdl_lstnews.bt_limpar1Click(Sender: TObject);
begin
      limpaphoto1(True);
...
procedure Tmdl_lstnews.bt_limpar2Click(Sender: TObject);
begin
      limpaphoto2(True);
...
procedure Tmdl_lstnews.bt_view1Click(Sender: TObject);
begin
      if dm.ds_sql.RecordCount>0 then begin
         ...
         mdl_richgalery_view.Left:=mdl_lstnews.Width-mdl_richgalery_view.Width;
         mdl_richgalery_view.Top:=mdl_lstnews.Height-mdl_richgalery_view.Height;
         mdl_richgalery_view.Show;
      end;
end;

procedure Tmdl_lstnews.bt_open1Click(Sender: TObject);
...
procedure Tmdl_lstnews.bt_open2Click(Sender: TObject);
var xfilext,xnamefile: String;
    xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
    xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp: Integer;
...
procedure Tmdl_lstnews.chk_view1Click(Sender: TObject);
begin
      if chk_view1.Checked then getLogo1;
end;

procedure Tmdl_lstnews.chk_view2Click(Sender: TObject);
begin
      if chk_view2.Checked then getLogo2;
end;

procedure Tmdl_lstnews.Splitter1Moved(Sender: TObject);
begin
      ComboBox_web.Width:=ToolBar_web.Width-53;
end;

procedure Tmdl_lstnews.DBGrid1CellClick(Column: TColumn);
begin
      atualiza_grade;
end;

procedure Tmdl_lstnews.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_lstnews.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_lstnews.DBGrid1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade;
end;

procedure Tmdl_lstnews.DBGrid2CellClick(Column: TColumn);
begin
      atualiza_grade2;
end;

procedure Tmdl_lstnews.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_lstnews.DBGrid2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_lstnews.DBGrid2MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade2;
end;

procedure Tmdl_lstnews.ComboSpeedButton1Click(Sender: TObject);
begin
      getLogo2;
end;

procedure Tmdl_lstnews.bt_recursiveClick(Sender: TObject);
...
function Tmdl_lstnews.inserimg(xnamefile,xfilext:String;
                      xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
                      xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp:Integer;
                      xic_ajt,xic_pr,xil_ajt,xil_pr: Boolean):Boolean;
...
function Tmdl_lstnews.retorna_TTabSheet(xidxcod:Integer):TTabSheet;
begin
      Case xidxcod of
          0: Result:=lngtb1;
          1: Result:=lngtb2;
...
procedure Tmdl_lstnews.PageControl_languagensChange(Sender: TObject);
begin
...
procedure Tmdl_lstnews.Timer_traduzTimer(Sender: TObject);
begin
      Inc(xtimerresponse);
end;

procedure Tmdl_lstnews.Tradutor1AoTraduzir(Sender: TObject;
  Traducao: String);
begin
    xreceivetrad:=Traducao;
end;

function Tmdl_lstnews.recebetraducao(xtrad_text,xtrad_de,xtrad_para: String):String;
var xrecebido: Bool;
begin
      xrecebido:=false;
      xreceivetrad:='';
...
procedure Tmdl_lstnews.save_cfg(xcodlng: Integer);
var axcod : integer;
    axshowing: Boolean;
begin
     axshowing:= loadx.Showing;
...
procedure Tmdl_lstnews.monta_table3;
var listaLng_id,axcoddefault,xid_default: Integer;
    axshowing: Boolean;
    //inclui linguagens
...
procedure Tmdl_lstnews.atualiza_grade3;
var axshowing: Boolean;
    axlocid: Integer;
begin
     //banner
...
procedure Tmdl_lstnews.limpaphoto3(xupdateset:Boolean);
begin
...
procedure Tmdl_lstnews.bt_open3Click(Sender: TObject);
var xfilext,xnamefile: String;
    xerror: Boolean;
    codBitmap: TBitmap;
    codJpeg: TJPEGImage;
...
procedure Tmdl_lstnews.bt_limpar3Click(Sender: TObject);
begin
      limpaphoto3(true);
end;

procedure Tmdl_lstnews.bt_save3Click(Sender: TObject);
begin
      save_cfg(listaLng.cod_lng[PageControl_languagens.TabIndex]);
end;

procedure Tmdl_lstnews.PageControl1Change(Sender: TObject);
begin
...
procedure Tmdl_lstnews.MenuItem1Click(Sender: TObject);
var axshowing: Boolean;
begin
...
procedure Tmdl_lstnews.bt_del2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_lstnews.ComboBox_entChange(Sender: TObject);
begin
      if StrtoInt(AxDadosUsr.axparm) > 5000 then begin
...
procedure Tmdl_lstnews.bt_helpClick(Sender: TObject);
begin
      //Tópicos de ajuda
...
procedure Tmdl_lstnews.StatusBar1Click(Sender: TObject);
begin
      hwsf.BtSobre;
end;

procedure Tmdl_lstnews.ToolBar_grpResize(Sender: TObject);
begin
     cb_group.Width := ToolBar_grp.Width - 50;
end;

procedure Tmdl_lstnews.Desfazer1Click(Sender: TObject);
begin
     //desfazer
...
procedure Tmdl_lstnews.Recortar1Click(Sender: TObject);
begin
     //recortar
     retorna_TRxRichEdit(PageControlab.TabIndex).CutToClipboard;
end;

procedure Tmdl_lstnews.Copiar1Click(Sender: TObject);
begin
     //copiar
     retorna_TRxRichEdit(PageControlab.TabIndex).CopyToClipboard;
end;

procedure Tmdl_lstnews.Colar1Click(Sender: TObject);
begin
      //colar
     retorna_TRxRichEdit(PageControlab.TabIndex).PasteFromClipboard;
end;

procedure Tmdl_lstnews.Cor1Click(Sender: TObject);
begin
     //cor da fonte
...
procedure Tmdl_lstnews.Negrito1Click(Sender: TObject);
begin
     //negrito
     if FUpdating then Exit;
...
procedure Tmdl_lstnews.Italico1Click(Sender: TObject);
begin
     //italico
     if FUpdating then Exit;
...
procedure Tmdl_lstnews.Sublinhado1Click(Sender: TObject);
begin
     //sublinhado
     if FUpdating then Exit;
...
procedure Tmdl_lstnews.Marcador1Click(Sender: TObject);
begin
     //marcador
     if FUpdating then Exit;
...
procedure Tmdl_lstnews.AlignButtonClick(Sender: TObject);
begin
...
procedure Tmdl_lstnews.esquerdo1Click(Sender: TObject);
begin
     retorna_LeftAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_lstnews.centro1Click(Sender: TObject);
begin
     retorna_CenterAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_lstnews.direita1Click(Sender: TObject);
begin
     retorna_RightAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_lstnews.justificado1Click(Sender: TObject);
begin
     retorna_JustifyAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_lstnews.re_editorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tmdl_lstnews.SelectionChange(Sender: TObject);
begin
  //if processoand then exit;
...
function Tmdl_lstnews.CurrText: TRxTextAttributes;
begin
...
procedure Tmdl_lstnews.SetEditRect;
var
  R: TRect;
begin
  with retorna_TRxRichEdit(PageControlab.TabIndex) do
...
procedure Tmdl_lstnews.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
function Tmdl_lstnews.retorna_TRxRichEdit(xidxcod:Integer):TRxRichEdit;
begin
      Case xidxcod of
          0: Result:=re_editor1;
          1: Result:=re_editor2;
...
function Tmdl_lstnews.retorna_fontName(xidxcod:Integer):TComboBox;
begin
      Case xidxcod of
          0: Result:=FontName1;
          1: Result:=FontName2;
...
function Tmdl_lstnews.retorna_fontSize(xidxcod:Integer):TEdit;
begin
      Case xidxcod of
          0: Result:=FontSize1;
          1: Result:=FontSize2;
...
function Tmdl_lstnews.retorna_BoldButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_lstnews.retorna_ItalicButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_lstnews.retorna_UnderlineButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_lstnews.retorna_LeftAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
          0: Result:=LeftAlign1;
          1: Result:=LeftAlign2;
...
function Tmdl_lstnews.retorna_CenterAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_lstnews.retorna_RightAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_lstnews.retorna_JustifyAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_lstnews.retorna_BulletsButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
procedure Tmdl_lstnews.cb_groupChange(Sender: TObject);
begin
...
procedure Tmdl_lstnews.monta_tableclass;
...
procedure Tmdl_lstnews.bt_newclassClick(Sender: TObject);
...
procedure Tmdl_lstnews.bt_delclassClick(Sender: TObject);
...
procedure Tmdl_lstnews.PanelclassResize(Sender: TObject);
begin
...
procedure Tmdl_lstnews.EVsaveKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_lstnews.EVsave2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_lstnews.bt_saveclassClick(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
...
procedure Tmdl_lstnews.Cordefundo1Click(Sender: TObject);
begin
      //cor de fundo
      if ColorDialog1.Execute then begin
...
procedure Tmdl_lstnews.validaCbClass();
begin
...
procedure Tmdl_lstnews.CheckBox_classClick(Sender: TObject);
begin
      validaCbClass();
end;

procedure Tmdl_lstnews.ComboBox_classKeyPress(Sender: TObject;
  var Key: Char);
begin
      if key=#13 then validaCbClass();
end;

procedure Tmdl_lstnews.ComboBox_classClick(Sender: TObject);
begin
      validaCbClass();
end;

function Tmdl_lstnews.Btsearch_auto_ax(pathdefault,filtrofind:string):Tbt_search_ax;
...
procedure Tmdl_lstnews.bt_exp1Click(Sender: TObject);
var xfiljpg : String;
...
procedure Tmdl_lstnews.bt_view2Click(Sender: TObject);
begin
      if dm.ds_sql3.RecordCount>0 then begin
         Application.CreateForm(Tmdl_richgalery_view,mdl_richgalery_view);
         mdl_richgalery_view.TableImage.xcp_cod:='codigo';
...
procedure Tmdl_lstnews.bt_exp2Click(Sender: TObject);
var xfiljpg : String;
    xImagem_tmp : TMemoryStream;
begin
      if ExportarImgDialog.Execute then begin
...
procedure Tmdl_lstnews.SpeedButton2Click(Sender: TObject);
...
procedure Tmdl_lstnews.SpeedButton4Click(Sender: TObject);
begin
      DBGrid1.SetFocus;
...
procedure Tmdl_lstnews.xfil_ate_chkClick(Sender: TObject);
begin
      xfil_ate.Enabled:=xfil_ate_chk.Checked;
end;

procedure Tmdl_lstnews.xfil_de_chkClick(Sender: TObject);
begin
      xfil_de.Enabled:=xfil_de_chk.Checked;
end;

procedure Tmdl_lstnews.calend1Click(Sender: TObject);
//var axtm: String;
begin
...
procedure Tmdl_lstnews.PanelbtviewResize(Sender: TObject);
begin
    bt_view1.Height:=Panelbtview.Height-49;
end;

procedure Tmdl_lstnews.Panelbtview2Resize(Sender: TObject);
begin
    bt_view2.Height:=Panelbtview2.Height-49;
end;

procedure Tmdl_lstnews.bt_imgRotateh1Click(Sender: TObject);
begin
...
procedure Tmdl_lstnews.bt_imgRotatea1Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp1,xlogosz1,xupdatelogo1,ComboBox_model.Text,LstTables.Table[1],'cod_gal','icon',ab_cod.Caption) then
        abretmplogo1;
end;

procedure Tmdl_lstnews.bt_imgRotateh2Click(Sender: TObject);
begin
...
procedure Tmdl_lstnews.bt_imgRotatea2Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp2,xlogosz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_ico',ms_cod.Caption) then begin
        if dm.rotateFoto(-90,xampltmp2,xamplsz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_larg',ms_cod.Caption) then
           abretmplogo2
...
procedure Tmdl_lstnews.MenuItem2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_lstnews.bt_cancel1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_lstnews.bt_activate1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_lstnews.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
...
var idnew:Integer;
    xfiljpg : String;
    xImagem_tmp : TMemoryStream;
    descricaonews: TStringList;
procedure exportar_imgs(xfilespath:String);
var xfiljpg : String;
    xImagem_tmp : TMemoryStream;
    xidcount,xtotimg: Integer;
    axshowing: Boolean;
begin
    ...
    if xtotimg > 0 then begin
         ...
         While not dm.ds_sql3.Eof do begin
           Inc(xidcount);
           loadx.Progressloading.position:=xidcount;
           loadx.lbloading.Caption:='Exportando imagens ['+inttostr(xidcount)+'/'+inttostr(xtotimg)+']';
           loadx.lbloading.Repaint;
           Application.ProcessMessages;
           xfiljpg := formatfloat('000',xidcount)+'-'+dm.ds_sql3.fieldbyname('descricao').AsString+'.jpg';
           xImagem_tmp.Clear;
...
begin
    ...
    idnew:=1;
    xImagem_tmp := TMemoryStream.Create;
    descricaonews := TStringList.Create;
    While not dm.ds_sql.Eof do begin
         atualiza_grade;
         re_editor1.Lines.SaveToFile('c:\tmp\news\noticia'+IntToStr(idnew)+'_texto.rtf');
         descricaonews.Clear;
         descricaonews.Add('Título: '+ab_titulo.Text);
         descricaonews.Add('Local: '+cb_loc.Text);
         descricaonews.Add('Data: '+DateToStr(cb_dt.date));
         descricaonews.SaveToFile('c:\tmp\news\noticia'+IntToStr(idnew)+'_dados.rtf');
         CreateDir('c:\tmp\news\noticia'+IntToStr(idnew)+'_fotos');
      //icon
      try
         xfiljpg := 'c:\tmp\news\noticia'+IntToStr(idnew)+'_icone.jpg';
         xImagem_tmp.Clear;
         xImagem_tmp.Position:=0;
         xImagem_tmp := dm.GetBinaryStreamPH(LstTables.Table[1],'cod_gal','icon',ab_cod.Caption);
         xImagem_tmp.Seek(0,soFromBeginning);
