...
var
  mdl_richcatalog: Tmdl_richcatalog;
...
procedure Tmdl_richcatalog.FormClose(Sender: TObject; var Action: TCloseAction);
...
procedure Tmdl_richcatalog.FormCreate(Sender: TObject);
var axshowing: Boolean;
...
begin
     ...
     mdl_richcatalog.Caption:= AxDadosUsr.axtitle;
     xinit:=true;
     axcod_ent:=0;
     PageControltxLast:=-1;
...
procedure Tmdl_richcatalog.monta_lng;
...
procedure Tmdl_richcatalog.monta_table1;
var axshowing: Boolean;
...
begin
     ...
     if not axshowing then begin
        loadx := Tloadx.Create(Application);
        loadx.lbloading.Caption:='Montando Lista de Produtos';
        loadx.Show;
        loadx.Update;
     end else begin
        loadx.lbloading.Caption:='Montando Lista de Produtos';
...
procedure Tmdl_richcatalog.monta_table2(xnewgal,xuplng:Boolean);
begin
...
procedure Tmdl_richcatalog.FormResize(Sender: TObject);
begin
...
procedure Tmdl_richcatalog.FormActivate(Sender: TObject);
begin
      mdl_richcatalog.Refresh;
      if xinit then begin
         xinit:=false;
...
procedure Tmdl_richcatalog.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      Case key of
...
procedure Tmdl_richcatalog.addreg;
begin
...
procedure Tmdl_richcatalog.travaformImages(xtrava: Boolean);
begin
...
procedure Tmdl_richcatalog.addreg2;
begin
     ms_cod.Caption:='novo';
     ax_ms_cod:=0;
     ms_titulo.Text:='';
...
procedure Tmdl_richcatalog.atualiza_grade;
var axshowing: Boolean;
    axlocid: Integer;
...
procedure Tmdl_richcatalog.limpaphoto1(xupdateset:Boolean);
begin
...
procedure Tmdl_richcatalog.atualiza_grade2;
var axshowing: Boolean;
...
procedure Tmdl_richcatalog.limpaphoto2(xupdateset:Boolean);
begin
...
procedure Tmdl_richcatalog.bt_new1Click(Sender: TObject);
begin
      addreg;
      ab_titulo.SetFocus;
end;

procedure Tmdl_richcatalog.bt_new2Click(Sender: TObject);
begin
      addreg2;
      ms_titulo.SetFocus;
end;

procedure Tmdl_richcatalog.bt_save1Click(Sender: TObject);
...
begin
     ...
     if (ComboBox_class2.ItemIndex<0) then begin
        hwsf.BtMensagem('É necessário selecionar a Categoria para o Produto.');
     ...
     if ab_titulo.Text='' then begin
        hwsf.BtMensagem('É necessário digitar o título do Produto.');
        ab_titulo.SetFocus;
        exit;
     end;
...
procedure Tmdl_richcatalog.ComboBox_webChange(Sender: TObject);
begin
...
procedure Tmdl_richcatalog.bt_save2Click(Sender: TObject);
...
procedure Tmdl_richcatalog.getLogo1;
...
procedure Tmdl_richcatalog.abretmplogo1;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp1.Seek(0,soFromBeginning);
...
procedure Tmdl_richcatalog.getLogo2;
var axcodBlb: Integer;
begin
     try
...
procedure Tmdl_richcatalog.abretmplogo2;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp2.Seek(0,soFromBeginning);
...
procedure Tmdl_richcatalog.getBanner;
begin
     xbannertmp.Clear;
...
procedure Tmdl_richcatalog.abretmpbanner;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xbannertmp.Seek(0,soFromBeginning);
...
procedure Tmdl_richcatalog.bt_limpar1Click(Sender: TObject);
begin
      limpaphoto1(True);
...
procedure Tmdl_richcatalog.bt_limpar2Click(Sender: TObject);
begin
      limpaphoto2(True);
...
procedure Tmdl_richcatalog.bt_view1Click(Sender: TObject);
begin
      if dm.ds_sql.RecordCount>0 then begin
         ...
         mdl_richgalery_view.Left:=mdl_richcatalog.Width-mdl_richgalery_view.Width;
         mdl_richgalery_view.Top:=mdl_richcatalog.Height-mdl_richgalery_view.Height;
         mdl_richgalery_view.Show;
      end;
end;

procedure Tmdl_richcatalog.bt_open1Click(Sender: TObject);
...
procedure Tmdl_richcatalog.bt_open2Click(Sender: TObject);
var xfilext,xnamefile: String;
    xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
    xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp: Integer;
...
procedure Tmdl_richcatalog.chk_view1Click(Sender: TObject);
begin
      if chk_view1.Checked then getLogo1;
end;

procedure Tmdl_richcatalog.chk_view2Click(Sender: TObject);
begin
      if chk_view2.Checked then getLogo2;
end;

procedure Tmdl_richcatalog.Splitter1Moved(Sender: TObject);
begin
      ComboBox_web.Width:=ToolBar_web.Width-53;
end;

procedure Tmdl_richcatalog.DBGrid1CellClick(Column: TColumn);
begin
      atualiza_grade;
end;

procedure Tmdl_richcatalog.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_richcatalog.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_richcatalog.DBGrid1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade;
end;

procedure Tmdl_richcatalog.DBGrid2CellClick(Column: TColumn);
begin
      atualiza_grade2;
end;

procedure Tmdl_richcatalog.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_richcatalog.DBGrid2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_richcatalog.DBGrid2MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade2;
end;

procedure Tmdl_richcatalog.bt_recursiveClick(Sender: TObject);
...
function Tmdl_richcatalog.inserimg(xnamefile,xfilext:String;
                      xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
                      xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp:Integer;
                      xic_ajt,xic_pr,xil_ajt,xil_pr: Boolean):Boolean;
...
function Tmdl_richcatalog.retorna_TTabSheet(xidxcod:Integer):TTabSheet;
begin
      Case xidxcod of
          0: Result:=lngtb1;
          1: Result:=lngtb2;
...
procedure Tmdl_richcatalog.PageControl_languagensChange(Sender: TObject);
begin
...
procedure Tmdl_richcatalog.Timer_traduzTimer(Sender: TObject);
begin
      Inc(xtimerresponse);
end;

procedure Tmdl_richcatalog.Tradutor1AoTraduzir(Sender: TObject;
  Traducao: String);
begin
    xreceivetrad:=Traducao;
end;

function Tmdl_richcatalog.recebetraducao(xtrad_text,xtrad_de,xtrad_para: String):String;
var xrecebido: Bool;
begin
      xrecebido:=false;
      xreceivetrad:='';
...
procedure Tmdl_richcatalog.save_cfg(xcodlng: Integer);
var axcod : integer;
    axshowing: Boolean;
begin
     axshowing:= loadx.Showing;
...
procedure Tmdl_richcatalog.monta_table3;
var listaLng_id,axcoddefault,xid_default: Integer;
    axshowing: Boolean;
    //inclui linguagens
...
procedure Tmdl_richcatalog.atualiza_grade3;
var axshowing: Boolean;
    axlocid: Integer;
begin
     //banner
...
procedure Tmdl_richcatalog.limpaphoto3(xupdateset:Boolean);
begin
...
procedure Tmdl_richcatalog.bt_open3Click(Sender: TObject);
var xfilext,xnamefile: String;
    xerror: Boolean;
    codBitmap: TBitmap;
    codJpeg: TJPEGImage;
...
procedure Tmdl_richcatalog.bt_limpar3Click(Sender: TObject);
begin
      limpaphoto3(true);
end;

procedure Tmdl_richcatalog.bt_save3Click(Sender: TObject);
begin
      save_cfg(listaLng.cod_lng[PageControl_languagens.TabIndex]);
end;

procedure Tmdl_richcatalog.PageControl1Change(Sender: TObject);
begin
...
procedure Tmdl_richcatalog.MenuItem1Click(Sender: TObject);
var axshowing: Boolean;
begin
...
procedure Tmdl_richcatalog.bt_del2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_richcatalog.ComboBox_entChange(Sender: TObject);
begin
      if StrtoInt(AxDadosUsr.axparm) > 5000 then begin
...
procedure Tmdl_richcatalog.bt_helpClick(Sender: TObject);
begin
      //Tópicos de ajuda
...
procedure Tmdl_richcatalog.StatusBar1Click(Sender: TObject);
begin
      hwsf.BtSobre;
end;

procedure Tmdl_richcatalog.ToolBar_grpResize(Sender: TObject);
begin
     cb_group.Width := ToolBar_grp.Width;
end;

procedure Tmdl_richcatalog.Desfazer1Click(Sender: TObject);
begin
     //desfazer
...
procedure Tmdl_richcatalog.Recortar1Click(Sender: TObject);
begin
     //recortar
     retorna_TRxRichEdit(PageControlab.TabIndex).CutToClipboard;
end;

procedure Tmdl_richcatalog.Copiar1Click(Sender: TObject);
begin
     //copiar
     retorna_TRxRichEdit(PageControlab.TabIndex).CopyToClipboard;
end;

procedure Tmdl_richcatalog.Colar1Click(Sender: TObject);
begin
      //colar
     retorna_TRxRichEdit(PageControlab.TabIndex).PasteFromClipboard;
end;

procedure Tmdl_richcatalog.Cor1Click(Sender: TObject);
begin
     //cor da fonte
...
procedure Tmdl_richcatalog.Negrito1Click(Sender: TObject);
begin
     //negrito
     if FUpdating then Exit;
...
procedure Tmdl_richcatalog.Italico1Click(Sender: TObject);
begin
     //italico
     if FUpdating then Exit;
...
procedure Tmdl_richcatalog.Sublinhado1Click(Sender: TObject);
begin
     //sublinhado
     if FUpdating then Exit;
...
procedure Tmdl_richcatalog.Marcador1Click(Sender: TObject);
begin
     //marcador
     if FUpdating then Exit;
...
procedure Tmdl_richcatalog.AlignButtonClick(Sender: TObject);
begin
...
procedure Tmdl_richcatalog.esquerdo1Click(Sender: TObject);
begin
     retorna_LeftAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richcatalog.centro1Click(Sender: TObject);
begin
     retorna_CenterAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richcatalog.direita1Click(Sender: TObject);
begin
     retorna_RightAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richcatalog.justificado1Click(Sender: TObject);
begin
     retorna_JustifyAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richcatalog.re_editorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
    try
...
procedure Tmdl_richcatalog.SelectionChange(Sender: TObject);
begin
  try
  //if processoand then exit;
...
function Tmdl_richcatalog.CurrText: TRxTextAttributes;
begin
...
procedure Tmdl_richcatalog.SetEditRect;
var
  R: TRect;
begin
  with retorna_TRxRichEdit(PageControlab.TabIndex) do
...
procedure Tmdl_richcatalog.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
function Tmdl_richcatalog.retorna_TRxRichEdit(xidxcod:Integer):TRxRichEdit;
begin
      Case xidxcod of
          //0: Result:=re_editor1;
          1: Result:=re_editor2;
...
function Tmdl_richcatalog.retorna_fontName(xidxcod:Integer):TComboBox;
begin
      Case xidxcod of
          //0: Result:=FontName1;
          1: Result:=FontName2;
...
function Tmdl_richcatalog.retorna_fontSize(xidxcod:Integer):TEdit;
begin
      Case xidxcod of
          //0: Result:=FontSize1;
          1: Result:=FontSize2;
...
function Tmdl_richcatalog.retorna_BoldButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richcatalog.retorna_ItalicButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richcatalog.retorna_UnderlineButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richcatalog.retorna_LeftAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
          //0: Result:=LeftAlign1;
          1: Result:=LeftAlign2;
...
function Tmdl_richcatalog.retorna_CenterAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richcatalog.retorna_RightAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richcatalog.retorna_JustifyAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richcatalog.retorna_BulletsButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richcatalog.atualizafeed:Boolean;
begin
    WebBrowser_feed.Navigate('http://'+AxDadosUsr.website+'/feedprd_upd.php');
    //hwsf.BtMensagem('Feed de Produtos Atualizado com sucesso.');
end;

procedure Tmdl_richcatalog.cb_groupChange(Sender: TObject);
begin
...
procedure Tmdl_richcatalog.monta_tableclass;
var axshowing: Boolean;
    axclass: Integer;
begin
      axshowing:= loadx.Showing;
...
procedure Tmdl_richcatalog.EVsaveKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_richcatalog.EVsave2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_richcatalog.Cordefundo1Click(Sender: TObject);
begin
      //cor de fundo
      if ColorDialog1.Execute then begin
...
procedure Tmdl_richcatalog.validaCbClass;
...
function Tmdl_richcatalog.Btsearch_auto_ax(pathdefault,filtrofind:string):Tbt_search_ax;
...
procedure Tmdl_richcatalog.bt_exp1Click(Sender: TObject);
var xfiljpg : String;
...
procedure Tmdl_richcatalog.bt_view2Click(Sender: TObject);
begin
      if dm.ds_sql3.RecordCount>0 then begin
         Application.CreateForm(Tmdl_richgalery_view,mdl_richgalery_view);
         mdl_richgalery_view.TableImage.xcp_cod:='codigo';
...
procedure Tmdl_richcatalog.bt_exp2Click(Sender: TObject);
var xfiljpg : String;
    xImagem_tmp : TMemoryStream;
begin
      if ExportarImgDialog.Execute then begin
...
procedure Tmdl_richcatalog.SpeedButton2Click(Sender: TObject);
...
procedure Tmdl_richcatalog.PanelbtviewResize(Sender: TObject);
begin
    bt_view1.Height:=Panelbtview.Height-49;
end;

procedure Tmdl_richcatalog.Panelbtview2Resize(Sender: TObject);
begin
    bt_view2.Height:=Panelbtview2.Height-49;
end;

procedure Tmdl_richcatalog.bt_imgRotateh1Click(Sender: TObject);
begin
...
procedure Tmdl_richcatalog.bt_imgRotatea1Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp1,xlogosz1,xupdatelogo1,ComboBox_model.Text,LstTables.Table[1],'cod_gal','icon',ab_cod.Caption) then
        abretmplogo1;
end;

procedure Tmdl_richcatalog.bt_imgRotateh2Click(Sender: TObject);
begin
...
procedure Tmdl_richcatalog.bt_imgRotatea2Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp2,xlogosz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_ico',ms_cod.Caption) then begin
        if dm.rotateFoto(-90,xampltmp2,xamplsz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_larg',ms_cod.Caption) then
           abretmplogo2
...
procedure Tmdl_richcatalog.MenuItem2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_richcatalog.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
...
procedure Tmdl_richcatalog.resetWebBrowse;
...
procedure Tmdl_richcatalog.SetRepetirImagem(xreptid:Integer);
var axreptx: String;
begin
    Case xreptid of
        0: axreptx:='no-repeat';
...
procedure Tmdl_richcatalog.setxHtml(xabaED:Integer);
...
procedure Tmdl_richcatalog.InternalSaveDocumentToStream(
...
procedure Tmdl_richcatalog.InternalSaveBodyHTMLToStream(const Stream: TStream);
var
  HTMLStr: string;
  Doc: IHTMLDocument2;
...
procedure Tmdl_richcatalog.InternalSaveBodyHTMLToStringList(const StringList: TStringList);
var
  HTMLStr: string;
  Doc: IHTMLDocument2;
  BodyElement: IHTMLElement;
...
procedure Tmdl_richcatalog.InternalSaveBodyTextToStream(const Stream: TStream);
var
  TextStr: string;
  Doc: IHTMLDocument2;
  BodyElement: IHTMLElement;
...
procedure Tmdl_richcatalog.InternalLoadDocumentFromStream(const Stream: TStream);
var
  PersistStreamInit: IPersistStreamInit;
  StreamAdapter: IStream;
begin
...
procedure Tmdl_richcatalog.SpeedButton10Click(Sender: TObject);
begin
    resetWebBrowse;
end;

procedure Tmdl_richcatalog.SpeedButton9Click(Sender: TObject);
begin
      bt_save1.Click;
end;

procedure Tmdl_richcatalog.SpeedButton11Click(Sender: TObject);
begin
    InvokeCMD(WebBrowser1, HTMLID_FIND);
end;

procedure Tmdl_richcatalog.SpeedButton8Click(Sender: TObject);
var
...
procedure Tmdl_richcatalog.NoRepetir1Click(Sender: TObject);
begin
    if (not NoRepetir1.Checked) then
        SetRepetirImagem(0);
end;

procedure Tmdl_richcatalog.repetirimagem1Click(Sender: TObject);
begin
    if (not repetirimagem1.Checked) then
        SetRepetirImagem(1);
end;

procedure Tmdl_richcatalog.RepetirX1Click(Sender: TObject);
begin
    if (not RepetirX1.Checked) then
        SetRepetirImagem(2);
end;

procedure Tmdl_richcatalog.RepetirY1Click(Sender: TObject);
begin
    if (not RepetirY1.Checked) then
        SetRepetirImagem(3);
end;

procedure Tmdl_richcatalog.Fixarfundo1Click(Sender: TObject);
begin
...
procedure Tmdl_richcatalog.Limpar1Click(Sender: TObject);
begin
       HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
...
procedure Tmdl_richcatalog.combofontChange(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('FontName', False,ComboFont.Text);
end;

procedure Tmdl_richcatalog.ComboSizeChange(Sender: TObject);
begin
...
procedure Tmdl_richcatalog.SpeedButton1Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('Bold', False,0);
end;

procedure Tmdl_richcatalog.SpeedButton3Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('Italic', False,0);
end;

procedure Tmdl_richcatalog.SpeedButton5Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('Underline', False,0);
end;

procedure Tmdl_richcatalog.SpeedButton6Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    if cdColor.Execute then
...
procedure Tmdl_richcatalog.ComboSpeedButton1Click(Sender: TObject);
...
procedure Tmdl_richcatalog.ComboBox_classClick(Sender: TObject);
begin
      validaCbClass;
end;

procedure Tmdl_richcatalog.ComboBox_classKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      validaCbClass;
end;

procedure Tmdl_richcatalog.ComboBox_classKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      validaCbClass;
end;

procedure Tmdl_richcatalog.ComboBox_classMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      validaCbClass;
end;

procedure Tmdl_richcatalog.WebBrowser_feedDownloadComplete(Sender: TObject);
begin
      feedokupd:=true;
end;

procedure Tmdl_richcatalog.alt_ordem(xtypOrd:Integer);
...
procedure Tmdl_richcatalog.bt_ordemupClick(Sender: TObject);
begin
      alt_ordem(0);
end;

procedure Tmdl_richcatalog.bt_ordemdownClick(Sender: TObject);
begin
      alt_ordem(1);
end;

procedure Tmdl_richcatalog.bt_newSrvClick(Sender: TObject);
var axgrpname: String;
    axshowing,xexecutaimg: Boolean;
    axcod,axcl_id: Integer; 
    xtxt3: TMemoryStream;
begin
      axgrpname:=hwsf.BtDesc('Digite o título da Classifição:');
...
procedure Tmdl_richcatalog.bt_delSrvClick(Sender: TObject);
...
begin
      ...
      With dm.ds_sql8 do begin
         ...
         if (recordcount>0) then begin
            axvincul:=true;
            Close;
            hwsf.BtMensagem('Exclusão não permitida, pois existem produtos vinculados a esta categoria.');
            Exit;
         end;
      end;
      axshowing:= loadx.Showing;
