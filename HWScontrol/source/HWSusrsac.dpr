...
uses
  ...
  umdl_usrsac in 'umdl_usrsac.pas' {mdl_usrsac};
...
begin
    ...
    loadx.lbloading.Caption:='HWScontrol SAC';
    loadx.Show;
    loadx.Update;
    ...
    Application.Title := 'HWScontrol Usuários SAC';
  ...
  dm.winsysreg(1,false,false);
          if (dm.conecta_bd(ParamStr(1),ParamStr(3),ParamStr(4))) then begin
             ...
             if HprevHist = 0 then begin
                ...
                Application.CreateForm(Tmdl_usrsac, mdl_usrsac);
             end else begin
