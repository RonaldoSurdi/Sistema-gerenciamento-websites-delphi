...
procedure Tmdl_lstprj2.FormClose(Sender: TObject; var Action: TCloseAction);
...
procedure Tmdl_lstprj2.FormCreate(Sender: TObject);
var axshowing: Boolean;
...
begin
     ...
     mdl_lstprj2.Caption:= AxDadosUsr.axtitle;
     axposFASexec:=false;
     xinit:=true;
     axcod_ent:=0;
     ...
     if StrtoInt(dm.xax_parm_Default) > 5000 then begin
...
procedure Tmdl_lstprj2.monta_lng;
...
procedure Tmdl_lstprj2.monta_table1;
var axshowing: Boolean;
...
begin
     ...
     With dm.ds_sql do begin
          ...
          CommandText:= 'SELECT * FROM '+LstTables.Table[0]+
                                ' WHERE cod_web='+#39+InttoStr(AxDadosUsr.cod_web)+#39+
                                ' AND xtp='+#39+dm.xax_parm_Default+#39+
...
procedure Tmdl_lstprj2.monta_table2(xnewgal,xuplng:Boolean);
var xcodgal: string;
begin
...
procedure Tmdl_lstprj2.FormResize(Sender: TObject);
begin
...
procedure Tmdl_lstprj2.FormActivate(Sender: TObject);
begin
      mdl_lstprj2.Refresh;
      if xinit then begin
         xinit:=false;
...
procedure Tmdl_lstprj2.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      Case key of
...
procedure Tmdl_lstprj2.travaformImages(xtrava: Boolean);
begin
...
procedure Tmdl_lstprj2.addreg2;
begin
     ms_cod.Caption:='novo';
     ax_ms_cod:=0;
     ms_titulo.Text:='';
...
procedure Tmdl_lstprj2.atualiza_grade;
var axshowing: Boolean;
    axlocid: Integer;
...
procedure Tmdl_lstprj2.limpaphoto1(xupdateset:Boolean);
begin
...
procedure Tmdl_lstprj2.atualiza_grade2;
var axshowing: Boolean;
    st_stream : TMemoryStream;
begin
     //banco de imagens
...
procedure Tmdl_lstprj2.limpaphoto2(xupdateset:Boolean);
begin
...
procedure Tmdl_lstprj2.bt_new1Click(Sender: TObject);
begin
      addreg;
      ab_titulo.SetFocus;
end;

procedure Tmdl_lstprj2.bt_new2Click(Sender: TObject);
begin
      addreg2;
      ms_titulo.SetFocus;
end;

procedure Tmdl_lstprj2.bt_del1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_lstprj2.bt_save1Click(Sender: TObject);
     ...
     if ab_cod.Caption = 'novo' then begin
        ...
        for axgal_id:=0 to listaLng.count-1 do begin
            ...
            with dm.executa do begin
                 ...
                 Params[9].AsString:=dm.xax_parm_Default;
...
procedure Tmdl_lstprj2.ComboBox_webChange(Sender: TObject);
begin
...
procedure Tmdl_lstprj2.bt_save2Click(Sender: TObject);
...
procedure Tmdl_lstprj2.getLogo1;
...
procedure Tmdl_lstprj2.abretmplogo1;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp1.Seek(0,soFromBeginning);
...
procedure Tmdl_lstprj2.getLogo2;
var axcodBlb: Integer;
begin
     try
...
procedure Tmdl_lstprj2.abretmplogo2;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp2.Seek(0,soFromBeginning);
...
procedure Tmdl_lstprj2.getBanner;
begin
     xbannertmp.Clear;
...
procedure Tmdl_lstprj2.abretmpbanner;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xbannertmp.Seek(0,soFromBeginning);
...
procedure Tmdl_lstprj2.bt_limpar1Click(Sender: TObject);
begin
      limpaphoto1(True);
...
procedure Tmdl_lstprj2.bt_limpar2Click(Sender: TObject);
begin
      limpaphoto2(True);
...
procedure Tmdl_lstprj2.bt_view1Click(Sender: TObject);
begin
      if dm.ds_sql.RecordCount>0 then begin
         ...
         mdl_richgalery_view.Left:=mdl_lstprj2.Width-mdl_richgalery_view.Width;
         mdl_richgalery_view.Top:=mdl_lstprj2.Height-mdl_richgalery_view.Height;
         mdl_richgalery_view.Show;
      end;
      //getLogo1;
end;

procedure Tmdl_lstprj2.bt_open1Click(Sender: TObject);
...
procedure Tmdl_lstprj2.bt_open2Click(Sender: TObject);
var xfilext,xnamefile: String;
    xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
    xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp: Integer;
...
procedure Tmdl_lstprj2.chk_view2Click(Sender: TObject);
begin
      if chk_view2.Checked then getLogo2;
end;

procedure Tmdl_lstprj2.Splitter1Moved(Sender: TObject);
begin
      ComboBox_web.Width:=ToolBar_web.Width-53;
end;

procedure Tmdl_lstprj2.DBGrid1CellClick(Column: TColumn);
begin
      atualiza_grade;
end;

procedure Tmdl_lstprj2.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_lstprj2.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_lstprj2.DBGrid1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade;
end;

procedure Tmdl_lstprj2.DBGrid2CellClick(Column: TColumn);
begin
      atualiza_grade2;
end;

procedure Tmdl_lstprj2.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_lstprj2.DBGrid2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_lstprj2.DBGrid2MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade2;
end;

procedure Tmdl_lstprj2.bt_view2Click(Sender: TObject);
begin
      if dm.ds_sql3.RecordCount>0 then begin
         Application.CreateForm(Tmdl_richgalery_view,mdl_richgalery_view);
         mdl_richgalery_view.TableImage.xcp_cod:='codigo';
...
procedure Tmdl_lstprj2.bt_recursiveClick(Sender: TObject);
...
function Tmdl_lstprj2.inserimg(xnamefile,xfilext:String;
                      xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
                      xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp:Integer;
                      xic_ajt,xic_pr,xil_ajt,xil_pr: Boolean):Boolean;
...
function Tmdl_lstprj2.retorna_TTabSheet(xidxcod:Integer):TTabSheet;
begin
      Case xidxcod of
          0: Result:=lngtb1;
          1: Result:=lngtb2;
...
procedure Tmdl_lstprj2.PageControl_languagensChange(Sender: TObject);
begin
...
procedure Tmdl_lstprj2.Timer_traduzTimer(Sender: TObject);
begin
      Inc(xtimerresponse);
end;

procedure Tmdl_lstprj2.Tradutor1AoTraduzir(Sender: TObject;
  Traducao: String);
begin
    xreceivetrad:=Traducao;
end;

function Tmdl_lstprj2.recebetraducao(xtrad_text,xtrad_de,xtrad_para: String):String;
var xrecebido: Bool;
begin
      xrecebido:=false;
      xreceivetrad:='';
...
procedure Tmdl_lstprj2.save_cfg(xcodlng: Integer);
var axcod : integer;
    axshowing: Boolean;
begin
     axshowing:= loadx.Showing;
     ...
     with dm.executa do begin
             ...
             Params[13].AsString:=dm.xax_parm_Default;
...
procedure Tmdl_lstprj2.monta_table3;
var listaLng_id,axcoddefault,xid_default: Integer;
    axshowing: Boolean;
    //inclui linguagens
...
begin
     ...
     With dm.ds_sql5 do begin
          ...
          CommandText:= 'SELECT codigo,cod_web,cod_lng,cp1,cp2,cp3,cp4,cp5,cp6,cp7,cp8,cp9,cp10,cp11,cp14,cp15,cp16 FROM '+LstTables.Table[5]+
                                ' WHERE cod_web='+#39+InttoStr(AxDadosUsr.cod_web)+#39+
                                ' AND cp16='+#39+dm.xax_parm_Default+#39+
                                ' ORDER BY cod_lng';
          Open;
          Filter:='';
          Filtered:=true;
               ...
               try
                   ...
                   for listaLng_id:=0 to axListInsertLng.count-1 do begin
                          ...
                          with dm.executa do begin
                               ...
                               Params[16].AsString:=dm.xax_parm_Default;
                               Execute;
                          end;
                          axBannerStrm.Seek(0,soFromBeginning);
...
procedure Tmdl_lstprj2.atualiza_grade_pers;
var axshowing: Boolean;
    axlocid: Integer;
begin
     //banner
...
procedure Tmdl_lstprj2.limpaphoto_pers(xupdateset:Boolean);
begin
...
procedure Tmdl_lstprj2.bt_open_persClick(Sender: TObject);
var xfilext,xnamefile: String;
    xerror: Boolean;
    codBitmap: TBitmap;
    codJpeg: TJPEGImage;
...
procedure Tmdl_lstprj2.bt_limpar_persClick(Sender: TObject);
begin
      limpaphoto_pers(true);
end;

procedure Tmdl_lstprj2.bt_save_persClick(Sender: TObject);
begin
      save_cfg(listaLng.cod_lng[PageControl_languagens.TabIndex]);
end;

procedure Tmdl_lstprj2.PageControl1Change(Sender: TObject);
begin
...
procedure Tmdl_lstprj2.MenuItem1Click(Sender: TObject);
var axshowing: Boolean;
begin
...
procedure Tmdl_lstprj2.bt_del2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_lstprj2.ComboBox_entChange(Sender: TObject);
begin
      if StrtoInt(dm.xax_parm_Default) > 5000 then begin
...
procedure Tmdl_lstprj2.bt_helpClick(Sender: TObject);
begin
      //Tópicos de ajuda
...
procedure Tmdl_lstprj2.StatusBar1Click(Sender: TObject);
begin
      hwsf.BtSobre;
end;

procedure Tmdl_lstprj2.ToolBar_grpResize(Sender: TObject);
begin
     cb_group.Width := ToolBar_grp.Width - 50;
end;

procedure Tmdl_lstprj2.Desfazer1Click(Sender: TObject);
begin
     //desfazer
...
procedure Tmdl_lstprj2.Recortar1Click(Sender: TObject);
begin
     //recortar
     retorna_TRxRichEdit(PageControlab.TabIndex).CutToClipboard;
end;

procedure Tmdl_lstprj2.Copiar1Click(Sender: TObject);
begin
     //copiar
     retorna_TRxRichEdit(PageControlab.TabIndex).CopyToClipboard;
end;

procedure Tmdl_lstprj2.Colar1Click(Sender: TObject);
begin
      //colar
     retorna_TRxRichEdit(PageControlab.TabIndex).PasteFromClipboard;
end;

procedure Tmdl_lstprj2.Cor1Click(Sender: TObject);
begin
     //cor da fonte
...
procedure Tmdl_lstprj2.Negrito1Click(Sender: TObject);
begin
     //negrito
     if FUpdating then Exit;
...
procedure Tmdl_lstprj2.Italico1Click(Sender: TObject);
begin
     //italico
     if FUpdating then Exit;
...
procedure Tmdl_lstprj2.Sublinhado1Click(Sender: TObject);
begin
     //sublinhado
     if FUpdating then Exit;
...
procedure Tmdl_lstprj2.Marcador1Click(Sender: TObject);
begin
     //marcador
     if FUpdating then Exit;
...
procedure Tmdl_lstprj2.AlignButtonClick(Sender: TObject);
begin
...
procedure Tmdl_lstprj2.esquerdo1Click(Sender: TObject);
begin
     retorna_LeftAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_lstprj2.centro1Click(Sender: TObject);
begin
     retorna_CenterAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_lstprj2.direita1Click(Sender: TObject);
begin
     retorna_RightAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_lstprj2.justificado1Click(Sender: TObject);
begin
     retorna_JustifyAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_lstprj2.re_editorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tmdl_lstprj2.SelectionChange(Sender: TObject);
begin
  //if processoand then exit;
...
function Tmdl_lstprj2.CurrText: TRxTextAttributes;
begin
...
procedure Tmdl_lstprj2.SetEditRect;
var
  R: TRect;
begin
  with retorna_TRxRichEdit(PageControlab.TabIndex) do
...
procedure Tmdl_lstprj2.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
function Tmdl_lstprj2.retorna_TRxRichEdit(xidxcod:Integer):TRxRichEdit;
begin
      Case xidxcod of
          0: Result:=re_editor1;
          1: Result:=re_editor2;
...
function Tmdl_lstprj2.retorna_fontName(xidxcod:Integer):TComboBox;
begin
      Case xidxcod of
          0: Result:=FontName1;
          1: Result:=FontName2;
...
function Tmdl_lstprj2.retorna_fontSize(xidxcod:Integer):TEdit;
begin
      Case xidxcod of
          0: Result:=FontSize1;
          1: Result:=FontSize2;
...
function Tmdl_lstprj2.retorna_BoldButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_lstprj2.retorna_ItalicButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_lstprj2.retorna_UnderlineButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_lstprj2.retorna_LeftAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
          0: Result:=LeftAlign1;
          1: Result:=LeftAlign2;
...
function Tmdl_lstprj2.retorna_CenterAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_lstprj2.retorna_RightAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_lstprj2.retorna_JustifyAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_lstprj2.retorna_BulletsButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
begin
      ...
      end else if (PageControlab.TabIndex = 1) then begin
         cb_group.Clear;
         With dm.ds_sql do begin
             if (recordcount <= 0) then begin
...
procedure Tmdl_lstprj2.cb_groupChange(Sender: TObject);
begin
...
procedure Tmdl_lstprj2.monta_tableclass;
...
procedure Tmdl_lstprj2.PanelclassResize(Sender: TObject);
begin
    ComboBox_class.Width := Panelclass.Width-11;
end;

procedure Tmdl_lstprj2.EVsaveKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_lstprj2.EVsave2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_lstprj2.Cordefundo1Click(Sender: TObject);
begin
      //cor de fundo
      if ColorDialog1.Execute then begin
...
procedure Tmdl_lstprj2.validaCbClass();
...
function Tmdl_lstprj2.Btsearch_auto_ax(pathdefault,filtrofind:string):Tbt_search_ax;
...
procedure Tmdl_lstprj2.ComboBox_classKeyPress(Sender: TObject;
  var Key: Char);
begin
      if key=#13 then validaCbClass();
end;

procedure Tmdl_lstprj2.ComboBox_classClick(Sender: TObject);
begin
      validaCbClass();
end;

procedure Tmdl_lstprj2.bt_exp1Click(Sender: TObject);
...
procedure Tmdl_lstprj2.bt_exp2Click(Sender: TObject);
var xfiljpg,xfileext : String;
    xImagem_tmp : TMemoryStream;
begin
      if ExportarImgDialog.Execute then begin
...
procedure Tmdl_lstprj2.SpeedButton2Click(Sender: TObject);
...
procedure Tmdl_lstprj2.chk_view1Click(Sender: TObject);
begin
      if chk_view1.Checked then getLogo1;
end;

procedure Tmdl_lstprj2.PanelbtviewResize(Sender: TObject);
begin
    bt_view1.Height:=Panelbtview.Height-49;
end;

procedure Tmdl_lstprj2.Panelbtview2Resize(Sender: TObject);
begin
    bt_view2.Height:=Panelbtview2.Height-49;
end;

procedure Tmdl_lstprj2.bt_imgRotateh1Click(Sender: TObject);
begin
...
procedure Tmdl_lstprj2.bt_imgRotatea1Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp1,xlogosz1,xupdatelogo1,ComboBox_model.Text,LstTables.Table[1],'cod_gal','icon',ab_cod.Caption) then
        abretmplogo1;
end;

procedure Tmdl_lstprj2.bt_imgRotateh2Click(Sender: TObject);
begin
...
procedure Tmdl_lstprj2.bt_imgRotatea2Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp2,xlogosz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_ico',ms_cod.Caption) then begin
        if dm.rotateFoto(-90,xampltmp2,xamplsz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_larg',ms_cod.Caption) then
           abretmplogo2
...
procedure Tmdl_lstprj2.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
      hwsf.BtMensagem('AVISO: Falha na conexão.');
end;

procedure Tmdl_lstprj2.PageControlabChange(Sender: TObject);
begin
     setPaCtrlLab;
end;
