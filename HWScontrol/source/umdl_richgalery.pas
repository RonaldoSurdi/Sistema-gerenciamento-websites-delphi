...
var
  mdl_richgalery: Tmdl_richgalery;
...
procedure Tmdl_richgalery.FormClose(Sender: TObject; var Action: TCloseAction);
...
procedure Tmdl_richgalery.FormCreate(Sender: TObject);
var axshowing: Boolean;
...
begin
     ...
     mdl_richgalery.Caption:= AxDadosUsr.axtitle;
     xinit:=true;
     axcod_ent:=0;
...
procedure Tmdl_richgalery.monta_lng;
...
procedure Tmdl_richgalery.monta_table1;
var axshowing: Boolean;
...
procedure Tmdl_richgalery.monta_table2(xnewgal,xuplng:Boolean);
var xcodgal: string;
begin
...
procedure Tmdl_richgalery.FormResize(Sender: TObject);
begin
...
procedure Tmdl_richgalery.FormActivate(Sender: TObject);
begin
      mdl_richgalery.Refresh;
      if xinit then begin
         xinit:=false;
...
procedure Tmdl_richgalery.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      Case key of
...
procedure Tmdl_richgalery.addreg;
begin
...
procedure Tmdl_richgalery.travaformImages(xtrava: Boolean);
begin
...
procedure Tmdl_richgalery.addreg2;
begin
     ms_cod.Caption:='novo';
     ax_ms_cod:=0;
     ms_titulo.Text:='';
...
procedure Tmdl_richgalery.atualiza_grade;
var axshowing: Boolean;
    axlocid: Integer;
...
procedure Tmdl_richgalery.limpaphoto1(xupdateset:Boolean);
begin
...
procedure Tmdl_richgalery.atualiza_grade2;
var axshowing: Boolean;
    st_stream : TMemoryStream;
begin
     //banco de imagens
...
procedure Tmdl_richgalery.limpaphoto2(xupdateset:Boolean);
begin
...
procedure Tmdl_richgalery.bt_new1Click(Sender: TObject);
begin
      addreg;
      ab_titulo.SetFocus;
end;

procedure Tmdl_richgalery.bt_new2Click(Sender: TObject);
begin
      addreg2;
      ms_titulo.SetFocus;
end;

procedure Tmdl_richgalery.bt_del1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_richgalery.bt_save1Click(Sender: TObject);
...
procedure Tmdl_richgalery.ComboBox_webChange(Sender: TObject);
begin
...
procedure Tmdl_richgalery.bt_save2Click(Sender: TObject);
...
procedure Tmdl_richgalery.getLogo1;
...
procedure Tmdl_richgalery.abretmplogo1;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp1.Seek(0,soFromBeginning);
...
procedure Tmdl_richgalery.getLogo2;
var axcodBlb: Integer;
begin
     try
...
procedure Tmdl_richgalery.abretmplogo2;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp2.Seek(0,soFromBeginning);
...
procedure Tmdl_richgalery.getBanner;
begin
     xbannertmp.Clear;
...
procedure Tmdl_richgalery.abretmpbanner;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xbannertmp.Seek(0,soFromBeginning);
...
procedure Tmdl_richgalery.bt_limpar1Click(Sender: TObject);
begin
      limpaphoto1(True);
...
procedure Tmdl_richgalery.bt_limpar2Click(Sender: TObject);
begin
      limpaphoto2(True);
...
procedure Tmdl_richgalery.bt_view1Click(Sender: TObject);
begin
      if dm.ds_sql.RecordCount>0 then begin
         ...
         mdl_richgalery_view.Left:=mdl_richgalery.Width-mdl_richgalery_view.Width;
         mdl_richgalery_view.Top:=mdl_richgalery.Height-mdl_richgalery_view.Height;
         mdl_richgalery_view.Show;
      end;
      //getLogo1;
end;

procedure Tmdl_richgalery.bt_open1Click(Sender: TObject);
...
procedure Tmdl_richgalery.bt_open2Click(Sender: TObject);
var xfilext,xnamefile: String;
    xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
    xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp: Integer;
...
procedure Tmdl_richgalery.chk_view1Click(Sender: TObject);
begin
      if chk_view1.Checked then getLogo1;
end;

procedure Tmdl_richgalery.chk_view2Click(Sender: TObject);
begin
      if chk_view2.Checked then getLogo2;
end;

procedure Tmdl_richgalery.Splitter1Moved(Sender: TObject);
begin
      ComboBox_web.Width:=ToolBar_web.Width-53;
end;

procedure Tmdl_richgalery.DBGrid1CellClick(Column: TColumn);
begin
      atualiza_grade;
end;

procedure Tmdl_richgalery.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_richgalery.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_richgalery.DBGrid1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade;
end;

procedure Tmdl_richgalery.DBGrid2CellClick(Column: TColumn);
begin
      atualiza_grade2;
end;

procedure Tmdl_richgalery.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_richgalery.DBGrid2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_richgalery.DBGrid2MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade2;
end;

procedure Tmdl_richgalery.bt_recursiveClick(Sender: TObject);
...
begin
      ...
      axfilter:='Todas as imagens (*.jpg;*.jpeg;*.bmp;*.swf;*.flv;*.png)|*.jpg;*.jpeg;*.bmp;*.swf;*.flv;*.png|Imagem JPEG (*.jpg)|*.jpg|Imagem JPEG (*.jpeg)|*.jpeg|Bitmaps (*.bmp)|*.bmp|Flash (*.swf)|*.swf|Flash Video (*.flv)|*.flv|PNG|*.png';
      ...
      if bt_search_ax.filelist.Count>0 then begin
         ...
         mdl_richgalery.Repaint;
         axstatInc:= TStringList.Create;
         axstatInc.Clear;
         axshowing:= loadx.Showing;
         if not axshowing then begin
            loadx := Tloadx.Create(Application);
            loadx.lbloading.Caption:='Exportando itens [1'+'/'+IntToStr(bt_search_ax.filelist.Count)+']';
            loadx.Show;
            loadx.Update;
         end else begin
            loadx.lbloading.Caption:='Exportando itens [1'+'/'+IntToStr(bt_search_ax.filelist.Count)+']';
...
function Tmdl_richgalery.inserimg(xnamefile,xfilext:String;
                      xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
                      xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp:Integer;
                      xic_ajt,xic_pr,xil_ajt,xil_pr: Boolean):Boolean;
...
function Tmdl_richgalery.retorna_TTabSheet(xidxcod:Integer):TTabSheet;
begin
      Case xidxcod of
          0: Result:=lngtb1;
          1: Result:=lngtb2;
...
procedure Tmdl_richgalery.PageControl_languagensChange(Sender: TObject);
begin
...
procedure Tmdl_richgalery.Timer_traduzTimer(Sender: TObject);
begin
      Inc(xtimerresponse);
end;

procedure Tmdl_richgalery.Tradutor1AoTraduzir(Sender: TObject;
  Traducao: String);
begin
    xreceivetrad:=Traducao;
end;

function Tmdl_richgalery.recebetraducao(xtrad_text,xtrad_de,xtrad_para: String):String;
var xrecebido: Bool;
begin
      xrecebido:=false;
      xreceivetrad:='';
...
procedure Tmdl_richgalery.save_cfg(xcodlng: Integer);
var axcod : integer;
    axshowing: Boolean;
begin
     axshowing:= loadx.Showing;
...
procedure Tmdl_richgalery.monta_table3;
var listaLng_id,axcoddefault,xid_default: Integer;
    axshowing: Boolean;
    //inclui linguagens
...
procedure Tmdl_richgalery.atualiza_grade3;
var axshowing: Boolean;
    axlocid: Integer;
begin
     //banner
...
procedure Tmdl_richgalery.limpaphoto3(xupdateset:Boolean);
begin
...
procedure Tmdl_richgalery.bt_open3Click(Sender: TObject);
var xfilext,xnamefile: String;
    xerror: Boolean;
    codBitmap: TBitmap;
    codJpeg: TJPEGImage;
...
procedure Tmdl_richgalery.bt_limpar3Click(Sender: TObject);
begin
      limpaphoto3(true);
end;

procedure Tmdl_richgalery.bt_save3Click(Sender: TObject);
begin
      save_cfg(listaLng.cod_lng[PageControl_languagens.TabIndex]);
end;

procedure Tmdl_richgalery.PageControl1Change(Sender: TObject);
begin
...
procedure Tmdl_richgalery.MenuItem1Click(Sender: TObject);
var axshowing: Boolean;
begin
...
procedure Tmdl_richgalery.bt_del2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_richgalery.ComboBox_entChange(Sender: TObject);
begin
      if StrtoInt(AxDadosUsr.axparm) > 5000 then begin
...
procedure Tmdl_richgalery.bt_helpClick(Sender: TObject);
begin
      //Tópicos de ajuda
...
procedure Tmdl_richgalery.StatusBar1Click(Sender: TObject);
begin
      hwsf.BtSobre;
end;

procedure Tmdl_richgalery.ToolBar_grpResize(Sender: TObject);
begin
     cb_group.Width := ToolBar_grp.Width - 50;
end;

procedure Tmdl_richgalery.Desfazer1Click(Sender: TObject);
begin
     //desfazer
...
procedure Tmdl_richgalery.Recortar1Click(Sender: TObject);
begin
     //recortar
     retorna_TRxRichEdit(PageControlab.TabIndex).CutToClipboard;
end;

procedure Tmdl_richgalery.Copiar1Click(Sender: TObject);
begin
     //copiar
     retorna_TRxRichEdit(PageControlab.TabIndex).CopyToClipboard;
end;

procedure Tmdl_richgalery.Colar1Click(Sender: TObject);
begin
      //colar
     retorna_TRxRichEdit(PageControlab.TabIndex).PasteFromClipboard;
end;

procedure Tmdl_richgalery.Cor1Click(Sender: TObject);
begin
     //cor da fonte
...
procedure Tmdl_richgalery.Negrito1Click(Sender: TObject);
begin
     //negrito
     if FUpdating then Exit;
...
procedure Tmdl_richgalery.Italico1Click(Sender: TObject);
begin
     //italico
     if FUpdating then Exit;
...
procedure Tmdl_richgalery.Sublinhado1Click(Sender: TObject);
begin
     //sublinhado
     if FUpdating then Exit;
...
procedure Tmdl_richgalery.Marcador1Click(Sender: TObject);
begin
     //marcador
     if FUpdating then Exit;
...
procedure Tmdl_richgalery.AlignButtonClick(Sender: TObject);
begin
...
procedure Tmdl_richgalery.esquerdo1Click(Sender: TObject);
begin
     retorna_LeftAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richgalery.centro1Click(Sender: TObject);
begin
     retorna_CenterAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richgalery.direita1Click(Sender: TObject);
begin
     retorna_RightAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richgalery.justificado1Click(Sender: TObject);
begin
     retorna_JustifyAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richgalery.re_editorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tmdl_richgalery.SelectionChange(Sender: TObject);
begin
  //if processoand then exit;
...
function Tmdl_richgalery.CurrText: TRxTextAttributes;
begin
...
procedure Tmdl_richgalery.SetEditRect;
var
  R: TRect;
begin
  with retorna_TRxRichEdit(PageControlab.TabIndex) do
...
procedure Tmdl_richgalery.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
function Tmdl_richgalery.retorna_TRxRichEdit(xidxcod:Integer):TRxRichEdit;
begin
      Case xidxcod of
          0: Result:=re_editor1;
          1: Result:=re_editor2;
...
function Tmdl_richgalery.retorna_fontName(xidxcod:Integer):TComboBox;
begin
      Case xidxcod of
          0: Result:=FontName1;
          1: Result:=FontName2;
...
function Tmdl_richgalery.retorna_fontSize(xidxcod:Integer):TEdit;
begin
      Case xidxcod of
          0: Result:=FontSize1;
          1: Result:=FontSize2;
...
function Tmdl_richgalery.retorna_BoldButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richgalery.retorna_ItalicButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richgalery.retorna_UnderlineButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richgalery.retorna_LeftAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
          0: Result:=LeftAlign1;
          1: Result:=LeftAlign2;
...
function Tmdl_richgalery.retorna_CenterAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richgalery.retorna_RightAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richgalery.retorna_JustifyAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richgalery.retorna_BulletsButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
procedure Tmdl_richgalery.cb_groupChange(Sender: TObject);
begin
...
procedure Tmdl_richgalery.monta_tableclass;
...
procedure Tmdl_richgalery.bt_newclassClick(Sender: TObject);
...
procedure Tmdl_richgalery.bt_delclassClick(Sender: TObject);
...
procedure Tmdl_richgalery.PanelclassResize(Sender: TObject);
begin
...
procedure Tmdl_richgalery.EVsaveKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_richgalery.EVsave2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_richgalery.bt_saveclassClick(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     if (dm.ds_sql.RecordCount>0) and (ab_cod.Caption<>'novo') then begin
...
procedure Tmdl_richgalery.Cordefundo1Click(Sender: TObject);
begin
      //cor de fundo
      if ColorDialog1.Execute then begin
...
procedure Tmdl_richgalery.validaCbClass();
begin
...
procedure Tmdl_richgalery.CheckBox_classClick(Sender: TObject);
begin
      validaCbClass();
end;

procedure Tmdl_richgalery.ComboBox_classKeyPress(Sender: TObject;
  var Key: Char);
begin
      if key=#13 then validaCbClass();
end;

procedure Tmdl_richgalery.ComboBox_classClick(Sender: TObject);
begin
      validaCbClass();
end;

function Tmdl_richgalery.Btsearch_auto_ax(pathdefault,filtrofind:string):Tbt_search_ax;
...
procedure Tmdl_richgalery.bt_view2Click(Sender: TObject);
begin
      if dm.ds_sql3.RecordCount>0 then begin
         Application.CreateForm(Tmdl_richgalery_view,mdl_richgalery_view);
         mdl_richgalery_view.TableImage.xcp_cod:='codigo';
...
procedure Tmdl_richgalery.bt_exp2Click(Sender: TObject);
var xfiljpg : String;
...
procedure Tmdl_richgalery.bt_exp1Click(Sender: TObject);
var xfiljpg : String;
    xImagem_tmp : TMemoryStream;
begin
      if ExportarImgDialog.Execute then begin
...
procedure Tmdl_richgalery.SpeedButton2Click(Sender: TObject);
...
begin
      ...
      if CreateDirtx<>'' then xfilespath:=CreateDirtx
      else xfilespath:=hwsf.Btpath;
      if xfilespath = '' then begin
         ...
         loadx.Close;
         PageControl1.Enabled:=true;
         if xfilespath = '' then hwsf.BtMensagem('Itens exportados com sucesso');
      end;
      if (cb_group.ItemIndex < (cb_group.Items.Count-1)) then begin
          ...
          Application.ProcessMessages;
          Inc(CreateDirax);
          CreateDirtx:='C:\Users\IRONSHADOW\Desktop\fotos\'+inttostr(CreateDirax)+'.'+cb_group.Text;
          CreateDir(CreateDirtx);
          SpeedButton2.Click;
      end;

end;

procedure Tmdl_richgalery.PanelbtviewResize(Sender: TObject);
begin
    bt_view1.Height:=Panelbtview.Height-49;
end;

procedure Tmdl_richgalery.Panelbtview2Resize(Sender: TObject);
begin
    bt_view2.Height:=Panelbtview2.Height-49;
end;

procedure Tmdl_richgalery.bt_imgRotateh1Click(Sender: TObject);
begin
...
procedure Tmdl_richgalery.bt_imgRotatea1Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp1,xlogosz1,xupdatelogo1,ComboBox_model.Text,LstTables.Table[1],'cod_gal','icon',ab_cod.Caption) then
        abretmplogo1;
end;

procedure Tmdl_richgalery.bt_imgRotateh2Click(Sender: TObject);
begin
...
procedure Tmdl_richgalery.bt_imgRotatea2Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp2,xlogosz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_ico',ms_cod.Caption) then begin
        if dm.rotateFoto(-90,xampltmp2,xamplsz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_larg',ms_cod.Caption) then
           abretmplogo2
...
procedure Tmdl_richgalery.bt_invertmv1Click(Sender: TObject);
begin
      invertEdt(false);
end;

procedure Tmdl_richgalery.invertEdt(axIv:Boolean);
var tx : TStringList;
begin
      try
...
procedure Tmdl_richgalery.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
