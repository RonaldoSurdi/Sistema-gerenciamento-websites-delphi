...
uses
  ...
  umdl_lstrich in 'umdl_lstrich.pas' {mdl_lstrich},
  umdl_inserttable in 'umdl_inserttable.pas' {mdl_inserttable};
...
begin
    ...
    Application.Title := 'HWScontrol RichText';
       ...
       if (ParamStr(1) <> '') and (ParamStr(2) = 'Å?Ö¤¶•') and (ParamStr(3) <> '') and (ParamStr(4) <> '') then begin
          ...
          if (dm.conecta_bd(ParamStr(1),ParamStr(3),ParamStr(4))) then begin
             ...
             if HprevHist = 0 then begin
                Application.CreateForm(Tmdl_lstrich, mdl_lstrich);
