...
uses
  ...
  umdl_lstnews in 'umdl_lstnews.pas' {mdl_lstnews},
  ...
  dm.winsysreg(1,false,false);
          if (dm.conecta_bd(ParamStr(1),ParamStr(3),ParamStr(4))) then begin
             ...
             if HprevHist = 0 then begin
                Application.CreateForm(Tmdl_lstnews, mdl_lstnews);
                if (ParamStr(5) <> '') then
                    mdl_lstnews.xiniCodab:= StrToInt(ParamStr(5))
                else mdl_lstnews.xiniCodab:= 0;
             end else begin
