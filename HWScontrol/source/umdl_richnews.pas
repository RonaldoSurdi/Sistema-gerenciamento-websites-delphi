...
type
  ...
  Tmdl_richnews = class(TForm)
    ...
    procedure ab_tituloKeyPress(Sender: TObject; var Key: Char);
  private
    //menus
...
procedure Tmdl_richnews.FormClose(Sender: TObject; var Action: TCloseAction);
...
procedure Tmdl_richnews.FormCreate(Sender: TObject);
var axshowing: Boolean;
...
begin
     ...
     mdl_richnews.Caption:= AxDadosUsr.axtitle;
     xinit:=true;
     axcod_ent:=0;
     PageControltxLast:=-1;
...
procedure Tmdl_richnews.monta_lng;
...
procedure Tmdl_richnews.monta_table1;
var axshowing: Boolean;
...
procedure Tmdl_richnews.monta_table2(xnewgal,xuplng:Boolean);
begin
...
procedure Tmdl_richnews.FormResize(Sender: TObject);
begin
...
procedure Tmdl_richnews.FormActivate(Sender: TObject);
begin
      mdl_richnews.Refresh;
      if xinit then begin
         xinit:=false;
...
procedure Tmdl_richnews.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      Case key of
...
procedure Tmdl_richnews.addreg;
begin
...
procedure Tmdl_richnews.travaformImages(xtrava: Boolean);
begin
...
procedure Tmdl_richnews.addreg2;
begin
     ms_cod.Caption:='novo';
     ax_ms_cod:=0;
     ms_titulo.Text:='';
...
procedure Tmdl_richnews.atualiza_grade;
var axshowing: Boolean;
    axlocid: Integer;
     ...
     axshowing:= loadx.Showing;
      ...
      if dm.ds_sql.RecordCount <= 0 then begin
         ...
         with dm.ds_sql do begin
            ...
            //aqui
            //if not FileExists('C:\Users\IRONSHADOW\Desktop\OsSerranos\04.Noticias\'+FormatDateTime('yyyymmdd',fieldbyname('xdt').AsDateTime)+' '+FormatDateTime('hhnnss',fieldbyname('xdt').AsDateTime)+' - '+fieldbyname('descricao').AsString+'.html') then
            //   xStringMSG.SaveToFile('C:\Users\IRONSHADOW\Desktop\OsSerranos\04.Noticias\'+FormatDateTime('yyyymmdd',fieldbyname('xdt').AsDateTime)+' '+FormatDateTime('hhnnss',fieldbyname('xdt').AsDateTime)+' - '+fieldbyname('descricao').AsString+'.html');
            if ab_cod.Caption = '2074' then
                axnmfl:= '2074'
            else axnmfl:= ab_titulo.Lines.Text;
            //axnmfl:= copy(axnmfl,1,230);
            axnmfl:= trim(axnmfl);
            axnmfl:=('C:\Users\IRONSHADOW\Desktop\OsSerranos\04.Noticias\'+FormatDateTime('yyyymmdd',cb_dt.Date)+' '+FormatDateTime('hhnnss',cb_tm.Time)+' - '+axnmfl+'.html');
            if not FileExists(axnmfl) then
               xStringMSG.SaveToFile(axnmfl);
            xStringMSG.Free;

            Os Serranos embalam lançamento da nova Ranger em Porto Alegre Conjunto tocou na concessionária Ford Super Autoshow durante o evento
            //ComboBox_model.Enabled:=true;
...
procedure Tmdl_richnews.limpaphoto1(xupdateset:Boolean);
begin
...
procedure Tmdl_richnews.atualiza_grade2;
var axshowing: Boolean;
...
procedure Tmdl_richnews.limpaphoto2(xupdateset:Boolean);
begin
...
procedure Tmdl_richnews.bt_new1Click(Sender: TObject);
begin
      addreg;
      ab_titulo.SetFocus;
end;

procedure Tmdl_richnews.bt_new2Click(Sender: TObject);
begin
      addreg2;
      ms_titulo.SetFocus;
end;

procedure Tmdl_richnews.bt_save1Click(Sender: TObject);
                   ...
                   if axcp5TMPimg and not axcp5TMPon then begin
                      if ((copy(axcp5TMPout,2,2)=':/') or
                          ...
                          if not FileExists(axcp5TMPout) then begin
                             ...
                             axcp5ADDstream.Position:=0;
                             if (axcp5ADDstream.Size>5000000) then begin
                                 loadx.Close;
                                 FreeMemStr;
                                 hwsf.BtMensagem('Tamanho do arquivo superior ao permitido [áté 4mb]'+#13+axcp5TMPout);
                                 exit;
                             end;
                             axcp5ADDstream.Clear;
                             axcp5ADDstream.Position:=0;
...
procedure Tmdl_richnews.ComboBox_webChange(Sender: TObject);
begin
...
procedure Tmdl_richnews.bt_save2Click(Sender: TObject);
...
procedure Tmdl_richnews.getLogo1;
...
procedure Tmdl_richnews.abretmplogo1;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp1.Seek(0,soFromBeginning);
...
procedure Tmdl_richnews.getLogo2;
var axcodBlb: Integer;
begin
     try
...
procedure Tmdl_richnews.abretmplogo2;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp2.Seek(0,soFromBeginning);
...
procedure Tmdl_richnews.getBanner;
begin
     xbannertmp.Clear;
...
procedure Tmdl_richnews.abretmpbanner;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xbannertmp.Seek(0,soFromBeginning);
...
procedure Tmdl_richnews.bt_limpar1Click(Sender: TObject);
begin
      limpaphoto1(True);
...
procedure Tmdl_richnews.bt_limpar2Click(Sender: TObject);
begin
      limpaphoto2(True);
...
procedure Tmdl_richnews.bt_view1Click(Sender: TObject);
begin
      if dm.ds_sql.RecordCount>0 then begin
         ...
         mdl_richgalery_view.Left:=mdl_richnews.Width-mdl_richgalery_view.Width;
         mdl_richgalery_view.Top:=mdl_richnews.Height-mdl_richgalery_view.Height;
         mdl_richgalery_view.Show;
      end;
end;

procedure Tmdl_richnews.bt_open1Click(Sender: TObject);
...
procedure Tmdl_richnews.bt_open2Click(Sender: TObject);
var xfilext,xnamefile: String;
    xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
    xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp: Integer;
...
procedure Tmdl_richnews.chk_view1Click(Sender: TObject);
begin
      if chk_view1.Checked then getLogo1;
end;

procedure Tmdl_richnews.chk_view2Click(Sender: TObject);
begin
      if chk_view2.Checked then getLogo2;
end;

procedure Tmdl_richnews.Splitter1Moved(Sender: TObject);
begin
      ComboBox_web.Width:=ToolBar_web.Width-53;
end;

procedure Tmdl_richnews.DBGrid1CellClick(Column: TColumn);
begin
      atualiza_grade;
end;

procedure Tmdl_richnews.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_richnews.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_richnews.DBGrid1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade;
end;

procedure Tmdl_richnews.DBGrid2CellClick(Column: TColumn);
begin
      atualiza_grade2;
end;

procedure Tmdl_richnews.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_richnews.DBGrid2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_richnews.DBGrid2MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade2;
end;

procedure Tmdl_richnews.bt_recursiveClick(Sender: TObject);
...
function Tmdl_richnews.inserimg(xnamefile,xfilext:String;
                      xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
                      xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp:Integer;
                      xic_ajt,xic_pr,xil_ajt,xil_pr: Boolean):Boolean;
...
function Tmdl_richnews.retorna_TTabSheet(xidxcod:Integer):TTabSheet;
begin
      Case xidxcod of
          0: Result:=lngtb1;
          1: Result:=lngtb2;
...
procedure Tmdl_richnews.PageControl_languagensChange(Sender: TObject);
begin
...
procedure Tmdl_richnews.Timer_traduzTimer(Sender: TObject);
begin
      Inc(xtimerresponse);
end;

procedure Tmdl_richnews.Tradutor1AoTraduzir(Sender: TObject;
  Traducao: String);
begin
    xreceivetrad:=Traducao;
end;

function Tmdl_richnews.recebetraducao(xtrad_text,xtrad_de,xtrad_para: String):String;
var xrecebido: Bool;
begin
      xrecebido:=false;
      xreceivetrad:='';
...
procedure Tmdl_richnews.save_cfg(xcodlng: Integer);
var axcod : integer;
    axshowing: Boolean;
begin
     axshowing:= loadx.Showing;
...
procedure Tmdl_richnews.monta_table3;
var listaLng_id,axcoddefault,xid_default: Integer;
    axshowing: Boolean;
    //inclui linguagens
...
procedure Tmdl_richnews.atualiza_grade3;
var axshowing: Boolean;
    axlocid: Integer;
begin
     //banner
...
procedure Tmdl_richnews.limpaphoto3(xupdateset:Boolean);
begin
...
procedure Tmdl_richnews.bt_open3Click(Sender: TObject);
var xfilext,xnamefile: String;
    xerror: Boolean;
    codBitmap: TBitmap;
    codJpeg: TJPEGImage;
...
procedure Tmdl_richnews.bt_limpar3Click(Sender: TObject);
begin
      limpaphoto3(true);
end;

procedure Tmdl_richnews.bt_save3Click(Sender: TObject);
begin
      save_cfg(listaLng.cod_lng[PageControl_languagens.TabIndex]);
end;

procedure Tmdl_richnews.PageControl1Change(Sender: TObject);
begin
...
procedure Tmdl_richnews.MenuItem1Click(Sender: TObject);
var axshowing: Boolean;
begin
...
procedure Tmdl_richnews.bt_del2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_richnews.ComboBox_entChange(Sender: TObject);
begin
      if StrtoInt(AxDadosUsr.axparm) > 5000 then begin
...
procedure Tmdl_richnews.bt_helpClick(Sender: TObject);
begin
      //Tópicos de ajuda
...
procedure Tmdl_richnews.StatusBar1Click(Sender: TObject);
begin
      hwsf.BtSobre;
end;

procedure Tmdl_richnews.ToolBar_grpResize(Sender: TObject);
begin
     cb_group.Width := ToolBar_grp.Width;
end;

procedure Tmdl_richnews.Desfazer1Click(Sender: TObject);
begin
     //desfazer
...
procedure Tmdl_richnews.Recortar1Click(Sender: TObject);
begin
     //recortar
     retorna_TRxRichEdit(PageControlab.TabIndex).CutToClipboard;
end;

procedure Tmdl_richnews.Copiar1Click(Sender: TObject);
begin
     //copiar
     retorna_TRxRichEdit(PageControlab.TabIndex).CopyToClipboard;
end;

procedure Tmdl_richnews.Colar1Click(Sender: TObject);
begin
      //colar
     retorna_TRxRichEdit(PageControlab.TabIndex).PasteFromClipboard;
end;

procedure Tmdl_richnews.Cor1Click(Sender: TObject);
begin
     //cor da fonte
...
procedure Tmdl_richnews.Negrito1Click(Sender: TObject);
begin
     //negrito
     if FUpdating then Exit;
...
procedure Tmdl_richnews.Italico1Click(Sender: TObject);
begin
     //italico
     if FUpdating then Exit;
...
procedure Tmdl_richnews.Sublinhado1Click(Sender: TObject);
begin
     //sublinhado
     if FUpdating then Exit;
...
procedure Tmdl_richnews.Marcador1Click(Sender: TObject);
begin
     //marcador
     if FUpdating then Exit;
...
procedure Tmdl_richnews.AlignButtonClick(Sender: TObject);
begin
...
procedure Tmdl_richnews.esquerdo1Click(Sender: TObject);
begin
     retorna_LeftAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richnews.centro1Click(Sender: TObject);
begin
     retorna_CenterAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richnews.direita1Click(Sender: TObject);
begin
     retorna_RightAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richnews.justificado1Click(Sender: TObject);
begin
     retorna_JustifyAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richnews.re_editorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
    try
...
procedure Tmdl_richnews.SelectionChange(Sender: TObject);
begin
  try
  //if processoand then exit;
...
function Tmdl_richnews.CurrText: TRxTextAttributes;
begin
...
procedure Tmdl_richnews.SetEditRect;
var
  R: TRect;
begin
  with retorna_TRxRichEdit(PageControlab.TabIndex) do
...
procedure Tmdl_richnews.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
function Tmdl_richnews.retorna_TRxRichEdit(xidxcod:Integer):TRxRichEdit;
begin
      Case xidxcod of
          //0: Result:=re_editor1;
          1: Result:=re_editor2;
...
function Tmdl_richnews.retorna_fontName(xidxcod:Integer):TComboBox;
begin
      Case xidxcod of
          //0: Result:=FontName1;
          1: Result:=FontName2;
...
function Tmdl_richnews.retorna_fontSize(xidxcod:Integer):TEdit;
begin
      Case xidxcod of
          //0: Result:=FontSize1;
          1: Result:=FontSize2;
...
function Tmdl_richnews.retorna_BoldButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richnews.retorna_ItalicButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richnews.retorna_UnderlineButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richnews.retorna_LeftAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
          //0: Result:=LeftAlign1;
          1: Result:=LeftAlign2;
...
function Tmdl_richnews.retorna_CenterAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richnews.retorna_RightAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richnews.retorna_JustifyAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richnews.retorna_BulletsButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
begin
      if (PageControlab.TabIndex = 1) then begin
         ...
         With dm.ds_sql do begin
             if (recordcount <= 0) then begin
                hwsf.BtMensagem('Não há Artigos cadastrados.');
...
procedure Tmdl_richnews.cb_groupChange(Sender: TObject);
begin
...
function Tmdl_richnews.atualizafeed:Boolean;
begin
    WebBrowser_feed.Navigate('http://'+AxDadosUsr.website+'/feed_upd.php');
    hwsf.BtMensagem('Feed de Artigos Atualizado com sucesso.');
end;

procedure Tmdl_richnews.monta_tableclass;
...
procedure Tmdl_richnews.EVsaveKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_richnews.EVsave2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_richnews.Cordefundo1Click(Sender: TObject);
begin
      //cor de fundo
      if ColorDialog1.Execute then begin
...
procedure Tmdl_richnews.validaCbClass;
//var axshowing: Boolean;
begin
{     axshowing:= loadx.Showing;
     if not axshowing then begin
...
function Tmdl_richnews.Btsearch_auto_ax(pathdefault,filtrofind:string):Tbt_search_ax;
...
procedure Tmdl_richnews.bt_exp1Click(Sender: TObject);
var xfiljpg : String;
...
procedure Tmdl_richnews.bt_view2Click(Sender: TObject);
begin
      if dm.ds_sql3.RecordCount>0 then begin
         Application.CreateForm(Tmdl_richgalery_view,mdl_richgalery_view);
         mdl_richgalery_view.TableImage.xcp_cod:='codigo';
...
procedure Tmdl_richnews.bt_exp2Click(Sender: TObject);
var xfiljpg : String;
    xImagem_tmp : TMemoryStream;
begin
      if ExportarImgDialog.Execute then begin
...
procedure Tmdl_richnews.SpeedButton2Click(Sender: TObject);
...
begin
      ...
      //axnmfl:= copy(axnmfl,1,230);
      axnmfl:= trim(axnmfl);
      axnmfl:=('C:\Users\IRONSHADOW\Desktop\OsSerranos\04.Noticias\'+FormatDateTime('yyyymmdd',cb_dt.Date)+' '+FormatDateTime('hhnnss',cb_tm.Time)+' - '+axnmfl);

      if not DirectoryExists(axnmfl) then
         CreateDir(axnmfl);
      xfilespath:= axnmfl;
      ...
      if xfilespath = '' then begin
         ...
         While not dm.ds_sql3.Eof do begin
           ...
           xImagem_tmp.SaveToFile(xfilespath+'\imagem'+inttostr(xidimg)+'.jpg');
           inc(xidimg);
           dm.ds_sql3.Next;
         end;
         xImagem_tmp.Free;
...
procedure Tmdl_richnews.SpeedButton4Click(Sender: TObject);
begin
      DBGrid1.SetFocus;
...
procedure Tmdl_richnews.xfil_ate_chkClick(Sender: TObject);
begin
      xfil_ate.Enabled:=xfil_ate_chk.Checked;
end;

procedure Tmdl_richnews.xfil_de_chkClick(Sender: TObject);
begin
      xfil_de.Enabled:=xfil_de_chk.Checked;
end;

procedure Tmdl_richnews.PanelbtviewResize(Sender: TObject);
begin
    bt_view1.Height:=Panelbtview.Height-49;
end;

procedure Tmdl_richnews.Panelbtview2Resize(Sender: TObject);
begin
    bt_view2.Height:=Panelbtview2.Height-49;
end;

procedure Tmdl_richnews.bt_imgRotateh1Click(Sender: TObject);
begin
...
procedure Tmdl_richnews.bt_imgRotatea1Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp1,xlogosz1,xupdatelogo1,ComboBox_model.Text,LstTables.Table[1],'cod_gal','icon',ab_cod.Caption) then
        abretmplogo1;
end;

procedure Tmdl_richnews.bt_imgRotateh2Click(Sender: TObject);
begin
...
procedure Tmdl_richnews.bt_imgRotatea2Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp2,xlogosz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_ico',ms_cod.Caption) then begin
        if dm.rotateFoto(-90,xampltmp2,xamplsz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_larg',ms_cod.Caption) then
           abretmplogo2
...
procedure Tmdl_richnews.MenuItem2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_richnews.bt_cancel1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
      if (dm.ds_sql.RecordCount>0) and (ab_cod.Caption<>'novo') then begin
        ...
        if hwsf.BtConfirma('Tem certeza que desejas cancelar o Registro?') then begin
           axshowing:= loadx.Showing;
           if not axshowing then begin
              loadx := Tloadx.Create(Application);
              loadx.lbloading.Caption:='Cancelando Registro';
              loadx.Show;
              loadx.Update;
           end else begin
              loadx.lbloading.Caption:='Cancelando Registro';
...
procedure Tmdl_richnews.bt_activate1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_richnews.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
...
procedure Tmdl_richnews.resetWebBrowse;
...
procedure Tmdl_richnews.SetRepetirImagem(xreptid:Integer);
var axreptx: String;
begin
    Case xreptid of
        0: axreptx:='no-repeat';
...
procedure Tmdl_richnews.setxHtml(xabaED:Integer);
...
procedure Tmdl_richnews.InternalSaveDocumentToStream(
...
procedure Tmdl_richnews.InternalSaveBodyHTMLToStream(const Stream: TStream);
var
  HTMLStr: string;
  Doc: IHTMLDocument2;
...
procedure Tmdl_richnews.InternalSaveBodyHTMLToStringList(const StringList: TStringList);
var
  HTMLStr: string;
  Doc: IHTMLDocument2;
  BodyElement: IHTMLElement;
...
procedure Tmdl_richnews.InternalSaveBodyTextToStream(const Stream: TStream);
var
  TextStr: string;
  Doc: IHTMLDocument2;
  BodyElement: IHTMLElement;
...
procedure Tmdl_richnews.InternalLoadDocumentFromStream(const Stream: TStream);
var
  PersistStreamInit: IPersistStreamInit;
  StreamAdapter: IStream;
begin
...
procedure Tmdl_richnews.SpeedButton10Click(Sender: TObject);
begin
    resetWebBrowse;
end;

procedure Tmdl_richnews.SpeedButton9Click(Sender: TObject);
begin
      bt_save1.Click;
end;

procedure Tmdl_richnews.SpeedButton11Click(Sender: TObject);
begin
    InvokeCMD(WebBrowser1, HTMLID_FIND);
end;

procedure Tmdl_richnews.SpeedButton8Click(Sender: TObject);
var
...
procedure Tmdl_richnews.NoRepetir1Click(Sender: TObject);
begin
    if (not NoRepetir1.Checked) then
        SetRepetirImagem(0);
end;

procedure Tmdl_richnews.repetirimagem1Click(Sender: TObject);
begin
    if (not repetirimagem1.Checked) then
        SetRepetirImagem(1);
end;

procedure Tmdl_richnews.RepetirX1Click(Sender: TObject);
begin
    if (not RepetirX1.Checked) then
        SetRepetirImagem(2);
end;

procedure Tmdl_richnews.RepetirY1Click(Sender: TObject);
begin
    if (not RepetirY1.Checked) then
        SetRepetirImagem(3);
end;

procedure Tmdl_richnews.Fixarfundo1Click(Sender: TObject);
begin
...
procedure Tmdl_richnews.Limpar1Click(Sender: TObject);
begin
       HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
...
procedure Tmdl_richnews.combofontChange(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('FontName', False,ComboFont.Text);
end;

procedure Tmdl_richnews.ComboSizeChange(Sender: TObject);
begin
...
procedure Tmdl_richnews.SpeedButton1Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('Bold', False,0);
end;

procedure Tmdl_richnews.SpeedButton3Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('Italic', False,0);
end;

procedure Tmdl_richnews.SpeedButton5Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('Underline', False,0);
end;

procedure Tmdl_richnews.SpeedButton6Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    if cdColor.Execute then
...
procedure Tmdl_richnews.ComboSpeedButton1Click(Sender: TObject);
...
procedure Tmdl_richnews.ComboBox_classClick(Sender: TObject);
begin
      validaCbClass;
end;

procedure Tmdl_richnews.ComboBox_classKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      validaCbClass;
end;

procedure Tmdl_richnews.ComboBox_classKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      validaCbClass;
end;

procedure Tmdl_richnews.ComboBox_classMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      validaCbClass;
end;

procedure Tmdl_richnews.WebBrowser_feedDownloadComplete(Sender: TObject);
begin
      feedokupd:=true;
end;

procedure Tmdl_richnews.bt_newSrvClick(Sender: TObject);
...
procedure Tmdl_richnews.bt_delSrvClick(Sender: TObject);
...
begin
      ...
      With dm.ds_sql8 do begin
         ...
         if (recordcount>0) then begin
            axvincul:=true;
            Close;
            hwsf.BtMensagem('Exclusão não permitida, pois existem Artigos vinculados a esta categoria.');
            Exit;
         end;
      end;
      axshowing:= loadx.Showing;
...
procedure Tmdl_richnews.ab_tituloKeyPress(Sender: TObject; var Key: Char);
begin
