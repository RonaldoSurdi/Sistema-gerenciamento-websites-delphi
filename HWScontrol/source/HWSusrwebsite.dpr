...
uses
  ...
  umdl_usrwebsite in 'umdl_usrwebsite.pas' {mdl_usrwebsite};
...
begin
    ...
    Application.Title := 'HWScontrol usuários vip';
       ...
       if (ParamStr(1) <> '') and (ParamStr(2) = 'Å?Ö¤¶•') and (ParamStr(3) <> '') and (ParamStr(4) <> '') then begin
          ...
          if (dm.conecta_bd(ParamStr(1),ParamStr(3),ParamStr(4))) then begin
             ...
             if HprevHist = 0 then begin
                ...
                Application.CreateForm(Tmdl_usrwebsite, mdl_usrwebsite);
             end else begin
