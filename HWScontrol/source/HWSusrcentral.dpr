...
uses
  ...
  umdl_usrcentral in 'umdl_usrcentral.pas' {mdl_usrcentral};
...
begin
    ...
    Application.Title := 'HWScontrol Usuários Central';
       ...
       if (ParamStr(1) <> '') and (ParamStr(2) = 'Å?Ö¤¶•') and (ParamStr(3) <> '') and (ParamStr(4) <> '') then begin
          ...
          if (dm.conecta_bd(ParamStr(1),ParamStr(3),ParamStr(4))) then begin
             ...
             if HprevHist = 0 then begin
                ...
                Application.CreateForm(Tmdl_usrcentral, mdl_usrcentral);
             end else begin
