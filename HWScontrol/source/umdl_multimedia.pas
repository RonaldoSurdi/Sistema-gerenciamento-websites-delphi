...
type
  ...
  Tmdl_multimedia = class(TForm)
    ...
    Label_size1: TLabel;
    chk_view1: TCheckBox;
    ExportarImgDialog2: TSavePictureDialog;
  ...
  private
    ...
    FUpdating: Boolean;
    xlogotmp2_tmp,xampltmp2_tmp: TMemoryStream;
    procedure monta_lng;
...
procedure Tmdl_multimedia.FormClose(Sender: TObject; var Action: TCloseAction);
...
procedure Tmdl_multimedia.FormCreate(Sender: TObject);
var axshowing: Boolean;
...
begin
     ...
     mdl_multimedia.Caption:= AxDadosUsr.axtitle;
     xinit:=true;
     axcod_ent:=0;
...
procedure Tmdl_multimedia.monta_lng;
...
procedure Tmdl_multimedia.monta_table1;
var axshowing: Boolean;
...
procedure Tmdl_multimedia.monta_table2(xnewgal,xuplng:Boolean);
var xcodgal: string;
begin
...
procedure Tmdl_multimedia.FormResize(Sender: TObject);
begin
...
procedure Tmdl_multimedia.FormActivate(Sender: TObject);
begin
      mdl_multimedia.Refresh;
      if xinit then begin
         xinit:=false;
...
procedure Tmdl_multimedia.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      Case key of
...
procedure Tmdl_multimedia.addreg;
begin
     ab_cod.Caption:='novo';
     ax_ab_cod:=0;
     ab_titulo.Text:='';
...
procedure Tmdl_multimedia.travaformImages(xtrava: Boolean);
begin
...
procedure Tmdl_multimedia.addreg2;
begin
     ms_cod.Caption:='novo';
     ax_ms_cod:=0;
     ms_titulo.Text:='';
...
procedure Tmdl_multimedia.atualiza_grade;
...
procedure Tmdl_multimedia.limpaphoto1(xupdateset:Boolean);
begin
...
procedure Tmdl_multimedia.atualiza_grade2;
var axshowing: Boolean;
    st_stream : TMemoryStream;
begin
     //banco de imagens
...
procedure Tmdl_multimedia.limpaphoto2(xupdateset:Boolean);
begin
...
procedure Tmdl_multimedia.bt_new1Click(Sender: TObject);
begin
      addreg;
      ab_titulo.SetFocus;
end;

procedure Tmdl_multimedia.bt_new2Click(Sender: TObject);
begin
      addreg2;
      ms_titulo.SetFocus;
end;

procedure Tmdl_multimedia.bt_del1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_multimedia.bt_save1Click(Sender: TObject);
var axcod,axcod2,axgal_id,cod_model,xidxlng,xid_default,axcodgrp,ax_ab_codinsert,xlogotmp1sz: integer;
...
begin
     ...
     xexecutaimg:=true;
     xlogotmp1.Seek(0,soFromBeginning);
     xlogotmp1sz:= xlogotmp1.size;
     xlogotmp1.Seek(0,soFromBeginning);
     if (xlogotmp1sz > 0) then begin
        if ab_cod.Caption = 'novo' then begin
...
procedure Tmdl_multimedia.ComboBox_webChange(Sender: TObject);
begin
...
procedure Tmdl_multimedia.bt_save2Click(Sender: TObject);
...
procedure Tmdl_multimedia.getLogo1;
...
procedure Tmdl_multimedia.abretmplogo1;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp1.Seek(0,soFromBeginning);
...
procedure Tmdl_multimedia.getLogo2;
var axcodBlb: Integer;
begin
     try
...
procedure Tmdl_multimedia.abretmplogo2;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp2.Seek(0,soFromBeginning);
...
procedure Tmdl_multimedia.getBanner;
begin
     xbannertmp.Clear;
...
procedure Tmdl_multimedia.abretmpbanner;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xbannertmp.Seek(0,soFromBeginning);
...
procedure Tmdl_multimedia.bt_limpar1Click(Sender: TObject);
begin
      limpaphoto1(True);
...
procedure Tmdl_multimedia.bt_limpar2Click(Sender: TObject);
begin
      limpaphoto2(True);
...
procedure Tmdl_multimedia.bt_view1Click(Sender: TObject);
begin
      if dm.ds_sql.RecordCount>0 then begin
         Application.CreateForm(Tmdl_multimedia_view,mdl_multimedia_view);
         mdl_multimedia_view.TableImage.xcp_cod3:='codigo';
         mdl_multimedia_view.TableImage.xcp_descricao:='descricao';
         mdl_multimedia_view.TableImage.xcp_img:='icon';
         mdl_multimedia_view.TableImage.xcp_tableimg:=LstTables.Table[1];
         mdl_multimedia_view.TableImage.xcp_codimg:='cod_gal';
         mdl_multimedia_view.TableImage.xcp_table:= dm.ds_sql;
         mdl_multimedia_view.Show;
      end;
end;

procedure Tmdl_multimedia.bt_open1Click(Sender: TObject);
...
begin
      if ImportarImgDialog.Execute then begin
         ...
         if not axshowing then begin
            loadx := Tloadx.Create(Application);
            loadx.lbloading.Caption:='Importando';
            loadx.Show;
            loadx.Update;
         end else begin
            loadx.lbloading.Caption:='Importando';
...
procedure Tmdl_multimedia.bt_open2Click(Sender: TObject);
var xfilext,xnamefile: String;
    xerror: Boolean;
    axshowing: Boolean;
begin
...
procedure Tmdl_multimedia.chk_view1Click(Sender: TObject);
begin
      if chk_view1.Checked then getLogo1;
end;

procedure Tmdl_multimedia.chk_view2Click(Sender: TObject);
begin
      if chk_view2.Checked then getLogo2;
end;

procedure Tmdl_multimedia.DBGrid1CellClick(Column: TColumn);
begin
      atualiza_grade;
end;

procedure Tmdl_multimedia.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_multimedia.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_multimedia.DBGrid1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade;
end;

procedure Tmdl_multimedia.DBGrid2CellClick(Column: TColumn);
begin
      atualiza_grade2;
end;

procedure Tmdl_multimedia.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_multimedia.DBGrid2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_multimedia.DBGrid2MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade2;
end;

procedure Tmdl_multimedia.ComboSpeedButton1Click(Sender: TObject);
begin
      getLogo2;
end;

procedure Tmdl_multimedia.Ampliar1Click(Sender: TObject);
begin
      if dm.ds_sql3.RecordCount>0 then begin
         Application.CreateForm(Tmdl_multimedia_view,mdl_multimedia_view);
         mdl_multimedia_view.TableImage.xcp_cod3:='codigo';
         mdl_multimedia_view.TableImage.xcp_descricao:='descricao';
         mdl_multimedia_view.TableImage.xcp_img:='img_larg';
         mdl_multimedia_view.TableImage.xcp_tableimg:=LstTables.Table[3];
         mdl_multimedia_view.TableImage.xcp_codimg:='cod_img';
         mdl_multimedia_view.TableImage.xcp_table:= dm.ds_sql3;
         mdl_multimedia_view.Show;
      end;
end;

function Tmdl_multimedia.inserimg(xnamefile,xfilext:String):Boolean;
var codStream: TMemoryStream;
    xerror:Boolean;
begin
        Application.ProcessMessages;
        Try
          ...
          loadx.Progressloading.position:=80;
          xerror:=false;
          if FileExists(copy(xnamefile,1,Length(xnamefile)-4)+'_ico'+xfilext) then begin
             xlogotmp2_tmp.LoadFromFile(copy(xnamefile,1,Length(xnamefile)-4)+'_ico'+xfilext);
             xlogotmp2_tmp.Seek(0,soFromBeginning);
          end else if FileExists(copy(xnamefile,1,Length(xnamefile)-4)+'.jpg') then begin
             xlogotmp2_tmp.LoadFromFile(copy(xnamefile,1,Length(xnamefile)-4)+'.jpg');
             xlogotmp2_tmp.Seek(0,soFromBeginning);
          end else begin
             hwsf.BtMensagem('É necessario a disponibilização da miniatura ou Introdução, pode-se utilizar [nomearq]_intro[.extenção] ou [nomearq.jpg]');
             xerror:=true;
          end;
          //loadx.Progressloading.position:=90;
...
function Tmdl_multimedia.retorna_TTabSheet(xidxcod:Integer):TTabSheet;
begin
      Case xidxcod of
          0: Result:=lngtb1;
          1: Result:=lngtb2;
...
procedure Tmdl_multimedia.PageControl_languagensChange(Sender: TObject);
begin
...
procedure Tmdl_multimedia.Timer_traduzTimer(Sender: TObject);
begin
      Inc(xtimerresponse);
end;

procedure Tmdl_multimedia.Tradutor1AoTraduzir(Sender: TObject;
  Traducao: String);
begin
    xreceivetrad:=Traducao;
end;

function Tmdl_multimedia.recebetraducao(xtrad_text,xtrad_de,xtrad_para: String):String;
var xrecebido: Bool;
begin
      xrecebido:=false;
      xreceivetrad:='';
...
procedure Tmdl_multimedia.save_cfg(xcodlng: Integer);
var axcod : integer;
    axshowing: Boolean;
begin
     axshowing:= loadx.Showing;
...
procedure Tmdl_multimedia.monta_table3;
var listaLng_id,axcoddefault,xid_default: Integer;
    axshowing: Boolean;
    //inclui linguagens
...
procedure Tmdl_multimedia.atualiza_grade3;
var axshowing: Boolean;
    axlocid: Integer;
begin
     //banner
...
procedure Tmdl_multimedia.limpaphoto3(xupdateset:Boolean);
begin
...
procedure Tmdl_multimedia.bt_open3Click(Sender: TObject);
var xfilext,xnamefile: String;
    xerror: Boolean;
    codBitmap: TBitmap;
    codJpeg: TJPEGImage;
...
begin
      if OpenBannerDialog.Execute then begin
         ...
         if (xbannersz > 10000000) then begin
            limpaphoto3(xupdatebanner);
            try loadx.Close; except end;
            hwsf.BtMensagem('Tamanho do arquivo excedeu o limite de 10 Mb.');
            exit;
         end;
         xupdatebanner:=true;
         try loadx.Close; except end;
...
procedure Tmdl_multimedia.bt_limpar3Click(Sender: TObject);
begin
      limpaphoto3(true);
end;

procedure Tmdl_multimedia.bt_save3Click(Sender: TObject);
begin
      save_cfg(listaLng.cod_lng[PageControl_languagens.TabIndex]);
end;

procedure Tmdl_multimedia.PageControl1Change(Sender: TObject);
begin
      if PageControl1.TabIndex=1 then atualiza_grade3;
end;

procedure Tmdl_multimedia.MenuItem1Click(Sender: TObject);
var axshowing: Boolean;
begin
...
procedure Tmdl_multimedia.bt_del2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_multimedia.ComboBox_entChange(Sender: TObject);
begin
      if StrtoInt(AxDadosUsr.axparm) > 5000 then begin
...
procedure Tmdl_multimedia.Salvarcomo1Click(Sender: TObject);
var xfiljpg : String;
...
begin
      if ExportarImgDialog.Execute then begin
         ...
         if not axshowing then begin
             loadx := Tloadx.Create(Application);
             loadx.lbloading.Caption:='Download em progresso';
             loadx.Show;
             loadx.Update;
         end else begin
             loadx.lbloading.Caption:='Download em progresso';
         ...
         if copy(xfiljpg,(Length(xfiljpg)-4),4) <> '.hws' then
            xfiljpg := xfiljpg + '.hws';
...
procedure Tmdl_multimedia.bt_helpClick(Sender: TObject);
begin
      //Tópicos de ajuda
...
procedure Tmdl_multimedia.StatusBar1Click(Sender: TObject);
begin
      hwsf.BtSobre;
end;

procedure Tmdl_multimedia.ToolBar_grpResize(Sender: TObject);
begin
     cb_group.Width := ToolBar_grp.Width - 50;
end;

procedure Tmdl_multimedia.Desfazer1Click(Sender: TObject);
begin
     //desfazer
...
procedure Tmdl_multimedia.Recortar1Click(Sender: TObject);
begin
     //recortar
     retorna_TRxRichEdit(PageControlab.TabIndex).CutToClipboard;
end;

procedure Tmdl_multimedia.Copiar1Click(Sender: TObject);
begin
     //copiar
     retorna_TRxRichEdit(PageControlab.TabIndex).CopyToClipboard;
end;

procedure Tmdl_multimedia.Colar1Click(Sender: TObject);
begin
      //colar
     retorna_TRxRichEdit(PageControlab.TabIndex).PasteFromClipboard;
end;

procedure Tmdl_multimedia.Cor1Click(Sender: TObject);
begin
     //cor da fonte
...
procedure Tmdl_multimedia.Negrito1Click(Sender: TObject);
begin
     //negrito
     if FUpdating then Exit;
...
procedure Tmdl_multimedia.Italico1Click(Sender: TObject);
begin
     //italico
     if FUpdating then Exit;
...
procedure Tmdl_multimedia.Sublinhado1Click(Sender: TObject);
begin
     //sublinhado
     if FUpdating then Exit;
...
procedure Tmdl_multimedia.Marcador1Click(Sender: TObject);
begin
     //marcador
     if FUpdating then Exit;
...
procedure Tmdl_multimedia.AlignButtonClick(Sender: TObject);
begin
...
procedure Tmdl_multimedia.esquerdo1Click(Sender: TObject);
begin
     retorna_LeftAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_multimedia.centro1Click(Sender: TObject);
begin
     retorna_CenterAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_multimedia.direita1Click(Sender: TObject);
begin
     retorna_RightAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_multimedia.justificado1Click(Sender: TObject);
begin
     retorna_JustifyAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_multimedia.re_editorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tmdl_multimedia.SelectionChange(Sender: TObject);
begin
  //if processoand then exit;
...
function Tmdl_multimedia.CurrText: TRxTextAttributes;
begin
...
procedure Tmdl_multimedia.SetEditRect;
var
  R: TRect;
begin
  with retorna_TRxRichEdit(PageControlab.TabIndex) do
...
procedure Tmdl_multimedia.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
function Tmdl_multimedia.retorna_TRxRichEdit(xidxcod:Integer):TRxRichEdit;
begin
      Case xidxcod of
          0: Result:=re_editor1;
          1: Result:=re_editor2;
...
function Tmdl_multimedia.retorna_fontName(xidxcod:Integer):TComboBox;
begin
      Case xidxcod of
          0: Result:=FontName1;
          1: Result:=FontName2;
...
function Tmdl_multimedia.retorna_fontSize(xidxcod:Integer):TEdit;
begin
      Case xidxcod of
          0: Result:=FontSize1;
          1: Result:=FontSize2;
...
function Tmdl_multimedia.retorna_BoldButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_multimedia.retorna_ItalicButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_multimedia.retorna_UnderlineButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_multimedia.retorna_LeftAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
          0: Result:=LeftAlign1;
          1: Result:=LeftAlign2;
...
function Tmdl_multimedia.retorna_CenterAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_multimedia.retorna_RightAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_multimedia.retorna_JustifyAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_multimedia.retorna_BulletsButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
      ...
      if (PageControlab.TabIndex = 1) then begin
         ...
         With dm.ds_sql do begin
             if (recordcount <= 0) then begin
                ...
                hwsf.BtMensagem('Antes de inserir os itens grave as informações do álbum.');
                PageControlab.TabIndex:=0;
                exit;
             end;
             axshowing:= loadx.Showing;
...
procedure Tmdl_multimedia.cb_groupChange(Sender: TObject);
begin
...
procedure Tmdl_multimedia.monta_tableclass;
...
procedure Tmdl_multimedia.bt_newclassClick(Sender: TObject);
...
procedure Tmdl_multimedia.bt_delclassClick(Sender: TObject);
...
procedure Tmdl_multimedia.EVsaveKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_multimedia.EVsave2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_multimedia.bt_saveclassClick(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     if (dm.ds_sql.RecordCount>0) and (ab_cod.Caption<>'novo') then begin
...
procedure Tmdl_multimedia.Cordefundo1Click(Sender: TObject);
begin
      //cor de fundo
      if ColorDialog1.Execute then begin
...
procedure Tmdl_multimedia.validaCbClass();
begin
...
procedure Tmdl_multimedia.CheckBox_classClick(Sender: TObject);
begin
      validaCbClass();
end;

procedure Tmdl_multimedia.ComboBox_classKeyPress(Sender: TObject;
  var Key: Char);
begin
      if key=#13 then validaCbClass();
end;

procedure Tmdl_multimedia.ComboBox_classClick(Sender: TObject);
begin
      validaCbClass();
end;

procedure Tmdl_multimedia.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
      hwsf.BtMensagem('AVISO: Falha na conexão.');
end;

procedure Tmdl_multimedia.bt_exp1Click(Sender: TObject);
var xfiljpg : String;
    xImagem_tmp : TMemoryStream;
begin
      if ExportarImgDialog2.Execute then begin
         xfiljpg := ExportarImgDialog2.FileName;
