...
var
  form_restrict1: Tform_restrict1;
...
procedure Tform_restrict1.MountedGrid;
begin
...
procedure Tform_restrict1.atualizaReg;
...
procedure Tform_restrict1.SpeedButton1Click(Sender: TObject);
var axcodIT: Integer;
    axshowing: Boolean;
begin
     Case axtypPerm of
...
procedure Tform_restrict1.SpeedButton7Click(Sender: TObject);
begin
     Case axtypPerm of
          1: begin
             if not dm2.ds_sql5.Active then exit;
...
procedure Tform_restrict1.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
      Action:=caHide;
end;

procedure Tform_restrict1.FormShow(Sender: TObject);
begin
      if mdl_filemanager.axformInit then atualizaReg;
end;

procedure Tform_restrict1.FormCreate(Sender: TObject);
begin
      axMountedGrid:=false;
end;
