...
begin
    ...
    loadx.lbloading.Caption:='HWScontrol Suporte Técnico';
    loadx.Show;
    loadx.Update;
    ...
    HprevHist := FindWindow(Nil, PChar('HWScontrol Suporte Técnico'));
    if HprevHist = 0 then begin
    Application.Title := 'HWScontrol Suporte Técnico';
  ...
  dm.winsysreg(1,true,false);
          if dm.conecta_bd(ParamStr(1),ParamStr(3),'') then begin
             Application.CreateForm(Tadm_st, adm_st);
          end else begin
