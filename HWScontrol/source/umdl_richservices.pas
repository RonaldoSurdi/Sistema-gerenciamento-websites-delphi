...
type
  ...
  Tmdl_richservices = class(TForm)
    ...
    bt_newSrv: TSpeedButton;
    bt_delSrv: TComboSpeedButton;
    ...
    procedure bt_newSrvClick(Sender: TObject);
    procedure bt_delSrvClick(Sender: TObject);
...
var
  mdl_richservices: Tmdl_richservices;
...
procedure Tmdl_richservices.FormClose(Sender: TObject; var Action: TCloseAction);
...
procedure Tmdl_richservices.FormCreate(Sender: TObject);
var axshowing: Boolean;
...
procedure Tmdl_richservices.monta_lng;
...
procedure Tmdl_richservices.monta_table1;
var axshowing: Boolean;
...
begin
     ...
     With dm.ds_sql do begin
          ...
          xfiltdata:='';
          xfiltCod:='0';
          if ComboBox_class.Items.Count>=0 then
             if ComboBox_class.ItemIndex>=0 then
                 xfiltCod:=Cod_ClassArray.Strings[ComboBox_class.ItemIndex];
          xfiltdata:=' AND (cod_class='+#39+xfiltCod+#39+')';
...
procedure Tmdl_richservices.monta_table2(xnewgal,xuplng:Boolean);
begin
...
procedure Tmdl_richservices.FormResize(Sender: TObject);
begin
...
procedure Tmdl_richservices.FormActivate(Sender: TObject);
begin
      try
        mdl_richservices.Refresh;
      except
      end;
      if xinit then begin
         xinit:=false;
...
procedure Tmdl_richservices.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      Case key of
...
procedure Tmdl_richservices.addreg;
begin
...
procedure Tmdl_richservices.travaformImages(xtrava: Boolean);
begin
...
procedure Tmdl_richservices.addreg2;
begin
     ms_cod.Caption:='novo';
     ax_ms_cod:=0;
     ms_titulo.Text:='';
...
procedure Tmdl_richservices.atualiza_grade;
var axshowing: Boolean;
    axlocid: Integer;
...
procedure Tmdl_richservices.limpaphoto1(xupdateset:Boolean);
begin
...
procedure Tmdl_richservices.atualiza_grade2;
var axshowing: Boolean;
...
procedure Tmdl_richservices.limpaphoto2(xupdateset:Boolean);
begin
...
procedure Tmdl_richservices.bt_new1Click(Sender: TObject);
begin
      addreg;
      ab_titulo.SetFocus;
end;

procedure Tmdl_richservices.bt_new2Click(Sender: TObject);
begin
      addreg2;
      ms_titulo.SetFocus;
end;

procedure Tmdl_richservices.bt_save1Click(Sender: TObject);
...
begin
     ax_ab_codinsert:=0;
     axcodgrp:=0;
     if (ComboBox_class2.ItemIndex<0) then begin
        hwsf.BtMensagem('É necessário selecionar o Serviço.');
        ComboBox_class2.SetFocus;
        exit;
     end else axcodgrp:= StrToInt(Cod_ClassArray.Strings[ComboBox_class2.ItemIndex]);
...
procedure Tmdl_richservices.ComboBox_webChange(Sender: TObject);
begin
...
procedure Tmdl_richservices.bt_save2Click(Sender: TObject);
...
procedure Tmdl_richservices.getLogo1;
...
procedure Tmdl_richservices.abretmplogo1;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp1.Seek(0,soFromBeginning);
...
procedure Tmdl_richservices.getLogo2;
var axcodBlb: Integer;
begin
     try
...
procedure Tmdl_richservices.abretmplogo2;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp2.Seek(0,soFromBeginning);
...
procedure Tmdl_richservices.getBanner;
begin
     xbannertmp.Clear;
...
procedure Tmdl_richservices.abretmpbanner;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xbannertmp.Seek(0,soFromBeginning);
...
procedure Tmdl_richservices.bt_limpar1Click(Sender: TObject);
begin
      limpaphoto1(True);
...
procedure Tmdl_richservices.bt_limpar2Click(Sender: TObject);
begin
      limpaphoto2(True);
...
procedure Tmdl_richservices.bt_view1Click(Sender: TObject);
begin
      if dm.ds_sql.RecordCount>0 then begin
         ...
         mdl_richgalery_view.Left:=mdl_richservices.Width-mdl_richgalery_view.Width;
         mdl_richgalery_view.Top:=mdl_richservices.Height-mdl_richgalery_view.Height;
         mdl_richgalery_view.Show;
      end;
end;

procedure Tmdl_richservices.bt_open1Click(Sender: TObject);
...
procedure Tmdl_richservices.bt_open2Click(Sender: TObject);
var xfilext,xnamefile: String;
    xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
    xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp: Integer;
...
procedure Tmdl_richservices.chk_view1Click(Sender: TObject);
begin
      if chk_view1.Checked then getLogo1;
end;

procedure Tmdl_richservices.chk_view2Click(Sender: TObject);
begin
      if chk_view2.Checked then getLogo2;
end;

procedure Tmdl_richservices.Splitter1Moved(Sender: TObject);
begin
      ComboBox_web.Width:=ToolBar_web.Width-53;
end;

procedure Tmdl_richservices.DBGrid1CellClick(Column: TColumn);
begin
      atualiza_grade;
end;

procedure Tmdl_richservices.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_richservices.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_richservices.DBGrid1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade;
end;

procedure Tmdl_richservices.DBGrid2CellClick(Column: TColumn);
begin
      atualiza_grade2;
end;

procedure Tmdl_richservices.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_richservices.DBGrid2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_richservices.DBGrid2MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade2;
end;

procedure Tmdl_richservices.bt_recursiveClick(Sender: TObject);
...
function Tmdl_richservices.inserimg(xnamefile,xfilext:String;
                      xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
                      xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp:Integer;
                      xic_ajt,xic_pr,xil_ajt,xil_pr: Boolean):Boolean;
...
function Tmdl_richservices.retorna_TTabSheet(xidxcod:Integer):TTabSheet;
begin
      Case xidxcod of
          0: Result:=lngtb1;
          1: Result:=lngtb2;
...
procedure Tmdl_richservices.PageControl_languagensChange(Sender: TObject);
begin
...
procedure Tmdl_richservices.Timer_traduzTimer(Sender: TObject);
begin
      Inc(xtimerresponse);
end;

procedure Tmdl_richservices.Tradutor1AoTraduzir(Sender: TObject;
  Traducao: String);
begin
    xreceivetrad:=Traducao;
end;

function Tmdl_richservices.recebetraducao(xtrad_text,xtrad_de,xtrad_para: String):String;
var xrecebido: Bool;
begin
      xrecebido:=false;
      xreceivetrad:='';
...
procedure Tmdl_richservices.save_cfg(xcodlng: Integer);
var axcod : integer;
    axshowing: Boolean;
begin
     axshowing:= loadx.Showing;
...
procedure Tmdl_richservices.monta_table3;
var listaLng_id,axcoddefault,xid_default: Integer;
    axshowing: Boolean;
    //inclui linguagens
...
procedure Tmdl_richservices.atualiza_grade3;
var axshowing: Boolean;
    axlocid: Integer;
begin
     //banner
...
procedure Tmdl_richservices.limpaphoto3(xupdateset:Boolean);
begin
...
procedure Tmdl_richservices.bt_open3Click(Sender: TObject);
var xfilext,xnamefile: String;
    xerror: Boolean;
    codBitmap: TBitmap;
    codJpeg: TJPEGImage;
...
procedure Tmdl_richservices.bt_limpar3Click(Sender: TObject);
begin
      limpaphoto3(true);
end;

procedure Tmdl_richservices.bt_save3Click(Sender: TObject);
begin
      save_cfg(listaLng.cod_lng[PageControl_languagens.TabIndex]);
end;

procedure Tmdl_richservices.PageControl1Change(Sender: TObject);
begin
...
procedure Tmdl_richservices.MenuItem1Click(Sender: TObject);
var axshowing: Boolean;
begin
...
procedure Tmdl_richservices.bt_del2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_richservices.ComboBox_entChange(Sender: TObject);
begin
      if StrtoInt(AxDadosUsr.axparm) > 5000 then begin
...
procedure Tmdl_richservices.bt_helpClick(Sender: TObject);
begin
      //Tópicos de ajuda
...
procedure Tmdl_richservices.StatusBar1Click(Sender: TObject);
begin
      hwsf.BtSobre;
end;

procedure Tmdl_richservices.ToolBar_grpResize(Sender: TObject);
begin
     cb_group.Width := ToolBar_grp.Width;
end;

procedure Tmdl_richservices.Desfazer1Click(Sender: TObject);
begin
     //desfazer
...
procedure Tmdl_richservices.Recortar1Click(Sender: TObject);
begin
     //recortar
     retorna_TRxRichEdit(PageControlab.TabIndex).CutToClipboard;
end;

procedure Tmdl_richservices.Copiar1Click(Sender: TObject);
begin
     //copiar
     retorna_TRxRichEdit(PageControlab.TabIndex).CopyToClipboard;
end;

procedure Tmdl_richservices.Colar1Click(Sender: TObject);
begin
      //colar
     retorna_TRxRichEdit(PageControlab.TabIndex).PasteFromClipboard;
end;

procedure Tmdl_richservices.Cor1Click(Sender: TObject);
begin
     //cor da fonte
...
procedure Tmdl_richservices.Negrito1Click(Sender: TObject);
begin
     //negrito
     if FUpdating then Exit;
...
procedure Tmdl_richservices.Italico1Click(Sender: TObject);
begin
     //italico
     if FUpdating then Exit;
...
procedure Tmdl_richservices.Sublinhado1Click(Sender: TObject);
begin
     //sublinhado
     if FUpdating then Exit;
...
procedure Tmdl_richservices.Marcador1Click(Sender: TObject);
begin
     //marcador
     if FUpdating then Exit;
...
procedure Tmdl_richservices.AlignButtonClick(Sender: TObject);
begin
...
procedure Tmdl_richservices.esquerdo1Click(Sender: TObject);
begin
     retorna_LeftAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richservices.centro1Click(Sender: TObject);
begin
     retorna_CenterAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richservices.direita1Click(Sender: TObject);
begin
     retorna_RightAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richservices.justificado1Click(Sender: TObject);
begin
     retorna_JustifyAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_richservices.re_editorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tmdl_richservices.SelectionChange(Sender: TObject);
begin
  //if processoand then exit;
  try
...
function Tmdl_richservices.CurrText: TRxTextAttributes;
begin
...
procedure Tmdl_richservices.SetEditRect;
var
  R: TRect;
begin
  with retorna_TRxRichEdit(PageControlab.TabIndex) do
...
procedure Tmdl_richservices.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
function Tmdl_richservices.retorna_TRxRichEdit(xidxcod:Integer):TRxRichEdit;
begin
      Case xidxcod of
          //0: Result:=re_editor1;
          1: Result:=re_editor2;
...
function Tmdl_richservices.retorna_fontName(xidxcod:Integer):TComboBox;
begin
      Case xidxcod of
          //0: Result:=FontName1;
          1: Result:=FontName2;
...
function Tmdl_richservices.retorna_fontSize(xidxcod:Integer):TEdit;
begin
      Case xidxcod of
          //0: Result:=FontSize1;
          1: Result:=FontSize2;
...
function Tmdl_richservices.retorna_BoldButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richservices.retorna_ItalicButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richservices.retorna_UnderlineButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richservices.retorna_LeftAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
          //0: Result:=LeftAlign1;
          1: Result:=LeftAlign2;
...
function Tmdl_richservices.retorna_CenterAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richservices.retorna_RightAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richservices.retorna_JustifyAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_richservices.retorna_BulletsButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
procedure Tmdl_richservices.FontNameChange(Sender: TObject);
begin
     if FUpdating then Exit;
     CurrText.Name := retorna_fontName(PageControlab.TabIndex).Items[retorna_fontName(PageControlab.TabIndex).ItemIndex];
end;

procedure Tmdl_richservices.FontSizeChange(Sender: TObject);
begin
     if FUpdating then Exit;
     CurrText.Size := StrToInt(retorna_fontSize(PageControlab.TabIndex).Text);
end;

procedure Tmdl_richservices.PageControlabChange(Sender: TObject);
...
function Tmdl_richservices.atualizafeed:Boolean;
begin
    WebBrowser_feed.Navigate('http://'+AxDadosUsr.website+'/feedsrv_upd.php');
    //hwsf.BtMensagem('Feed de Serviços Atualizado com sucesso.');
end;

procedure Tmdl_richservices.cb_groupChange(Sender: TObject);
begin
...
procedure Tmdl_richservices.monta_tableclass;
var axshowing: Boolean;
    axclass: Integer;
begin
      axshowing:= loadx.Showing;
      if not axshowing then begin
         loadx := Tloadx.Create(Application);
         loadx.lbloading.Caption:='Montando Serviços';
         loadx.Show;
         loadx.Update;
      end else begin
         loadx.lbloading.Caption:='Montando Serviços';
      ...
      With dm.ds_sql6 do begin
          ...
          Filter:=xdsqlfilter;
          loadx.Progressloading.position:=90;
          axclass:=ComboBox_class.ItemIndex;
          Cod_ClassArray.Clear;
          ...
          if recordCount>0 then begin
             First;
             While not Eof do begin
                Cod_ClassArray.Add(fieldbyname('codigo').AsString);
                ComboBox_class.Items.Add(fieldbyname('cp1').AsString);
                Next;
             end;
             First;
             ComboBox_class2.Items:=ComboBox_class.Items;
             if ((axclass >= ComboBox_class.Items.Count) or (axclass<0)) then
                 axclass:=0;
          end else begin
             axclass:=-1;
          end;
          ComboBox_class2.ItemIndex:=axclass;
          ComboBox_class.ItemIndex:=axclass;
      end;
      validaCbClass;
end;

procedure Tmdl_richservices.EVsaveKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_richservices.EVsave2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_richservices.Cordefundo1Click(Sender: TObject);
begin
      //cor de fundo
      if ColorDialog1.Execute then begin
...
procedure Tmdl_richservices.validaCbClass;
var axshowing,frmviewAdd: Boolean;
begin
     ...
     if not axshowing then begin
         ...
         loadx.Show;
         loadx.Update;
         ComboBox_class.Repaint;
     end else begin
         loadx.lbloading.Caption:='Abrindo...';
         loadx.lbloading.Repaint;
     end;
     frmviewAdd:=(ComboBox_class.Items.Count>0);
     if frmviewAdd then frmviewAdd:=(ComboBox_class.ItemIndex>=0);
     Panel_AddCtg.Enabled:=frmviewAdd;
     DBGrid1.Enabled:=frmviewAdd;
     bt_ordemup.Enabled:=(ComboBox_class.ItemIndex>0);
     bt_ordemdown.Enabled:=(ComboBox_class.ItemIndex<ComboBox_class.Items.Count);
     monta_table1;
     try loadx.Close; except end;
     ComboBox_class.Enabled:=true;
end;

function Tmdl_richservices.Btsearch_auto_ax(pathdefault,filtrofind:string):Tbt_search_ax;
...
procedure Tmdl_richservices.bt_exp1Click(Sender: TObject);
var xfiljpg : String;
...
procedure Tmdl_richservices.bt_view2Click(Sender: TObject);
begin
      if dm.ds_sql3.RecordCount>0 then begin
         Application.CreateForm(Tmdl_richgalery_view,mdl_richgalery_view);
         mdl_richgalery_view.TableImage.xcp_cod:='codigo';
...
procedure Tmdl_richservices.bt_exp2Click(Sender: TObject);
var xfiljpg : String;
    xImagem_tmp : TMemoryStream;
begin
      if ExportarImgDialog.Execute then begin
...
procedure Tmdl_richservices.SpeedButton2Click(Sender: TObject);
...
procedure Tmdl_richservices.PanelbtviewResize(Sender: TObject);
begin
    bt_view1.Height:=Panelbtview.Height-49;
end;

procedure Tmdl_richservices.Panelbtview2Resize(Sender: TObject);
begin
    bt_view2.Height:=Panelbtview2.Height-49;
end;

procedure Tmdl_richservices.bt_imgRotateh1Click(Sender: TObject);
begin
...
procedure Tmdl_richservices.bt_imgRotatea1Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp1,xlogosz1,xupdatelogo1,ComboBox_model.Text,LstTables.Table[1],'cod_gal','icon',ab_cod.Caption) then
        abretmplogo1;
end;

procedure Tmdl_richservices.bt_imgRotateh2Click(Sender: TObject);
begin
...
procedure Tmdl_richservices.bt_imgRotatea2Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp2,xlogosz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_ico',ms_cod.Caption) then begin
        if dm.rotateFoto(-90,xampltmp2,xamplsz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_larg',ms_cod.Caption) then
           abretmplogo2
...
procedure Tmdl_richservices.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
...
procedure Tmdl_richservices.resetWebBrowse;
...
procedure Tmdl_richservices.SetRepetirImagem(xreptid:Integer);
var axreptx: String;
begin
    Case xreptid of
        0: axreptx:='no-repeat';
...
procedure Tmdl_richservices.setxHtml(xabaED:Integer);
...
procedure Tmdl_richservices.InternalSaveDocumentToStream(
...
procedure Tmdl_richservices.InternalSaveBodyHTMLToStream(const Stream: TStream);
var
  HTMLStr: string;
  Doc: IHTMLDocument2;
...
procedure Tmdl_richservices.InternalSaveBodyHTMLToStringList(const StringList: TStringList);
var
  HTMLStr: string;
  Doc: IHTMLDocument2;
  BodyElement: IHTMLElement;
...
procedure Tmdl_richservices.InternalSaveBodyTextToStream(const Stream: TStream);
var
  TextStr: string;
  Doc: IHTMLDocument2;
  BodyElement: IHTMLElement;
...
procedure Tmdl_richservices.InternalLoadDocumentFromStream(const Stream: TStream);
var
  PersistStreamInit: IPersistStreamInit;
  StreamAdapter: IStream;
begin
...
procedure Tmdl_richservices.SpeedButton10Click(Sender: TObject);
begin
    resetWebBrowse;
end;

procedure Tmdl_richservices.SpeedButton9Click(Sender: TObject);
begin
      bt_save1.Click;
end;

procedure Tmdl_richservices.SpeedButton11Click(Sender: TObject);
begin
    InvokeCMD(WebBrowser1, HTMLID_FIND);
end;

procedure Tmdl_richservices.SpeedButton8Click(Sender: TObject);
var
...
procedure Tmdl_richservices.NoRepetir1Click(Sender: TObject);
begin
    if (not NoRepetir1.Checked) then
        SetRepetirImagem(0);
end;

procedure Tmdl_richservices.repetirimagem1Click(Sender: TObject);
begin
    if (not repetirimagem1.Checked) then
        SetRepetirImagem(1);
end;

procedure Tmdl_richservices.RepetirX1Click(Sender: TObject);
begin
    if (not RepetirX1.Checked) then
        SetRepetirImagem(2);
end;

procedure Tmdl_richservices.RepetirY1Click(Sender: TObject);
begin
    if (not RepetirY1.Checked) then
        SetRepetirImagem(3);
end;

procedure Tmdl_richservices.Fixarfundo1Click(Sender: TObject);
begin
...
procedure Tmdl_richservices.Limpar1Click(Sender: TObject);
begin
       HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
...
procedure Tmdl_richservices.combofontChange(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('FontName', False,ComboFont.Text);
end;

procedure Tmdl_richservices.ComboSizeChange(Sender: TObject);
begin
...
procedure Tmdl_richservices.SpeedButton1Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('Bold', False,0);
end;

procedure Tmdl_richservices.SpeedButton3Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('Italic', False,0);
end;

procedure Tmdl_richservices.SpeedButton5Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    HTMLDocumento.execCommand('Underline', False,0);
end;

procedure Tmdl_richservices.SpeedButton6Click(Sender: TObject);
begin
    HTMLDocumento := WebBrowser1.Document as IHTMLDocument2;
    if cdColor.Execute then
...
procedure Tmdl_richservices.ComboSpeedButton1Click(Sender: TObject);
...
procedure Tmdl_richservices.ComboBox_classClick(Sender: TObject);
begin
      validaCbClass;
end;

procedure Tmdl_richservices.ComboBox_classKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      validaCbClass;
end;

procedure Tmdl_richservices.ComboBox_classKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      validaCbClass;
end;

procedure Tmdl_richservices.ComboBox_classMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      validaCbClass;
end;

procedure Tmdl_richservices.WebBrowser_feedDownloadComplete(Sender: TObject);
begin
      feedokupd:=true;
end;

procedure Tmdl_richservices.alt_ordem(xtypOrd:Integer);
...
begin
    ...
    if (not updord) then begin
        hwsf.BtMensagem('Serviço selecionado Inválido.');
        Exit;
    end;
    //Cadastrando novo
    axshowing:= loadx.Showing;
...
procedure Tmdl_richservices.bt_ordemupClick(Sender: TObject);
begin
      alt_ordem(0);
end;

procedure Tmdl_richservices.bt_ordemdownClick(Sender: TObject);
begin
      alt_ordem(1);
end;

procedure Tmdl_richservices.bt_newSrvClick(Sender: TObject);
var axgrpname: String;
    axshowing,xexecutaimg: Boolean;
    axcod,axcl_id: Integer; 
    xtxt3: TMemoryStream;
begin
      axgrpname:=hwsf.BtDesc('Digite o título do Serviço:');
      if (axgrpname = '') then begin
         hwsf.BtMensagem('Título inválido.');
         Exit;
      end;
      if (dm.ds_sql6.Locate('cp1',axgrpname,[])) then begin
         hwsf.BtMensagem('Título já cadastrado.');
         Exit;
      end;
      //Cadastrando novo
      axshowing:= loadx.Showing;
...
procedure Tmdl_richservices.bt_delSrvClick(Sender: TObject);
...
begin
      ...
      With dm.ds_sql8 do begin
         ...
         if (recordcount>0) then begin
            axvincul:=true;
            Close;
            hwsf.BtMensagem('Exclusão não permitida, pois itens vinculados a este serviço.');
            Exit;
         end;
      end;
      axshowing:= loadx.Showing;
...
procedure Tmdl_richservices.bt_del1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
