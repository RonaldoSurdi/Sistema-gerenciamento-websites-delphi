object mdl_usrcontact: Tmdl_usrcontact
  Left = 585
  Top = 114
  Width = 749
  Height = 639
    ...
    object GroupBox2: TGroupBox
      ...
      object ToolBar1: TToolBar
        ...
        object ComboSpeedButton1: TComboSpeedButton
          ...
          Width = 128
          Height = 30
          Hint = 'Importar cat'#225'logo csv'
          PopupMenu = PopupMenu_import
          Caption = 'Importar'
          Glyph.Data = {
        ...
        object bt_delALL: TComboSpeedButton
          Left = 245
          Top = 2
          Width = 128
          Height = 30
          Hint = 'AVISO: Todos os Registros Listados ser'#227'o Exlcuidos'
  ...
  object OpenDialog1: TOpenDialog
    Filter = 'Separados por v'#237'rgula ";" [*.csv]|*.csv'
    Title = 'Importar lista de e-mail'#39's'
    Left = 242
    Top = 282
  end
  object PopupMenu_import: TPopupMenu
    Left = 138
    Top = 378
    ...
    object Nomeemail1: TMenuItem
      Caption = 'Nome'
      Checked = True
      OnClick = Nomeemail1Click
    end
    ...
    object Semclassificao1: TMenuItem
      Caption = 'Sem classifica'#231#227'o'
      Checked = True
      OnClick = Semclassificao1Click
    end
    object NewsletterWebsite1: TMenuItem
      Caption = 'Newsletter Website'
      OnClick = NewsletterWebsite1Click
    end
