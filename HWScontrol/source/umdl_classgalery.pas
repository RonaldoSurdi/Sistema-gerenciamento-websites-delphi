...
var
  mdl_classgalery: Tmdl_classgalery;
...
procedure Tmdl_classgalery.FormClose(Sender: TObject; var Action: TCloseAction);
...
procedure Tmdl_classgalery.FormCreate(Sender: TObject);
var axshowing: Boolean;
...
begin
     ...
     mdl_classgalery.Caption:= AxDadosUsr.axtitle;
     xinit:=true;
     axcod_ent:=0;
     ...
     xupdatelogo2:=False;
     xupdatebanner:=False;
     ordem_dbprocessos1:='codigo';
     ordem_dbprocessos2:='codigo';
     ordem_dbprocessos3:='codigo';
     ordem_dbdesc1:=true;
     ordem_dbdesc2:=true;
     ordem_dbdesc3:=true;
...
procedure Tmdl_classgalery.monta_lng;
...
procedure Tmdl_classgalery.monta_table1;
var axshowing: Boolean;
...
procedure Tmdl_classgalery.monta_table2(xnewgal,xuplng:Boolean);
...
procedure Tmdl_classgalery.FormResize(Sender: TObject);
begin
...
procedure Tmdl_classgalery.FormActivate(Sender: TObject);
begin
      mdl_classgalery.Refresh;
      if xinit then begin
         xinit:=false;
...
procedure Tmdl_classgalery.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      Case key of
...
procedure Tmdl_classgalery.addreg;
begin
...
procedure Tmdl_classgalery.travaformImages(xtrava: Boolean);
begin
...
procedure Tmdl_classgalery.addreg2;
begin
     ms_cod.Caption:='novo';
     ax_ms_cod:=0;
     ms_titulo.Text:='';
...
procedure Tmdl_classgalery.addreg3;
begin
     cl_cod.Caption:='novo';
     ax_cl_cod:=0;
     axcod_class:=0;
...
procedure Tmdl_classgalery.atualiza_grade;
var axshowing: Boolean;
    axlocid: Integer;
...
procedure Tmdl_classgalery.atualiza_grade3;
...
procedure Tmdl_classgalery.limpaphoto1(xupdateset:Boolean);
begin
...
procedure Tmdl_classgalery.atualiza_grade2;
var axshowing: Boolean;
    st_stream : TMemoryStream;
begin
     //banco de imagens
...
procedure Tmdl_classgalery.limpaphoto2(xupdateset:Boolean);
begin
...
procedure Tmdl_classgalery.limpaphoto3(xupdateset:Boolean);
begin
...
procedure Tmdl_classgalery.bt_new1Click(Sender: TObject);
begin
      addreg;
      ab_titulo.SetFocus;
end;

procedure Tmdl_classgalery.bt_new2Click(Sender: TObject);
begin
      addreg2;
      ms_titulo.SetFocus;
end;

procedure Tmdl_classgalery.bt_del1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_classgalery.bt_save1Click(Sender: TObject);
...
procedure Tmdl_classgalery.ComboBox_webChange(Sender: TObject);
begin
...
procedure Tmdl_classgalery.bt_save2Click(Sender: TObject);
...
procedure Tmdl_classgalery.getLogo1;
...
procedure Tmdl_classgalery.getLogo3;
var axcodBlb: Integer;
begin
     try
...
procedure Tmdl_classgalery.abretmplogo1;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp1.Seek(0,soFromBeginning);
...
procedure Tmdl_classgalery.abretmplogo3;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp3.Seek(0,soFromBeginning);
...
procedure Tmdl_classgalery.getLogo2;
var axcodBlb: Integer;
begin
     try
...
procedure Tmdl_classgalery.abretmplogo2;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp2.Seek(0,soFromBeginning);
...
procedure Tmdl_classgalery.getBanner;
begin
     xbannertmp.Clear;
...
procedure Tmdl_classgalery.abretmpbanner;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xbannertmp.Seek(0,soFromBeginning);
...
procedure Tmdl_classgalery.bt_limpar1Click(Sender: TObject);
begin
      limpaphoto1(True);
...
procedure Tmdl_classgalery.bt_limpar2Click(Sender: TObject);
begin
      limpaphoto2(True);
...
procedure Tmdl_classgalery.bt_view1Click(Sender: TObject);
begin
      if dm.ds_sql.RecordCount>0 then begin
         ...
         mdl_richgalery_view.Left:=mdl_classgalery.Width-mdl_richgalery_view.Width;
         mdl_richgalery_view.Top:=mdl_classgalery.Height-mdl_richgalery_view.Height;
         mdl_richgalery_view.Show;
      end;
      //getLogo1;
end;

procedure Tmdl_classgalery.bt_open1Click(Sender: TObject);
...
procedure Tmdl_classgalery.bt_open2Click(Sender: TObject);
var xfilext,xnamefile: String;
    xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
    xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp: Integer;
...
procedure Tmdl_classgalery.chk_view2Click(Sender: TObject);
begin
      if chk_view2.Checked then getLogo2;
end;

procedure Tmdl_classgalery.Splitter1Moved(Sender: TObject);
begin
      ComboBox_web.Width:=ToolBar_web.Width-53;
end;

procedure Tmdl_classgalery.DBGrid1CellClick(Column: TColumn);
begin
      atualiza_grade;
end;

procedure Tmdl_classgalery.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_classgalery.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_classgalery.DBGrid1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade;
end;

procedure Tmdl_classgalery.DBGrid2CellClick(Column: TColumn);
begin
      atualiza_grade2;
end;

procedure Tmdl_classgalery.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_classgalery.DBGrid2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_classgalery.DBGrid2MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade2;
end;

procedure Tmdl_classgalery.bt_view2Click(Sender: TObject);
begin
      if dm.ds_sql3.RecordCount>0 then begin
         Application.CreateForm(Tmdl_richgalery_view,mdl_richgalery_view);
         mdl_richgalery_view.TableImage.xcp_cod:='codigo';
...
procedure Tmdl_classgalery.bt_recursiveClick(Sender: TObject);
...
function Tmdl_classgalery.inserimg(xnamefile,xfilext:String;
                      xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
                      xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp:Integer;
                      xic_ajt,xic_pr,xil_ajt,xil_pr: Boolean):Boolean;
...
function Tmdl_classgalery.retorna_TTabSheet(xidxcod:Integer):TTabSheet;
begin
      Case xidxcod of
          0: Result:=lngtb1;
          1: Result:=lngtb2;
...
procedure Tmdl_classgalery.PageControl_languagensChange(Sender: TObject);
begin
...
procedure Tmdl_classgalery.Timer_traduzTimer(Sender: TObject);
begin
      Inc(xtimerresponse);
end;

procedure Tmdl_classgalery.Tradutor1AoTraduzir(Sender: TObject;
  Traducao: String);
begin
    xreceivetrad:=Traducao;
end;

function Tmdl_classgalery.recebetraducao(xtrad_text,xtrad_de,xtrad_para: String):String;
var xrecebido: Bool;
begin
      xrecebido:=false;
      xreceivetrad:='';
...
procedure Tmdl_classgalery.save_cfg(xcodlng: Integer);
var axcod : integer;
    axshowing: Boolean;
begin
     axshowing:= loadx.Showing;
...
procedure Tmdl_classgalery.monta_table3;
var listaLng_id,axcoddefault,xid_default: Integer;
    axshowing: Boolean;
    //inclui linguagens
...
procedure Tmdl_classgalery.atualiza_grade_pers;
var axshowing: Boolean;
    axlocid: Integer;
begin
     //banner
...
procedure Tmdl_classgalery.limpaphoto_pers(xupdateset:Boolean);
begin
...
procedure Tmdl_classgalery.bt_open_persClick(Sender: TObject);
var xfilext,xnamefile: String;
    xerror: Boolean;
    codBitmap: TBitmap;
    codJpeg: TJPEGImage;
...
procedure Tmdl_classgalery.bt_limpar_persClick(Sender: TObject);
begin
      limpaphoto_pers(true);
end;

procedure Tmdl_classgalery.bt_save_persClick(Sender: TObject);
begin
      save_cfg(listaLng.cod_lng[PageControl_languagens.TabIndex]);
end;

procedure Tmdl_classgalery.PageControl1Change(Sender: TObject);
begin
...
procedure Tmdl_classgalery.MenuItem1Click(Sender: TObject);
var axshowing: Boolean;
begin
...
procedure Tmdl_classgalery.bt_del2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_classgalery.ComboBox_entChange(Sender: TObject);
begin
      if StrtoInt(AxDadosUsr.axparm) > 5000 then begin
...
procedure Tmdl_classgalery.bt_helpClick(Sender: TObject);
begin
      //Tópicos de ajuda
...
procedure Tmdl_classgalery.StatusBar1Click(Sender: TObject);
begin
      hwsf.BtSobre;
end;

procedure Tmdl_classgalery.ToolBar_grpResize(Sender: TObject);
begin
     cb_group.Width := ToolBar_grp.Width - 50;
end;

procedure Tmdl_classgalery.Desfazer1Click(Sender: TObject);
begin
     //desfazer
...
procedure Tmdl_classgalery.Recortar1Click(Sender: TObject);
begin
     //recortar
     retorna_TRxRichEdit(PageControlab.TabIndex).CutToClipboard;
end;

procedure Tmdl_classgalery.Copiar1Click(Sender: TObject);
begin
     //copiar
     retorna_TRxRichEdit(PageControlab.TabIndex).CopyToClipboard;
end;

procedure Tmdl_classgalery.Colar1Click(Sender: TObject);
begin
      //colar
     retorna_TRxRichEdit(PageControlab.TabIndex).PasteFromClipboard;
end;

procedure Tmdl_classgalery.Cor1Click(Sender: TObject);
begin
     //cor da fonte
...
procedure Tmdl_classgalery.Negrito1Click(Sender: TObject);
begin
     //negrito
     if FUpdating then Exit;
...
procedure Tmdl_classgalery.Italico1Click(Sender: TObject);
begin
     //italico
     if FUpdating then Exit;
...
procedure Tmdl_classgalery.Sublinhado1Click(Sender: TObject);
begin
     //sublinhado
     if FUpdating then Exit;
...
procedure Tmdl_classgalery.Marcador1Click(Sender: TObject);
begin
     //marcador
     if FUpdating then Exit;
...
procedure Tmdl_classgalery.AlignButtonClick(Sender: TObject);
begin
...
procedure Tmdl_classgalery.esquerdo1Click(Sender: TObject);
begin
     retorna_LeftAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_classgalery.centro1Click(Sender: TObject);
begin
     retorna_CenterAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_classgalery.direita1Click(Sender: TObject);
begin
     retorna_RightAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_classgalery.justificado1Click(Sender: TObject);
begin
     retorna_JustifyAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_classgalery.re_editorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tmdl_classgalery.SelectionChange(Sender: TObject);
begin
  //if processoand then exit;
...
function Tmdl_classgalery.CurrText: TRxTextAttributes;
begin
...
procedure Tmdl_classgalery.SetEditRect;
var
  R: TRect;
begin
  with retorna_TRxRichEdit(PageControlab.TabIndex) do
...
procedure Tmdl_classgalery.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
function Tmdl_classgalery.retorna_TRxRichEdit(xidxcod:Integer):TRxRichEdit;
begin
      Case xidxcod of
          0: Result:=re_editor3;
          1: Result:=re_editor1;
...
function Tmdl_classgalery.retorna_fontName(xidxcod:Integer):TComboBox;
begin
      Case xidxcod of
          0: Result:=FontName3;
          1: Result:=FontName1;
...
function Tmdl_classgalery.retorna_fontSize(xidxcod:Integer):TEdit;
begin
      Case xidxcod of
          0: Result:=FontSize3;
          1: Result:=FontSize1;
...
function Tmdl_classgalery.retorna_BoldButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_classgalery.retorna_ItalicButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_classgalery.retorna_UnderlineButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_classgalery.retorna_LeftAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
          0: Result:=LeftAlign3;
          1: Result:=LeftAlign1;
...
function Tmdl_classgalery.retorna_CenterAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_classgalery.retorna_RightAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_classgalery.retorna_JustifyAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_classgalery.retorna_BulletsButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
procedure Tmdl_classgalery.setPaCtrlLab;
...
procedure Tmdl_classgalery.cb_groupChange(Sender: TObject);
begin
...
procedure Tmdl_classgalery.monta_tableclass;
...
procedure Tmdl_classgalery.PanelclassResize(Sender: TObject);
begin
    ComboBox_class.Width := Panelclass.Width-11;
end;

procedure Tmdl_classgalery.EVsaveKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_classgalery.EVsave2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_classgalery.Cordefundo1Click(Sender: TObject);
begin
      //cor de fundo
      if ColorDialog1.Execute then begin
...
procedure Tmdl_classgalery.validaCbClass();
...
function Tmdl_classgalery.Btsearch_auto_ax(pathdefault,filtrofind:string):Tbt_search_ax;
...
procedure Tmdl_classgalery.ComboBox_classKeyPress(Sender: TObject;
  var Key: Char);
begin
      if key=#13 then validaCbClass();
end;

procedure Tmdl_classgalery.ComboBox_classClick(Sender: TObject);
begin
      validaCbClass();
end;

procedure Tmdl_classgalery.bt_new3Click(Sender: TObject);
begin
      addreg3;
      cl_titulo.SetFocus;
end;

procedure Tmdl_classgalery.bt_del3Click(Sender: TObject);
...
procedure Tmdl_classgalery.DBGrid3CellClick(Column: TColumn);
begin
      atualiza_grade3;
end;

procedure Tmdl_classgalery.DBGrid3KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade3;
end;

procedure Tmdl_classgalery.DBGrid3KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade3;
end;

procedure Tmdl_classgalery.DBGrid3MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade3;
end;

procedure Tmdl_classgalery.bt_save3Click(Sender: TObject);
...
procedure Tmdl_classgalery.bt_exp1Click(Sender: TObject);
var xfiljpg : String;
...
procedure Tmdl_classgalery.bt_exp2Click(Sender: TObject);
var xfiljpg : String;
    xImagem_tmp : TMemoryStream;
begin
      if ExportarImgDialog.Execute then begin
...
procedure Tmdl_classgalery.bt_open3Click(Sender: TObject);
var xfilext,xnamefile: String;
    codBitmap: TBitmap;
    codJpeg: TJPEGImage;
    codAbrirtmp: TPicture;
...
procedure Tmdl_classgalery.bt_limpar3Click(Sender: TObject);
begin
      limpaphoto3(True);
      if hwsf.BtConfirma('Gravar dados?') then begin
         bt_save3.Click;
...
procedure Tmdl_classgalery.bt_view3Click(Sender: TObject);
begin
      if dm.ds_sql6.RecordCount>0 then begin
         Application.CreateForm(Tmdl_richgalery_view,mdl_richgalery_view);
         mdl_richgalery_view.TableImage.xcp_cod:='codigo';
...
procedure Tmdl_classgalery.chk_view3Click(Sender: TObject);
begin
      if chk_view3.Checked then getLogo3;
end;

procedure Tmdl_classgalery.SpeedButton2Click(Sender: TObject);
...
procedure Tmdl_classgalery.bt_exp3Click(Sender: TObject);
var xfiljpg : String;
    xImagem_tmp : TMemoryStream;
begin
      if ExportarImgDialog.Execute then begin
...
procedure Tmdl_classgalery.chk_view1Click(Sender: TObject);
begin
      if chk_view1.Checked then getLogo1;
end;

procedure Tmdl_classgalery.Panelbtview3Resize(Sender: TObject);
begin
    bt_view3.Height:=Panelbtview3.Height-49;
end;

procedure Tmdl_classgalery.PanelbtviewResize(Sender: TObject);
begin
    bt_view1.Height:=Panelbtview.Height-49;
end;

procedure Tmdl_classgalery.Panelbtview2Resize(Sender: TObject);
begin
    bt_view2.Height:=Panelbtview2.Height-49;
end;

procedure Tmdl_classgalery.bt_imgRotateh3Click(Sender: TObject);
begin
     if dm.rotateFoto(90,xlogotmp3,xlogosz3,xupdatelogo3,'0',LstTables.Table[0]+'_ax','cod_class','icon',cl_cod.Caption) then
        abretmplogo3;
end;

procedure Tmdl_classgalery.bt_imgRotatea3Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp3,xlogosz3,xupdatelogo3,'0',LstTables.Table[0]+'_ax','cod_class','icon',cl_cod.Caption) then
        abretmplogo3;
end;

procedure Tmdl_classgalery.bt_imgRotateh1Click(Sender: TObject);
begin
...
procedure Tmdl_classgalery.bt_imgRotatea1Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp1,xlogosz1,xupdatelogo1,ComboBox_model.Text,LstTables.Table[1],'cod_gal','icon',ab_cod.Caption) then
        abretmplogo1;
end;

procedure Tmdl_classgalery.bt_imgRotateh2Click(Sender: TObject);
begin
...
procedure Tmdl_classgalery.bt_imgRotatea2Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp2,xlogosz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_ico',ms_cod.Caption) then begin
        if dm.rotateFoto(-90,xampltmp2,xamplsz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_larg',ms_cod.Caption) then
           abretmplogo2
...
procedure Tmdl_classgalery.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
      hwsf.BtMensagem('AVISO: Falha na conexão.');
end;

procedure Tmdl_classgalery.DBGrid3TitleClick(Column: TColumn);
var xinddbs: integer;
begin
...
procedure Tmdl_classgalery.DBGrid1TitleClick(Column: TColumn);
var xinddbs: integer;
begin
...
procedure Tmdl_classgalery.DBGrid2TitleClick(Column: TColumn);
var xinddbs: integer;
begin
