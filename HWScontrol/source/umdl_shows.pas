...
procedure Tmdl_shows.FormClose(Sender: TObject; var Action: TCloseAction);
...
procedure Tmdl_shows.FormCreate(Sender: TObject);
var axshowing: Boolean;
...
begin
     ...
     mdl_shows.Caption:= AxDadosUsr.axtitle;
     xinit:=true;
     axcod_ent:=0;
...
procedure Tmdl_shows.monta_lng;
...
procedure Tmdl_shows.monta_table1;
var axshowing: Boolean;
...
procedure Tmdl_shows.monta_table2(xnewgal,xuplng:Boolean);
begin
...
procedure Tmdl_shows.FormResize(Sender: TObject);
begin
...
procedure Tmdl_shows.FormActivate(Sender: TObject);
begin
      mdl_shows.Refresh;
      if xinit then begin
         xinit:=false;
...
procedure Tmdl_shows.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      Case key of
...
procedure Tmdl_shows.travaformImages(xtrava: Boolean);
begin
...
procedure Tmdl_shows.atualiza_grade;
var axshowing: Boolean;
    axlocid: Integer;
...
begin
     ...
     axshowing:= loadx.Showing;
      if not axshowing then begin
         loadx := Tloadx.Create(Application);
         loadx.lbloading.Caption:='Atualizando Show';
         loadx.Show;
         loadx.Update;
      end else begin
         loadx.lbloading.Caption:='Atualizando Show';
...
procedure Tmdl_shows.limpaphoto1(xupdateset:Boolean);
begin
...
procedure Tmdl_shows.atualiza_grade2;
var axshowing: Boolean;
    st_stream : TMemoryStream;
begin
     //banco de imagens
...
procedure Tmdl_shows.limpaphoto2(xupdateset:Boolean);
begin
...
procedure Tmdl_shows.bt_new1Click(Sender: TObject);
begin
      addreg;
      ab_titulo.SetFocus;
end;

procedure Tmdl_shows.bt_new2Click(Sender: TObject);
begin
      addreg2;
      ms_titulo.SetFocus;
end;

procedure Tmdl_shows.bt_save1Click(Sender: TObject);
...
procedure Tmdl_shows.ComboBox_webChange(Sender: TObject);
begin
...
procedure Tmdl_shows.bt_save2Click(Sender: TObject);
...
begin
     ...
     if ab_cod.Caption = 'novo' then begin
        hwsf.BtMensagem('É necessário gravar as alterações do Show.');
        exit;
     end;
...
procedure Tmdl_shows.abretmplogo1;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp1.Seek(0,soFromBeginning);
...
procedure Tmdl_shows.abretmplogo2;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xlogotmp2.Seek(0,soFromBeginning);
...
procedure Tmdl_shows.getBanner;
begin
     xbannertmp.Clear;
...
procedure Tmdl_shows.abretmpbanner;
var erro: Boolean;
    ax_filenm: TFileName;
begin
    xbannertmp.Seek(0,soFromBeginning);
...
procedure Tmdl_shows.bt_limpar1Click(Sender: TObject);
begin
      limpaphoto1(True);
      if hwsf.BtConfirma('Gravar dados do Show?') then begin
         bt_save1.Click;
         if chk_view1.Checked then getLogo1;
      end;
end;

procedure Tmdl_shows.bt_limpar2Click(Sender: TObject);
begin
      limpaphoto2(True);
...
procedure Tmdl_shows.bt_view1Click(Sender: TObject);
begin
      if dm.ds_sql.RecordCount>0 then begin
         ...
         mdl_richgalery_view.Left:=mdl_shows.Width-mdl_richgalery_view.Width;
         mdl_richgalery_view.Top:=mdl_shows.Height-mdl_richgalery_view.Height;
         mdl_richgalery_view.Show;
      end;
end;

procedure Tmdl_shows.bt_open1Click(Sender: TObject);
...
procedure Tmdl_shows.bt_open2Click(Sender: TObject);
var xfilext,xnamefile: String;
    xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
    xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp: Integer;
...
procedure Tmdl_shows.chk_view1Click(Sender: TObject);
begin
      if chk_view1.Checked then getLogo1;
end;

procedure Tmdl_shows.chk_view2Click(Sender: TObject);
begin
      if chk_view2.Checked then getLogo2;
end;

procedure Tmdl_shows.Splitter1Moved(Sender: TObject);
begin
      ComboBox_web.Width:=ToolBar_web.Width-53;
end;

procedure Tmdl_shows.DBGrid1CellClick(Column: TColumn);
begin
      atualiza_grade;
end;

procedure Tmdl_shows.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_shows.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade;
end;

procedure Tmdl_shows.DBGrid1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade;
end;

procedure Tmdl_shows.DBGrid2CellClick(Column: TColumn);
begin
      atualiza_grade2;
end;

procedure Tmdl_shows.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_shows.DBGrid2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      atualiza_grade2;
end;

procedure Tmdl_shows.DBGrid2MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
      atualiza_grade2;
end;

procedure Tmdl_shows.ComboSpeedButton1Click(Sender: TObject);
begin
      getLogo2;
end;

procedure Tmdl_shows.bt_recursiveClick(Sender: TObject);
...
function Tmdl_shows.inserimg(xnamefile,xfilext:String;
                      xic_w,xic_h,xic_dpi,xic_cp,xil_w,xil_h,xil_dpi,xil_cp,
                      xic_h_tmp,xic_w_tmp,xil_h_tmp,xil_w_tmp:Integer;
                      xic_ajt,xic_pr,xil_ajt,xil_pr: Boolean):Boolean;
...
function Tmdl_shows.retorna_TTabSheet(xidxcod:Integer):TTabSheet;
begin
      Case xidxcod of
          0: Result:=lngtb1;
          1: Result:=lngtb2;
...
procedure Tmdl_shows.PageControl_languagensChange(Sender: TObject);
begin
...
procedure Tmdl_shows.Timer_traduzTimer(Sender: TObject);
begin
      Inc(xtimerresponse);
end;

procedure Tmdl_shows.Tradutor1AoTraduzir(Sender: TObject;
  Traducao: String);
begin
    xreceivetrad:=Traducao;
end;

function Tmdl_shows.recebetraducao(xtrad_text,xtrad_de,xtrad_para: String):String;
var xrecebido: Bool;
begin
      xrecebido:=false;
      xreceivetrad:='';
...
procedure Tmdl_shows.save_cfg(xcodlng: Integer);
var axcod : integer;
    axshowing: Boolean;
begin
     axshowing:= loadx.Showing;
...
procedure Tmdl_shows.monta_table3;
var listaLng_id,axcoddefault,xid_default: Integer;
    axshowing: Boolean;
    //inclui linguagens
...
procedure Tmdl_shows.atualiza_grade3;
var axshowing: Boolean;
    axlocid: Integer;
begin
     //banner
...
procedure Tmdl_shows.limpaphoto3(xupdateset:Boolean);
begin
...
procedure Tmdl_shows.bt_open3Click(Sender: TObject);
var xfilext,xnamefile: String;
    xerror: Boolean;
    codBitmap: TBitmap;
    codJpeg: TJPEGImage;
...
procedure Tmdl_shows.bt_limpar3Click(Sender: TObject);
begin
      limpaphoto3(true);
end;

procedure Tmdl_shows.bt_save3Click(Sender: TObject);
begin
      save_cfg(listaLng.cod_lng[PageControl_languagens.TabIndex]);
end;

procedure Tmdl_shows.PageControl1Change(Sender: TObject);
begin
...
procedure Tmdl_shows.MenuItem1Click(Sender: TObject);
var axshowing: Boolean;
begin
...
procedure Tmdl_shows.bt_del2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_shows.ComboBox_entChange(Sender: TObject);
begin
      if StrtoInt(AxDadosUsr.axparm) > 5000 then begin
...
procedure Tmdl_shows.bt_helpClick(Sender: TObject);
begin
      //Tópicos de ajuda
...
procedure Tmdl_shows.StatusBar1Click(Sender: TObject);
begin
      hwsf.BtSobre;
end;

procedure Tmdl_shows.ToolBar_grpResize(Sender: TObject);
begin
     cb_group.Width := ToolBar_grp.Width - 50;
end;

procedure Tmdl_shows.Desfazer1Click(Sender: TObject);
begin
     //desfazer
...
procedure Tmdl_shows.Recortar1Click(Sender: TObject);
begin
     //recortar
     retorna_TRxRichEdit(PageControlab.TabIndex).CutToClipboard;
end;

procedure Tmdl_shows.Copiar1Click(Sender: TObject);
begin
     //copiar
     retorna_TRxRichEdit(PageControlab.TabIndex).CopyToClipboard;
end;

procedure Tmdl_shows.Colar1Click(Sender: TObject);
begin
      //colar
     retorna_TRxRichEdit(PageControlab.TabIndex).PasteFromClipboard;
end;

procedure Tmdl_shows.Cor1Click(Sender: TObject);
begin
     //cor da fonte
...
procedure Tmdl_shows.Negrito1Click(Sender: TObject);
begin
     //negrito
     if FUpdating then Exit;
...
procedure Tmdl_shows.Italico1Click(Sender: TObject);
begin
     //italico
     if FUpdating then Exit;
...
procedure Tmdl_shows.Sublinhado1Click(Sender: TObject);
begin
     //sublinhado
     if FUpdating then Exit;
...
procedure Tmdl_shows.Marcador1Click(Sender: TObject);
begin
     //marcador
     if FUpdating then Exit;
...
procedure Tmdl_shows.AlignButtonClick(Sender: TObject);
begin
...
procedure Tmdl_shows.esquerdo1Click(Sender: TObject);
begin
     retorna_LeftAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_shows.centro1Click(Sender: TObject);
begin
     retorna_CenterAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_shows.direita1Click(Sender: TObject);
begin
     retorna_RightAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_shows.justificado1Click(Sender: TObject);
begin
     retorna_JustifyAlign(PageControlab.TabIndex).Click;
end;

procedure Tmdl_shows.re_editorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tmdl_shows.SelectionChange(Sender: TObject);
begin
  //if processoand then exit;
...
function Tmdl_shows.CurrText: TRxTextAttributes;
begin
...
procedure Tmdl_shows.SetEditRect;
var
  R: TRect;
begin
  with retorna_TRxRichEdit(PageControlab.TabIndex) do
...
procedure Tmdl_shows.UpdateCursorPos;
var
  CharPos: TPoint;
begin
...
function Tmdl_shows.retorna_TRxRichEdit(xidxcod:Integer):TRxRichEdit;
begin
      Case xidxcod of
          0: Result:=re_editor1;
          1: Result:=re_editor2;
...
function Tmdl_shows.retorna_fontName(xidxcod:Integer):TComboBox;
begin
      Case xidxcod of
          0: Result:=FontName1;
          1: Result:=FontName2;
...
function Tmdl_shows.retorna_fontSize(xidxcod:Integer):TEdit;
begin
      Case xidxcod of
          0: Result:=FontSize1;
          1: Result:=FontSize2;
...
function Tmdl_shows.retorna_BoldButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_shows.retorna_ItalicButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_shows.retorna_UnderlineButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_shows.retorna_LeftAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
          0: Result:=LeftAlign1;
          1: Result:=LeftAlign2;
...
function Tmdl_shows.retorna_CenterAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_shows.retorna_RightAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_shows.retorna_JustifyAlign(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
...
function Tmdl_shows.retorna_BulletsButton(xidxcod:Integer):TToolButton;
begin
      Case xidxcod of
      ...
      if (PageControlab.TabIndex = 1) then begin
         ...
         With dm.ds_sql do begin
             if (recordcount <= 0) then begin
                ...
                hwsf.BtMensagem('Antes de inserir os itens grave as informações do Show.');
                PageControlab.TabIndex:=0;
                exit;
             end;
             axshowing:= loadx.Showing;
...
procedure Tmdl_shows.cb_groupChange(Sender: TObject);
begin
...
procedure Tmdl_shows.monta_tableclass;
...
procedure Tmdl_shows.bt_newclassClick(Sender: TObject);
...
procedure Tmdl_shows.bt_delclassClick(Sender: TObject);
...
procedure Tmdl_shows.PanelclassResize(Sender: TObject);
begin
...
procedure Tmdl_shows.EVsaveKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_shows.EVsave2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      //if processoand then exit;
      if (Shift = [ssCtrl]) then
...
procedure Tmdl_shows.bt_saveclassClick(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     if (dm.ds_sql.RecordCount>0) and (ab_cod.Caption<>'novo') then begin
        ...
        if not axshowing then begin
           loadx := Tloadx.Create(Application);
           loadx.lbloading.Caption:='Excluindo Show';
           loadx.Show;
           loadx.Update;
        end else begin
           loadx.lbloading.Caption:='Excluindo Show';
...
procedure Tmdl_shows.Cordefundo1Click(Sender: TObject);
begin
      //cor de fundo
      if ColorDialog1.Execute then begin
...
procedure Tmdl_shows.validaCbClass();
begin
...
procedure Tmdl_shows.CheckBox_classClick(Sender: TObject);
begin
      validaCbClass();
end;

procedure Tmdl_shows.ComboBox_classKeyPress(Sender: TObject;
  var Key: Char);
begin
      if key=#13 then validaCbClass();
end;

procedure Tmdl_shows.ComboBox_classClick(Sender: TObject);
begin
      validaCbClass();
end;

function Tmdl_shows.Btsearch_auto_ax(pathdefault,filtrofind:string):Tbt_search_ax;
...
procedure Tmdl_shows.monta_uf(xselect:Boolean; xufdefault:string);
...
procedure Tmdl_shows.monta_cid(xuf,xciddefault:String);
...
procedure Tmdl_shows.xcp18_axufChange(Sender: TObject);
begin
     monta_cid(xcp18_axuf.text,'');
end;

procedure Tmdl_shows.bt_exp1Click(Sender: TObject);
var xfiljpg : String;
...
procedure Tmdl_shows.bt_view2Click(Sender: TObject);
begin
      if dm.ds_sql3.RecordCount>0 then begin
         Application.CreateForm(Tmdl_richgalery_view,mdl_richgalery_view);
         mdl_richgalery_view.TableImage.xcp_cod:='codigo';
...
procedure Tmdl_shows.bt_exp2Click(Sender: TObject);
var xfiljpg : String;
    xImagem_tmp : TMemoryStream;
begin
      if ExportarImgDialog.Execute then begin
...
procedure Tmdl_shows.SpeedButton2Click(Sender: TObject);
...
procedure Tmdl_shows.SpeedButton4Click(Sender: TObject);
begin
      DBGrid1.SetFocus;
...
procedure Tmdl_shows.xfil_ate_chkClick(Sender: TObject);
begin
      xfil_ate.Enabled:=xfil_ate_chk.Checked;
end;

procedure Tmdl_shows.xfil_de_chkClick(Sender: TObject);
begin
      xfil_de.Enabled:=xfil_de_chk.Checked;
end;

procedure Tmdl_shows.calend1Click(Sender: TObject);
//var axtm: String;
begin
...
procedure Tmdl_shows.PanelbtviewResize(Sender: TObject);
begin
    bt_view1.Height:=Panelbtview.Height-49;
end;

procedure Tmdl_shows.Panelbtview2Resize(Sender: TObject);
begin
    bt_view2.Height:=Panelbtview2.Height-49;
end;

procedure Tmdl_shows.bt_imgRotateh1Click(Sender: TObject);
begin
...
procedure Tmdl_shows.bt_imgRotatea1Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp1,xlogosz1,xupdatelogo1,ComboBox_model.Text,LstTables.Table[1],'cod_gal','icon',ab_cod.Caption) then
        abretmplogo1;
end;

procedure Tmdl_shows.bt_imgRotateh2Click(Sender: TObject);
begin
...
procedure Tmdl_shows.bt_imgRotatea2Click(Sender: TObject);
begin
     if dm.rotateFoto(-90,xlogotmp2,xlogosz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_ico',ms_cod.Caption) then begin
        if dm.rotateFoto(-90,xampltmp2,xamplsz2,xupdatelogo2,ComboBox_model.Text,LstTables.Table[3],'cod_img','img_larg',ms_cod.Caption) then
           abretmplogo2
...
procedure Tmdl_shows.MenuItem2Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
...
procedure Tmdl_shows.bt_cancel1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
      if (dm.ds_sql.RecordCount>0) and (ab_cod.Caption<>'novo') then begin
        ...
        if hwsf.BtConfirma('Tem certeza que desejas cancelar o Show?') then begin
           axshowing:= loadx.Showing;
           if not axshowing then begin
              loadx := Tloadx.Create(Application);
              loadx.lbloading.Caption:='Cancelando Show';
              loadx.Show;
              loadx.Update;
           end else begin
              loadx.lbloading.Caption:='Cancelando Show';
...
procedure Tmdl_shows.bt_activate1Click(Sender: TObject);
var axshowing: Boolean;
    axcod: Integer;
begin
     //banco de imagens
      if (dm.ds_sql.RecordCount>0) and (ab_cod.Caption<>'novo') then begin
        axcod:= StrToInt(ab_cod.Caption);
        if hwsf.BtConfirma('Tem certeza que desejas reativar o Show?') then begin
           axshowing:= loadx.Showing;
           if not axshowing then begin
              loadx := Tloadx.Create(Application);
              loadx.lbloading.Caption:='Reativando Show';
              loadx.Show;
              loadx.Update;
           end else begin
              loadx.lbloading.Caption:='Reativando Show';
...
procedure Tmdl_shows.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
