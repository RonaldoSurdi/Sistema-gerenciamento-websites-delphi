...
procedure Tmdl_usrassoc.FormClose(Sender: TObject; var Action: TCloseAction);
...
procedure Tmdl_usrassoc.FormCreate(Sender: TObject);
var axshowing: Boolean;
...
begin
     ...
     mdl_usrassoc.Caption := AxDadosUsr.axtitle;
...
procedure Tmdl_usrassoc.ResizeComponentesFrm();
begin
...
procedure Tmdl_usrassoc.FormShow(Sender: TObject);
begin
    ResizeComponentesFrm();
end;

procedure Tmdl_usrassoc.FormResize(Sender: TObject);
begin
    ResizeComponentesFrm();
end;

procedure Tmdl_usrassoc.atualiza_grade2;
...
procedure Tmdl_usrassoc.atualiza_grade2_ADD;
...
procedure Tmdl_usrassoc.atualiza_grade3;
...
procedure Tmdl_usrassoc.atualiza_grade4;
...
procedure Tmdl_usrassoc.addreg2;
begin
     xcodigo2.Text:='novo';
     xcpw3.Text:= '';
     xcpw4.DateTime:=Now;
...
procedure Tmdl_usrassoc.addreg2_ADD;
var axidPerm: Integer;
begin
...
procedure Tmdl_usrassoc.addreg3;
var axidPerm: Integer;
begin
     xcodigo3.Text:='novo';
     xcpx1.Text:= '';
...
procedure Tmdl_usrassoc.addreg4;
var axidPerm: Integer;
begin
     xcodigo4.Text:='novo';
     xcpz1.Text:= '';
...
procedure Tmdl_usrassoc.filtrar_reg;
...
procedure Tmdl_usrassoc.filtrar_reg3;
...
procedure Tmdl_usrassoc.filtrar_reg4;
var ax_filterReg:String;
    procedure add_filterReg(exec_filterReg:Boolean;tx_filterReg,op_filterReg:String);
    begin
         if exec_filterReg then begin
...
procedure Tmdl_usrassoc.ComboBox_searchChange(Sender: TObject);
begin
...
procedure Tmdl_usrassoc.Edit_searchKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure Tmdl_usrassoc.Edit_searchChange(Sender: TObject);
begin
     filtrar_reg;
end;

procedure Tmdl_usrassoc.edKeyPress(Sender: TObject; var Key: Char);
begin
     Case key of
       '0'..'9' :;
       #13, #8, #27:
...
procedure Tmdl_usrassoc.atualiza_xcpw25;
begin
     with dm.ds_sql5 do begin
       First;
       xcpw25_ax.Clear;
...
procedure Tmdl_usrassoc.ComboBox_webChange(Sender: TObject);
begin
...
procedure Tmdl_usrassoc.monta_table2;
begin
     With dm.ds_sql4 do begin
...
procedure Tmdl_usrassoc.bt_prior2Click(Sender: TObject);
begin
    dm.ds_sql4.Prior;
    atualiza_grade2;
end;

procedure Tmdl_usrassoc.bt_next2Click(Sender: TObject);
begin
    dm.ds_sql4.Next;
    atualiza_grade2;
end;

procedure Tmdl_usrassoc.bt_new2Click(Sender: TObject);
begin
    addreg2;
    xcpw6.SetFocus;
end;

procedure Tmdl_usrassoc.bt_del2Click(Sender: TObject);
var axcod: Integer;
    axshowing: Boolean;
begin
...
procedure Tmdl_usrassoc.bt_save2Click(Sender: TObject);
...
procedure Tmdl_usrassoc.DBGrid2CellClick(Column: TColumn);
begin
     atualiza_grade2;
end;

procedure Tmdl_usrassoc.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     atualiza_grade2;
end;

procedure Tmdl_usrassoc.DBGrid2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     atualiza_grade2;
end;

procedure Tmdl_usrassoc.xcpw24_axChange(Sender: TObject);
begin
     if (xinitAUX) then begin
...
procedure Tmdl_usrassoc.xcpw24Change(Sender: TObject);
begin
     if (xinitAUX) then begin
       if xcpw24.Text <> '' then
...
procedure Tmdl_usrassoc.xcpw25_axChange(Sender: TObject);
begin
     if (xinitAUX) then begin
...
procedure Tmdl_usrassoc.xcpw25Change(Sender: TObject);
begin
     if (xinitAUX) then begin
       if xcpw25.Text <> '' then
...
procedure Tmdl_usrassoc.SpeedButton8Click(Sender: TObject);
begin
      JumpTo('www.correios.com.br/servicos/cep/cep_default.cfm');
end;

procedure Tmdl_usrassoc.btatualizarClick(Sender: TObject);
begin
      dm.ds_sql4.Close;
      dm.ds_sql4.Open;
      atualiza_grade2;
...
procedure Tmdl_usrassoc.ApplicationEvents1Exception(Sender: TObject;
  E: Exception);
begin
      hwsf.BtMensagem('AVISO: Falha na conexão.');
end;

procedure Tmdl_usrassoc.DBGrid3CellClick(Column: TColumn);
begin
     atualiza_grade3;
end;

procedure Tmdl_usrassoc.DBGrid3KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     atualiza_grade3;
end;

procedure Tmdl_usrassoc.DBGrid3KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     atualiza_grade3;
end;

procedure Tmdl_usrassoc.DBGrid4CellClick(Column: TColumn);
begin
     atualiza_grade4;
end;

procedure Tmdl_usrassoc.DBGrid4KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     atualiza_grade4;
end;

procedure Tmdl_usrassoc.DBGrid4KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     atualiza_grade4;
end;

procedure Tmdl_usrassoc.bt_new3Click(Sender: TObject);
begin
    addreg3;
    xcpx1.SetFocus;
end;

procedure Tmdl_usrassoc.bt_new4Click(Sender: TObject);
begin
    addreg4;
    xcpz1.SetFocus;
end;

function Tmdl_usrassoc.resultID_xcpcod_class(xcpclassCod:String):Integer;
...
function Tmdl_usrassoc.resultStat_xcpcod_class(xcpclassId:Integer):Boolean;
...
function Tmdl_usrassoc.update_xcpcod_class():Boolean;
...
function Tmdl_usrassoc.resultID_xcpy9(xcpy9Cod:String):Integer;
...
function Tmdl_usrassoc.update_xcpy9():Boolean;
begin
    With dm.ds_sql7 do begin
         First;
         xcpy9.Clear;
...
procedure Tmdl_usrassoc.bt_del3Click(Sender: TObject);
...
procedure Tmdl_usrassoc.bt_del4Click(Sender: TObject);
var axcodelid: Integer;
begin
...
procedure Tmdl_usrassoc.bt_save3Click(Sender: TObject);
...
begin
     ...
     if xcodigo3.Text = 'novo' then begin
        ...
        with dm.executa do begin
            CommandText :='UPDATE '+LstTables.Table[5]+'_ax SET descricao=:p0,descricao=:p1,idstat=:p2,idview=:p3,idadd=:p4,perm0=:p5,perm1=:p6,perm2=:p7,perm3=:p8,perm4=:p9,perm5=:p10,perm6=:p11,perm7=:p12,perm8=:p13,perm9=:p14'+
                          ' WHERE codigo=:p15';
...
procedure Tmdl_usrassoc.bt_save4Click(Sender: TObject);
var axcod,axcod_class: integer;
    axAreatt: String;
    axshowing: Boolean;
begin
...
procedure Tmdl_usrassoc.xcpcod_classChange(Sender: TObject);
begin
     resultStat_xcpcod_class(xcpcod_class.ItemIndex);
end;

procedure Tmdl_usrassoc.filter_BtsClick(Sender: TObject);
begin
     filtrar_reg;
end;

procedure Tmdl_usrassoc.monta_uf(xselect:Boolean; xufdefault:string);
...
procedure Tmdl_usrassoc.monta_cid(xuf,xciddefault:String);
...
procedure Tmdl_usrassoc.getUFCit(xauxCodCit:Integer; var xauxUF,xauxCit:String);
begin
     With dm.ds_sql8 do begin
...
procedure Tmdl_usrassoc.xcpw18_axufChange(Sender: TObject);
begin
     monta_cid(xcpw18_axuf.text,'');
end;

procedure Tmdl_usrassoc.DBGrid2DrawColumnCell(Sender: TObject;
...
procedure Tmdl_usrassoc.xcpz_cat_sct(Sender: TObject);
begin
...
procedure Tmdl_usrassoc.filter_class2Click(Sender: TObject);
begin
     filtrar_reg4;
end;

procedure Tmdl_usrassoc.PageControl2Change(Sender: TObject);
begin
...
procedure Tmdl_usrassoc.Edit_search3Change(Sender: TObject);
begin
     filtrar_reg3;
end;

procedure Tmdl_usrassoc.Edit_search4Change(Sender: TObject);
begin
     filtrar_reg4;
end;
