...
var
  form_restrict3: Tform_restrict3;
...
procedure Tform_restrict3.MountedGrid;
begin
...
procedure Tform_restrict3.atualizaReg;
...
procedure Tform_restrict3.SpeedButton1Click(Sender: TObject);
var axcodIT: Integer;
    axshowing: Boolean;
begin
     Case axtypPerm of
...
procedure Tform_restrict3.SpeedButton7Click(Sender: TObject);
begin
     Case axtypPerm of
          1: begin
             if not dm2.ds_sql5.Active then exit;
...
procedure Tform_restrict3.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
      Action:=caHide;
end;

procedure Tform_restrict3.FormShow(Sender: TObject);
begin
      if mdl_filemanager.axformInit then atualizaReg;
end;

procedure Tform_restrict3.FormCreate(Sender: TObject);
begin
      axMountedGrid:=false;
end;
