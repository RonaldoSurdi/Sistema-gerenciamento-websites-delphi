...
begin
  with (GetSoapWebModule as THWSappdbBin) do begin
     ...
     xnomefile1:='';
     xnomefile2:='';
     xpthfiles:='E:/whws/hwshost.com.br/mns95SeIo/'+axcdweb+'/';
     xpthfilesMV:='E:/whws/hwshost.com.br/rv/mns95SeIoX/'+axcdweb+'/';
...
begin
  with (GetSoapWebModule as THWSappdbBin) do begin
     ...
     DeCompressedStream2:= TMemoryStream.Create;
     xnomefile2:='';
     xpthfiles2:='E:/whws/hwshost.com.br/mns95SeIo/'+axcdweb+'/';
     xpthfiles2MV:='E:/whws/hwshost.com.br/rv/mns95SeIoX/'+axcdweb+'/';
...
begin
  with (GetSoapWebModule as THWSappdbBin) do begin
     ...
     axResult:=false;
     xnomefile2:='';
     xpthfiles:='E:/whws/hwshost.com.br/mns95SeIoTMP/'+axcdweb+'/';
     xpthfiles2:='E:/whws/hwshost.com.br/mns95SeIo/'+axcdweb+'/';
     xpthfilesMV:='E:/whws/hwshost.com.br/rv/mns95SeIoTMPX/'+axcdweb+'/';
     xpthfiles2MV:='E:/whws/hwshost.com.br/rv/mns95SeIoX/'+axcdweb+'/';
     if (not DirectoryExists(xpthfiles)) then
        CreateDir(xpthfiles);
     if (not DirectoryExists(xpthfiles2)) then
   ...
   with (GetSoapWebModule as THWSappdbBin) do begin
     Try
        ...
        if (xcodcdID = 573205) then begin
           ...
           axdtSent:=Now;
           axdtSent2:=StrToDateTime(AxMsgSL1.Strings[16]);
