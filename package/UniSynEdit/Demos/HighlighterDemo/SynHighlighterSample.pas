...
The original code is: D:\Quellen\Komponenten\SynEdit\Demos\HighlighterDemo\SynHighlighterSample.pas, released 2005-07-01.
Description: 
...
$Id: SynHighlighterSample.pas,v 1.6.2.5 2005/07/01 17:29:43 maelh Exp $
...
const
  ...
  KeyWords: array[0..2] of WideString = (
    'hello', 'synedit', 'world' 
  );
  ...
  case fLine[Run] of
    ...
    begin
      ...
      repeat
        ...
        if not IsLineEnd(fLine[Run]) then
          Inc(Run);
...
function TSynSampleSyn.GetKeyWords(TokenKind: Integer): WideString;
begin
  Result := 
    'Hello,SynEdit,World';
end;
...
function TSynSampleSyn.GetSampleSource: WideString;
begin
  Result := 
...
class function TSynSampleSyn.GetFriendlyLanguageName: WideString;
begin
