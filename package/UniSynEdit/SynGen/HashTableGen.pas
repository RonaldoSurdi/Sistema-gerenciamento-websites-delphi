...
var
  ...
  searching: Boolean;
  KeyWords: array of WideString;
  HashKeyList: THashKeyList;

{$Q-}
function HashKey(const S: WideString): Cardinal;
var
  i: Integer;
begin
  Result := 0;
...
{$Q-}
function FinalHashKey(const S: WideString): Cardinal;
var
  i: Integer;
begin
  Result := 0;
...
begin
  ...
  Result := Result + Format('  KeyWords: array[0..%d] of WideString = (', [High(KeyWords)]) + #13#10;
