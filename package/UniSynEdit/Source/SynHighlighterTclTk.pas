...
$Id: SynHighlighterTclTk.pas,v 1.18.2.5 2005/07/01 17:17:43 maelh Exp $
...
const
  TclTkKeys: array[0..146] of WideString = (
...
function TSynTclTkSyn.IsSecondKeyWord(aToken: WideString): Boolean;
var
  First, Last, I, Compare: Integer;
  Token: WideString;
begin
...
var
  iKeys: TWideStringList;
  cDefKey: Integer;
  iIndex: Integer;
begin
  iKeys := TWideStringList.Create;
  try
