...
$Id: SynHighlighterUNIXShellScript.pas,v 1.7.2.6 2005/07/01 17:17:43 maelh Exp $
...
const
  ...
  ShellScriptKeys: array[1..ShellScriptKeysCount] of WideString = (
  ...
  ShellScriptSecondKeys: array[1..ShellScriptSecondKeysCount] of WideString = (
...
procedure TSynUNIXShellScriptSyn.SetSecondKeys(const Value: TWideStrings);
var
  i: Integer;
begin
  if Value <> nil then
