...
$Id: SynEdit.pas,v 1.386.2.36 2005/09/24 22:14:40 maelh Exp $
...
{$IFDEF SYN_CLX}
        ...
        if fGutter.Gradient then
          Canvas.Brush.Style := bsSolid;
{$ELSE}
        GetTextExtentPoint32W(DC, PWideChar(s), Length(s), TextSize);
        if fGutter.Gradient then
        begin
...
// This is only to simply paint-operations and has nothing to do with multi-byte
// chars.
...
begin
  ...
  begin
    inc(j);
    CountOfAvgGlyphs := Ceil(TextWidth(Canvas, S[i]) / fCharWidth);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        CountOfAvgGlyphs := Ceil(TextWidth(Canvas, Token[NonFillerPos]) / fCharWidth);
        ...
        if WordWrap then
          ...
          begin
            dec(nCharsToPaint);
            while Token[First + nCharsToPaint - 1] = FillerChar do
              dec(nCharsToPaint);
          end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        GetCharWidthW(Canvas.Handle, LastChar, LastChar, RealCharWidth);
    end
    ...
    begin
      ...
      begin
        ...
        GetCharWidth(Canvas.Handle, LastChar, LastChar, RealCharWidth);
    end;

    if RealCharWidth > 0 then
      Inc(rcToken.Left, RealCharWidth - CharWidth);
  end;
{$ENDIF}
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          sToken := sLineExpandedAtWideGlyhs;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                Result := CallWindowProcW(WndProc, hWnd, WM_CHAR, wParam, lParam);
              end;
              Message := WM_NULL;
            end;
          end;
...
initialization
{$IFNDEF SYN_CLX}
  if not IsCharMsgAlreadyUnicode then
  begin
    ...
    if Win32PlatformIsUnicode then
      GetMsgHook := SetWindowsHookExW(WH_GETMESSAGE, @GetMsgProc, HInstance,
        GetCurrentThreadId);
  end
  else
    GetMsgHook := 0;
