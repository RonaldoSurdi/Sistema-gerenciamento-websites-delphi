...
$Id: SynEditHighlighter.pas,v 1.36.2.9 2005/07/06 15:37:03 maelh Exp $
...
type
  ...
  public
    ...
    function GetKeyWords(TokenKind: Integer): WideString; virtual; abstract;
...
{$ENDIF}
    ...
    function IsLineEnd(AChar: WideChar): Boolean; virtual;
...
function TSynCustomHighlighter.IsLineEnd(AChar: WideChar): Boolean;
begin
