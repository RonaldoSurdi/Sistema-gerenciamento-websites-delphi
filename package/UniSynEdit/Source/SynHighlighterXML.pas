...
$Id: SynHighlighterXML.pas,v 1.11.2.4 2005/08/30 18:30:05 maelh Exp $
...
begin
  ...
  while not (IsLineEnd(fLine[Run]) or (fLine[Run] = '&') or (fLine[Run] = #34)) do
    Inc(Run);
...
begin
  ...
  while not (IsLineEnd(fLine[Run]) or (fLine[Run] = '&') or (fLine[Run] = #39)) do
    Inc(Run);
