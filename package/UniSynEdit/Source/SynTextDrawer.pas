...
// $Id: SynTextDrawer.pas,v 1.6.2.2 2005/07/01 17:17:44 maelh Exp $
...
type
  ...
  TheExtTextOutProc = procedure (X, Y: Integer; fuOptions: UINT;
    const ARect: TRect; Text: PWideChar; Length: Integer) of object;
  ...
  protected
    ...
    procedure TextOutOrExtTextOut(X, Y: Integer; fuOptions: UINT;
      const ARect: TRect; Text: PWideChar; Length: Integer); virtual;
  ...
  public
    procedure ExtTextOut(X, Y: Integer; fuOptions: UINT; const ARect: TRect;
      Text: PWideChar; Length: Integer); override;
  end;
...
procedure TheTextDrawer.ExtTextOut(X, Y: Integer; fuOptions: UINT;
  ...
  begin
    ...
    begin
      GetTextExtentPoint32W(FDC, @Text[i], 1, Size);
...
begin
  ...
  Windows.ExtTextOutW(FDC, X, Y, fuOptions, @ARect, Text,
...
procedure TheTextDrawerEx.ExtTextOutFixed(X, Y: Integer; fuOptions: UINT;
  const ARect: TRect; Text: PWideChar; Length: Integer);
begin
  Windows.ExtTextOutW(StockDC, X, Y, fuOptions, @ARect, Text, Length, nil);
end;
...
procedure TheTextDrawerEx.TextOutOrExtTextOut(X, Y: Integer;
  fuOptions: UINT; const ARect: TRect; Text: PWideChar; Length: Integer);
begin
  ...
  with ARect do
    ...
    Windows.TextOutW(StockDC, X, Y, Text, Length)
  else
    Windows.ExtTextOutW(StockDC, X, Y, fuOptions, @ARect, Text, Length, nil)
end;
