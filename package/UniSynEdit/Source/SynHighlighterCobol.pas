...
$Id: SynHighlighterCobol.pas,v 1.5.2.4 2005/07/01 17:17:40 maelh Exp $
...
begin
  ...
  begin
    ...
    repeat
      inc(Run);
    until (Run = fCodeStartPos - 1) or IsLineEnd(fLine[Run]);
  end
  else
  begin
...
begin
  ...
  begin
    ...
    repeat
      Inc(Run);
    until IsLineEnd(fLine[Run]) or (Run > fCodeEndPos);
  end;
end;
