...
uses
  ...
  SysUtils,
  hwsfunctions,
  uwebchat_conf in 'uwebchat_conf.pas' {webchat_conf},
    ...
    Try
       ...
       if axwinsys then begin
          ...
          if HprevHist = 0 then begin
             ...
             loadx.lbloading.Caption:='HWSsac Conferências';
             loadx.Show;
             loadx.Update;
             ...
             if axwinsys then begin
                ...
                if axwinsys then begin
                   ...
                   loadx.Repaint;
                   Application.Title := 'HWSsac Conferências';
                   loadx.Close;
                   Application.CreateForm(Twebchat_conf, webchat_conf);
                end;
             end;
          end else begin
