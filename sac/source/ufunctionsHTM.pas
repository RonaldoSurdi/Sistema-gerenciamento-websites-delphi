...
function InvokeCMDfnc(WB: TWebbrowser; InvokeIE: Boolean; Value1, Value2: Integer; var vaIn, vaOut: OleVariant): Boolean; overload;
{ ************************************************************************* }
...
var
  vaIn, vaOut: Olevariant;
begin
  InvokeCmdfnc(WB, FALSE, OLECMDID_COPY, OLECMDEXECOPT_DODEFAULT, vaIn, vaOut);
end;
...
var
  vaIn, vaOut: Olevariant;
begin
  InvokeCmdfnc(WB, FALSE, OLECMDID_PASTE, OLECMDEXECOPT_DODEFAULT, vaIn, vaOut);
end;
...
var
  vaIn, vaOut: Olevariant;
begin
  InvokeCmdfnc(WB, FALSE, OLECMDID_SELECTALL, OLECMDEXECOPT_DODEFAULT, vaIn, vaOut);
end;
...
var
  vaIn, vaOut: Olevariant;
begin
  InvokeCmdfnc(WB, FALSE, OLECMDID_CUT, OLECMDEXECOPT_DODEFAULT, vaIn, vaOut);
end;
...
begin
  ...
  begin
   { if (WB.QueryStatusWB(OLECMDID_ZOOM)
    ...
    vaIn := null;
    InvokeCmdfnc(WB, FALSE, OLECMDID_ZOOM, OLECMDEXECOPT_DONTPROMPTUSER, vaIn, vaOut);
    result := vaOut;
  end;
end;
